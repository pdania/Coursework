...
public class MailLine extends com.pullenti.ner.MetaToken {
    ...
    public static MailLine parse(com.pullenti.ner.Token t0, int _lev) {
        if (t0 == null) 
            return null;
        ...
        if (res.typ == Types.UNDEFINED) {
            ...
            for (; t != null && (t.endChar < res.endChar); t = t.getNext()) {
            ...
            for (; t != null && (t.endChar < res.endChar); t = t.getNext()) {
                ...
                if (t instanceof com.pullenti.ner.TextToken) {
                    ...
                    com.pullenti.ner.person.internal.PersonItemToken pit = com.pullenti.ner.person.internal.PersonItemToken.tryAttach(t, null, com.pullenti.ner.person.internal.PersonItemToken.ParseAttr.NO, null);
                    if (pit != null) {
                        nams++;
                        t = pit.getEndToken();
                        continue;
        ...
        if (res.typ == Types.UNDEFINED) {
            ...
            for (com.pullenti.ner.Token t = t0; t != null && t.endChar <= res.endChar; t = t.getNext()) {
                if (!((t instanceof com.pullenti.ner.TextToken))) 
                    continue;
                if (t.isChar('<')) {
                ...
                if (tok != null) {
                    okWords++;
                    for (; t != null && t.endChar <= tok.endChar; t = t.getNext()) {
                        t.tag = tok.termin;
                    }
                    t = tok.getEndToken();
                    if ((t.getNext() instanceof com.pullenti.ner.TextToken) && t.getNext().getMorph().getCase().isGenitive()) {
                        for (t = t.getNext(); t.endChar <= res.endChar; t = t.getNext()) {
                            ...
                            if (!npt1.getMorph().getCase().isGenitive()) 
                                break;
                            for (; t.endChar < npt1.endChar; t = t.getNext()) {
                                t.tag = t;
                            }
                            t.tag = t;
                        }
                ...
                if ((t.getMorph()._getClass().isPreposition() || t.getMorph()._getClass().isConjunction() || t.getMorph()._getClass().isMisc()) || t.isValue("C", null)) 
                    continue;
                if ((okWords > 0 && t.getPrevious() != null && t.getPrevious().isComma()) && t.getPrevious().beginChar > t0.beginChar && !t.chars.isAllLower()) {
            ...
            if (t != null) {
                ...
                if (((t.isValue("ПЕРЕСЫЛАЕМОЕ", null) || t.isValue("ПЕРЕАДРЕСОВАННОЕ", null))) && t.getNext() != null && t.getNext().isValue("СООБЩЕНИЕ", null)) {
                    ...
                    if (t.isNewlineAfter() && (_lev < 5)) {
                        MailLine res1 = parse(t.getNext(), _lev + 1);
                        if (res1 != null && res1.typ == Types.HELLO) 
                            res.typ = Types.FROM;
                    }
                    MailLine _next = parse(res.getEndToken().getNext(), _lev + 1);
                    if (_next != null) {
                    ...
                    for (; t != null && t.endChar <= tmax; t = t.getNext()) {
                        if (t.isValue("ОТ", null) || t.isValue("FROM", null)) 
                            ...
                            for (t = t.getNext(); t != null && t.endChar <= res.endChar; t = t.getNext()) {
