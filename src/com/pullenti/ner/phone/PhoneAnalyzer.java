...
public class PhoneAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.Collection<com.pullenti.ner.ReferentClass> getTypeSystem() {
        return java.util.Arrays.asList(new com.pullenti.ner.ReferentClass[] {com.pullenti.ner.phone.internal.MetaPhone.globalMeta});
    }
    ...
    public static class PhoneAnalizerData extends com.pullenti.ner.core.AnalyzerData {
        ...
        public com.pullenti.ner.Referent registerReferent(com.pullenti.ner.Referent referent) {
            ...
            com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.phone.PhoneReferent>> wrapphLi2659 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.phone.PhoneReferent>>();
            boolean inoutres2660 = com.pullenti.unisharp.Utils.tryGetValue(m_PhonesHash, key, wrapphLi2659);
            phLi = wrapphLi2659.value;
            if (!inoutres2660) 
            ...
            for (com.pullenti.ner.phone.PhoneReferent p : phLi) {
                if (p.canBeEquals(_phone, com.pullenti.ner.Referent.EqualType.WITHINONETEXT)) {
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        ...
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            java.util.ArrayList<com.pullenti.ner.phone.internal.PhoneItemToken> pli = com.pullenti.ner.phone.internal.PhoneItemToken.tryAttachAll(t);
            ...
            if (rts == null) 
                ...
                if ((ki == PhoneKind.UNDEFINED && prevPhone != null && !isPref) && prevPhone.getKind() != PhoneKind.MOBILE && kkk == 0) 
    ...
    public com.pullenti.ner.ReferentToken processReferent(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        java.util.ArrayList<com.pullenti.ner.phone.internal.PhoneItemToken> pli = com.pullenti.ner.phone.internal.PhoneItemToken.tryAttachAll(begin);
        if (pli == null || pli.size() == 0) 
            return null;
        int i = 0;
        for (; i < pli.size(); i++) {
    ...
    private PhoneReferent getNextPhone(com.pullenti.ner.Token t, int lev) {
        ...
        if (t == null || lev > 3) 
            return null;
        java.util.ArrayList<com.pullenti.ner.phone.internal.PhoneItemToken> its = com.pullenti.ner.phone.internal.PhoneItemToken.tryAttachAll(t);
        if (its == null) 
            return null;
    ...
    static {
        _globalInstance = new PhoneAnalyzer(); 
    }
}
