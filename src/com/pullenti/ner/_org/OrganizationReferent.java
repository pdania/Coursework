...
public class OrganizationReferent extends com.pullenti.ner.Referent {
    ...
    public String toString(boolean shortVariant, com.pullenti.morph.MorphLang lang, int lev) {
        ...
        if (!shortVariant && getOwner() != null) 
            res.append("; ").append(this.getOwner().toString(true, lang, lev + 1));
        if (!shortVariant) {
            if (!noType && !isDep) {
                String typ = null;
            ...
            String kl = this.getStringValue(ATTR_KLADR);
            if (kl != null) 
            ...
            if (isDep || outOwnInName) {
                for (com.pullenti.ner.Slot ss : getSlots()) {
                    if (com.pullenti.unisharp.Utils.stringsEq(ss.getTypeName(), ATTR_HIGHER) && (ss.getValue() instanceof com.pullenti.ner.Referent) && (lev < 20)) {
                        ...
                        res.append(';');
                        res.append(" ").append((((com.pullenti.ner.Referent)com.pullenti.unisharp.Utils.cast(ss.getValue(), com.pullenti.ner.Referent.class))).toString(shortVariant, lang, lev + 1));
                        break;
                    }
                }
            }
    ...
    public String toSortString() {
        return getKind() + this.toString(true, com.pullenti.morph.MorphLang.UNKNOWN, 0);
    }
    ...
    public boolean checkCorrection() {
        if (getSlots().size() < 1) 
            return false;
        String s = this.toString(true, com.pullenti.morph.MorphLang.UNKNOWN, 0).toLowerCase();
    ...
    private String correctName(String name, com.pullenti.unisharp.Outargwrapper<Integer> num) {
        ...
        if (Character.isDigit(name.charAt(0)) && name.indexOf(' ') > 0) {
            int i;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapi2398 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres2399 = com.pullenti.unisharp.Utils.parseInteger(name.substring(0, 0 + name.indexOf(' ')), 0, null, wrapi2398);
            i = (wrapi2398.value != null ? wrapi2398.value : 0);
            if (inoutres2399) {
                if (i > 1) {
                    num.value = i;
            ...
            if (i >= 0 && name.charAt(i) == '.') {
                ...
                boolean inoutres2400 = com.pullenti.unisharp.Utils.parseInteger(name.substring(i + 1), 0, null, num);
                if (i > 0 && inoutres2400 && num.value > 0) {
                    if (i < 1) 
                        return null;
    ...
    public void addName(String name, boolean removeLongGovNames, com.pullenti.ner.Token t) {
        int num;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapnum2401 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        String s = this.correctName(name, wrapnum2401);
        num = (wrapnum2401.value != null ? wrapnum2401.value : 0);
        if (s == null) {
                    ...
                    if (m_NameSingleNormalReal == null) {
                        ...
                        for (int ii = getSlots().size() - 1; ii >= 0; ii--) {
                            if (com.pullenti.unisharp.Utils.stringsEq(this.getSlots().get(ii).getTypeName(), ATTR_NAME) && com.pullenti.unisharp.Utils.stringsNe(((String)com.pullenti.unisharp.Utils.cast(this.getSlots().get(ii).getValue(), String.class)), s)) {
                                mt = com.pullenti.morph.Morphology.process((String)com.pullenti.unisharp.Utils.cast(this.getSlots().get(ii).getValue(), String.class), t.getMorph().getLanguage(), null);
                                if (mt != null && mt.size() == 1) {
    ...
    public void addNameStr(String name, com.pullenti.ner._org.internal.OrgItemTypeToken typ, int cou) {
        ...
        if (name == null) {
            ...
            if (typ.name != null && com.pullenti.unisharp.Utils.stringsCompare(typ.name, typ.typ, true) != 0 && ((typ.name.length() > typ.typ.length() || this.findSlot(ATTR_NAME, null, true) == null))) {
                int num = 0;
                com.pullenti.unisharp.Outargwrapper<Integer> wrapnum2402 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                String s = this.correctName(typ.name, wrapnum2402);
                num = (wrapnum2402.value != null ? wrapnum2402.value : 0);
            ...
            if (typ == null || typ.isNotTyp) 
                ...
                if (typ.name != null) {
                    int num = 0;
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapnum2403 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    String ss = this.correctName(typ.name, wrapnum2403);
                    num = (wrapnum2403.value != null ? wrapnum2403.value : 0);
                    if (ss != null) {
                        this.addTypeStr(ss);
    ...
    public boolean _typesContains(String substr) {
        for (com.pullenti.ner.Slot s : getSlots()) {
            if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), ATTR_TYPE)) {
                if ((((String)com.pullenti.unisharp.Utils.cast(s.getValue(), String.class)).indexOf(substr) >= 0)) 
                    return true;
            }
        }
        return false;
    ...
    public void addType(com.pullenti.ner._org.internal.OrgItemTypeToken typ, boolean finalAdd) {
        ...
        if (typ.isNotTyp) 
            return;
        for (com.pullenti.ner.Token tt = typ.getBeginToken(); tt != null && tt.endChar <= typ.endChar; tt = tt.getNext()) {
    ...
    public boolean canBeGeneralFor(com.pullenti.ner.Referent obj) {
        if (m_Level > 10) 
            return false;
        m_Level++;
        boolean b = this.canBeEqualsEx(obj, true, com.pullenti.ner.Referent.EqualType.DIFFERENTTEXTS);
        m_Level--;
        if (!b) 
            return false;
        ...
        if (geos1.size() == 0 && geos2.size() > 0) {
            ...
            if (getHigher() != null && (((OrganizationReferent)com.pullenti.unisharp.Utils.cast(obj, OrganizationReferent.class))).getHigher() != null) {
                m_Level++;
                b = getHigher().canBeGeneralFor((((OrganizationReferent)com.pullenti.unisharp.Utils.cast(obj, OrganizationReferent.class))).getHigher());
                m_Level--;
                if (b) 
                    return true;
            }
    ...
    private boolean _checkEqEponyms(OrganizationReferent __org) {
        ...
        if (this.findSlot(ATTR_EPONYM, null, true) != null && __org.findSlot(ATTR_EPONYM, null, true) != null) 
            return false;
        String s = __org.toString(true, com.pullenti.morph.MorphLang.UNKNOWN, 0);
        for (String e : getEponyms()) {
            if ((s.indexOf(e) >= 0)) 
                return true;
        }
        s = this.toString(true, com.pullenti.morph.MorphLang.UNKNOWN, 0);
    ...
    private boolean _canBeEquals(com.pullenti.ner.Referent obj, boolean ignoreGeoObjects, com.pullenti.ner.Referent.EqualType typ, int lev) {
        ...
        if (getNumber() != null || __org.getNumber() != null) {
            if (com.pullenti.unisharp.Utils.stringsNe(__org.getNumber(), getNumber())) {
                ...
                else if (typ == com.pullenti.ner.Referent.EqualType.FORMERGING && ((__org.getNumber() == null || this.getNumber() == null))) {
                }
                else 
                    return false;
            }
            ...
            if (((eqNumber || eqEponyms)) && ((this.findSlot(ATTR_NAME, null, true) == null || __org.findSlot(ATTR_NAME, null, true) == null))) {
                ...
                for (java.util.Map.Entry<String, Boolean> v : getNameVars().entrySet()) {
                    if (typ == com.pullenti.ner.Referent.EqualType.DIFFERENTTEXTS && v.getValue()) 
                        continue;
                    boolean b;
                    com.pullenti.unisharp.Outargwrapper<Boolean> wrapb2405 = new com.pullenti.unisharp.Outargwrapper<Boolean>();
                    boolean inoutres2406 = com.pullenti.unisharp.Utils.tryGetValue(__org.getNameVars(), v.getKey(), wrapb2405);
                    b = (wrapb2405.value != null ? wrapb2405.value : false);
                    if (!inoutres2406) 
                        continue;
                ...
                if ((maxLen < 2) && ((k1 == OrganizationKind.GOVENMENT || typ == com.pullenti.ner.Referent.EqualType.FORMERGING)) && typ != com.pullenti.ner.Referent.EqualType.DIFFERENTTEXTS) {
                    if (geos1.size() == geos2.size()) {
                        java.util.Collection<String> nams = (typ == com.pullenti.ner.Referent.EqualType.FORMERGING ? __org.getNameVars().keySet() : __org.getNames());
        ...
        if (this.findSlot(ATTR_EPONYM, null, true) != null || obj.findSlot(ATTR_EPONYM, null, true) != null) {
            if (typ == com.pullenti.ner.Referent.EqualType.FORMERGING && ((this.findSlot(ATTR_EPONYM, null, true) == null || obj.findSlot(ATTR_EPONYM, null, true) == null))) {
            }
            else {
                boolean ok = false;
                java.util.Collection<String> eps = this.getEponyms();
