...
public class OrgItemEngItem extends com.pullenti.ner.MetaToken {
    ...
    public static com.pullenti.ner.ReferentToken tryAttachOrg(com.pullenti.ner.Token t, boolean canBeCyr) {
        ...
        for (; t != null; t = t.getNext()) {
            ...
            if (t.isChar('(') && t.getNext() != null) {
                ...
                OrgItemTypeToken typ = OrgItemTypeToken.tryAttach(t.getNext(), true, null);
    ...
    public static void initialize() {
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Public Limited Company".toUpperCase(), "PLC");
        t.addAbridge("P.L.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Limited Liability Company".toUpperCase(), "LLC");
        t.addAbridge("L.L.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Limited Liability Partnership".toUpperCase(), "LLP");
        t.addAbridge("L.L.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Limited Liability Limited Partnership".toUpperCase(), "LLLP");
        t.addAbridge("L.L.L.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Limited Duration Company".toUpperCase(), "LDC");
        t.addAbridge("L.D.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("International Business Company".toUpperCase(), "IBC");
        t.addAbridge("I.B.S.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Joint stock company".toUpperCase(), "JSC");
        t.addAbridge("J.S.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Open Joint stock company".toUpperCase(), "OJSC");
        t.addAbridge("O.J.S.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Sosiedad Anonima".toUpperCase(), "SA");
        t.addVariant("Sociedad Anonima".toUpperCase(), false);
        t.addAbridge("S.A.");
        t.addVariant("SPA", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Société en commandite".toUpperCase(), "SC");
        t.addAbridge("S.C.");
        t.addVariant("SCS", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Societas Europaea".toUpperCase(), "SE");
        t.addAbridge("S.E.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Società in accomandita".toUpperCase(), "SAS");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Société en commandite par actions".toUpperCase(), "SCA");
        t.addAbridge("S.C.A.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Société en nom collectif".toUpperCase(), "SNC");
        t.addVariant("Società in nome collettivo".toUpperCase(), false);
        t.addAbridge("S.N.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("General Partnership".toUpperCase(), "GP");
        t.addVariant("General Partners", false);
        t.addAbridge("G.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Limited Partnership".toUpperCase(), "LP");
        t.addAbridge("L.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Kommanditaktiengesellschaft".toUpperCase(), "KGAA");
        t.addVariant("KOMMAG", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Societe a Responsidilite Limitee".toUpperCase(), "SRL");
        t.addAbridge("S.A.R.L.");
        t.addAbridge("S.R.L.");
        t.addVariant("SARL", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Società a garanzia limitata".toUpperCase(), "SAGL");
        t.addAbridge("S.A.G.L.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Società limitata".toUpperCase(), "SL");
        t.addAbridge("S.L.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Vennootschap Met Beperkte Aansparkelij kheid".toUpperCase(), "BV");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Vennootschap Met Beperkte Aansparkelij".toUpperCase(), "AVV");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Naamlose Vennootschap".toUpperCase(), "NV");
        t.addAbridge("N.V.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Gesellschaft mit beschrakter Haftung".toUpperCase(), "GMBH");
        t.addVariant("ГМБХ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Aktiengesellschaft".toUpperCase(), "AG");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("International Company".toUpperCase(), "IC");
        t.addAbridge("I.C.");
        m_Ontology.add(t);
        ...
        t.addVariant("& Company", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Kollektivgesellschaft".toUpperCase(), "KG");
        t.addAbridge("K.G.");
        t.addVariant("OHG", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new130("Kommanditgesellschaft".toUpperCase(), "KG");
