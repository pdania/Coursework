...
public class OrgItemNameToken extends com.pullenti.ner.MetaToken {
        ...
        if (t.isValue("ОРДЕНА", null) && t.getNext() != null) {
            ...
            if ((t.getWhitespacesAfterCount() < 2) && com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t.getNext(), true, false)) {
                ...
                if (br != null && (br.getLengthChar() < 40)) 
                    return _new1817(t, br.getEndToken(), true);
            }
        }
        ...
        if (res == null) {
            if (extOnto) {
                if (((t.getReferent() instanceof com.pullenti.ner.geo.GeoReferent)) || (((t instanceof com.pullenti.ner.TextToken) && !t.isChar(';')))) 
                    return _new1821(t, t, t.getSourceText());
            }
            return null;
        }
        if (prev == null && !extOnto) {
            if (t.kit.ontology != null) {
                com.pullenti.ner._org.OrganizationAnalyzer.OrgAnalyzerData ad = (com.pullenti.ner._org.OrganizationAnalyzer.OrgAnalyzerData)com.pullenti.unisharp.Utils.cast(t.kit.ontology._getAnalyzerData(com.pullenti.ner._org.OrganizationAnalyzer.ANALYZER_NAME), com.pullenti.ner._org.OrganizationAnalyzer.OrgAnalyzerData.class);
                if (ad != null) {
        ...
        if (m_StdNouns.tryParse(res.getEndToken(), com.pullenti.ner.core.TerminParseAttr.NO) != null) {
            ...
            for (com.pullenti.ner.Token tt = res.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                ...
                if ((npt2.getEndToken().isValue("УПРАВЛЕНИЕ", null) || npt2.getEndToken().isValue("ИНСТИТУТ", null) || npt2.getEndToken().isValue("УПРАВЛІННЯ", null)) || npt2.getEndToken().isValue("ІНСТИТУТ", null) || tt.getPrevious().isValue("ПРИ", null)) {
                    com.pullenti.ner.ReferentToken rt = tt.kit.processReferent(com.pullenti.ner._org.OrganizationAnalyzer.ANALYZER_NAME, tt);
                    if (rt != null) 
                        break;
                }
                cou++;
    ...
    private static OrgItemNameToken _TryAttach(com.pullenti.ner.Token t, OrgItemNameToken prev, boolean extOnto) {
        ...
        if (r != null) {
            if (com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), "DENOMINATION")) 
                return _new1822(t, t, r.toString(true, t.kit.baseLanguage, 0), true);
        ...
        if (tok != null) 
            return _new1823(t, tok.getEndToken(), tok.termin.getCanonicText(), tok.termin.tag == null, tok.termin.tag != null, tok.getMorph());
        if ((((tok = m_StdNames.tryParse(t, com.pullenti.ner.core.TerminParseAttr.NO)))) != null) 
            return _new1824(t, tok.getEndToken(), tok.termin.getCanonicText(), true);
        OrgItemEngItem eng = OrgItemEngItem.tryAttach(t, false);
        if (eng == null && t.isChar(',')) 
            eng = OrgItemEngItem.tryAttach(t.getNext(), false);
        if (eng != null) 
            return _new1825(t, eng.getEndToken(), eng.fullValue, true);
        ...
        if (tt.isChar(',') && prev != null) {
            ...
            if (ty != null) 
                return null;
            res = _new1826(npt1.getBeginToken(), npt1.getEndToken(), npt1.getMorph(), npt1.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false));
        ...
        if (((tt.isChar('&') || tt.isValue("AND", null) || tt.isValue("UND", null))) && prev != null) {
            if ((tt.getNext() instanceof com.pullenti.ner.TextToken) && tt.getLengthChar() == 1 && tt.getNext().chars.isLatinLetter()) {
                res = _new1827(tt, tt.getNext(), tt.getNext().chars);
                res.isAfterConjunction = true;
        ...
        if (!tt.chars.isLetter()) 
            return null;
        java.util.ArrayList<com.pullenti.morph.DerivateGroup> expinf = null;
        if (prev != null && prev.getEndToken().getMorphClassInDictionary().isNoun()) {
            ...
            expinf = com.pullenti.morph.Explanatory.findDerivates(wo, true, prev.getEndToken().getMorph().getLanguage());
        }
        ...
        if (npt != null && expinf != null) {
            for (com.pullenti.morph.DerivateGroup ei : expinf) {
        ...
        if (npt != null && ((explOk || npt.getMorph().getCase().isGenitive() || ((prev != null && !((com.pullenti.morph.MorphCase.ooBitand(prev.getMorph().getCase(), npt.getMorph().getCase()))).isUndefined()))))) {
            ...
            res = _new1826(npt.getBeginToken(), npt.getEndToken(), npt.getMorph(), npt.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false));
            res.isNounPhrase = true;
            if ((npt.getEndToken().getWhitespacesAfterCount() < 2) && (npt.getEndToken().getNext() instanceof com.pullenti.ner.TextToken)) {
                ...
                if (npt2 != null && npt2.getMorph().getCase().isGenitive() && npt2.chars.isAllLower()) {
                    ...
                    if (mv2.isAdjective() && mv2.isVerb()) {
                        com.pullenti.morph.MorphBaseInfo bi = com.pullenti.morph.MorphBaseInfo._new1829(npt.getMorph().getCase(), npt.getMorph().getGender(), npt.getMorph().getNumber());
                ...
                if (com.pullenti.unisharp.Utils.stringsEq(tt.term, "ПО")) 
                    ...
                    if (ok) {
                        if (OrgItemTypeToken.tryAttach(tt.getNext(), true, null) != null) 
                            ...
                            com.pullenti.ner.ReferentToken rt = tt.kit.processReferent(com.pullenti.ner._org.OrganizationAnalyzer.ANALYZER_NAME, tt.getNext());
                            if (rt != null) 
                                ok = false;
                        }
                    }
                    String s = npt.noun.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false);
                    ...
                    ok = npt.getMorph().getCase().isPrepositional();
                if (ok) {
                    res = _new1831(t, npt.getEndToken(), npt.getMorph(), npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.chars);
                    res.isNounPhrase = true;
            ...
            if (t1 != null && t1.chars.isLatinLetter() && !t1.chars.isAllLower()) {
                res = _new1832(t, t1, t1.chars, t1.getMorph());
        ...
        if (res == null) {
            ...
            res = _new1833(tt, tt, tt.term, tt.getMorph());
    ...
    public static void initialize() throws Exception, java.io.IOException {
        ...
        for (String s : new String[] {"ЗАКАЗЧИК", "ИСПОЛНИТЕЛЬ", "РАЗРАБОТЧИК", "БЕНЕФИЦИАР", "ПОЛУЧАТЕЛЬ", "ОТПРАВИТЕЛЬ", "ИЗГОТОВИТЕЛЬ", "ПРОИЗВОДИТЕЛЬ", "ПОСТАВЩИК", "АБОНЕНТ", "КЛИЕНТ", "ВКЛАДЧИК", "СУБЪЕКТ", "ПРОДАВЕЦ", "ПОКУПАТЕЛЬ", "АРЕНДОДАТЕЛЬ", "АРЕНДАТОР", "СУБАРЕНДАТОР", "НАЙМОДАТЕЛЬ", "НАНИМАТЕЛЬ", "АГЕНТ", "ПРИНЦИПАЛ", "ПРОДАВЕЦ", "ПОСТАВЩИК", "ПОДРЯДЧИК", "СУБПОДРЯДЧИК"}) {
            m_StdTails.add(com.pullenti.ner.core.Termin._new135(s, s));
        }
        for (String s : new String[] {"ЗАМОВНИК", "ВИКОНАВЕЦЬ", "РОЗРОБНИК", "БЕНЕФІЦІАР", "ОДЕРЖУВАЧ", "ВІДПРАВНИК", "ВИРОБНИК", "ВИРОБНИК", "ПОСТАЧАЛЬНИК", "АБОНЕНТ", "КЛІЄНТ", "ВКЛАДНИК", "СУБ'ЄКТ", "ПРОДАВЕЦЬ", "ПОКУПЕЦЬ", "ОРЕНДОДАВЕЦЬ", "ОРЕНДАР", "СУБОРЕНДАР", "НАЙМОДАВЕЦЬ", "НАЙМАЧ", "АГЕНТ", "ПРИНЦИПАЛ", "ПРОДАВЕЦЬ", "ПОСТАЧАЛЬНИК", "ПІДРЯДНИК", "СУБПІДРЯДНИК"}) {
            m_StdTails.add(com.pullenti.ner.core.Termin._new472(s, com.pullenti.morph.MorphLang.UA, s));
        }
        ...
        for (int k = 0; k < 2; k++) {
            ...
            for (String line0 : com.pullenti.unisharp.Utils.split(str, String.valueOf('\n'), false)) {
                ...
                if (k == 0) 
                    ...
                    m_StdNouns.add(com.pullenti.ner.core.Termin._new922(line, com.pullenti.morph.MorphLang.UA));
            }
        }
    }

    public static OrgItemNameToken _new1817(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.isIgnoredPart = _arg3;
        return res;
    }

    public static OrgItemNameToken _new1821(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        return res;
    }

    public static OrgItemNameToken _new1822(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, boolean _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
    ...
    public static OrgItemNameToken _new1823(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, boolean _arg4, boolean _arg5, com.pullenti.ner.MorphCollection _arg6) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.isStdTail = _arg4;
    ...
    public static OrgItemNameToken _new1824(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, boolean _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.isStdName = _arg4;
        return res;
    ...
    public static OrgItemNameToken _new1825(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, boolean _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.isStdTail = _arg4;
        return res;
    ...
    public static OrgItemNameToken _new1826(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3, String _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.setMorph(_arg3);
        res.value = _arg4;
        return res;
    ...
    public static OrgItemNameToken _new1827(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.morph.CharsInfo _arg3) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.chars = _arg3;
        return res;
    }

    public static OrgItemNameToken _new1831(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3, String _arg4, com.pullenti.morph.CharsInfo _arg5) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.setMorph(_arg3);
        res.value = _arg4;
        res.chars = _arg5;
    ...
    public static OrgItemNameToken _new1832(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.morph.CharsInfo _arg3, com.pullenti.ner.MorphCollection _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.chars = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static OrgItemNameToken _new1833(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.MorphCollection _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static OrgItemNameToken _new2377(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.isStdName = _arg3;
        return res;
    }

    public static OrgItemNameToken _new2379(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.morph.CharsInfo _arg4) {
        OrgItemNameToken res = new OrgItemNameToken(_arg1, _arg2);
        res.value = _arg3;
        res.chars = _arg4;
        return res;
