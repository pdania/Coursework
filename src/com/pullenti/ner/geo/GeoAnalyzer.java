...
public class GeoAnalyzer extends com.pullenti.ner.Analyzer {
            ...
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                ...
                if (step > 0 && (t instanceof com.pullenti.ner.ReferentToken)) {
                    ...
                    if (((_geo != null && t.getNext() != null && t.getNext().isChar('(')) && t.getNext().getNext() != null && _geo.canBeEquals(t.getNext().getNext().getReferent(), com.pullenti.ner.Referent.EqualType.WITHINONETEXT)) && t.getNext().getNext().getNext() != null && t.getNext().getNext().getNext().isChar(')')) {
                        com.pullenti.ner.ReferentToken rt0 = com.pullenti.ner.ReferentToken._new767(_geo, t, t.getNext().getNext().getNext(), t.getMorph());
                        kit.embedToken(rt0);
                        t = rt0;
                        continue;
                    }
                    if ((_geo != null && t.getNext() != null && t.getNext().isHiphen()) && t.getNext().getNext() != null && _geo.canBeEquals(t.getNext().getNext().getReferent(), com.pullenti.ner.Referent.EqualType.WITHINONETEXT)) {
                        com.pullenti.ner.ReferentToken rt0 = com.pullenti.ner.ReferentToken._new767(_geo, t, t.getNext().getNext(), t.getMorph());
                        kit.embedToken(rt0);
                        t = rt0;
                        continue;
                    }
                        ...
                        if (rt == null && (((GeoReferent)com.pullenti.unisharp.Utils.cast(cli.get(0).ontoItem.referent, GeoReferent.class))).isState()) {
                            if ((rt == null && tt != null && (tt.getReferent() instanceof GeoReferent)) && tt.getWhitespacesBeforeCount() == 1) {
                                ...
                                if (com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigher((GeoReferent)com.pullenti.unisharp.Utils.cast(cli.get(0).ontoItem.referent, GeoReferent.class), geo2)) {
                                    ...
                                    rt = com.pullenti.ner.ReferentToken._new767(cl, cli.get(0).getBeginToken(), cli.get(0).getEndToken(), cli.get(0).getMorph());
                                }
                            }
                            if (rt == null && step == 0) {
        ...
        if (newCities && ad.localOntology.getItems().size() > 0) {
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                ...
                if (_geo != null) {
                    ...
                    com.pullenti.ner.ReferentToken rt = com.pullenti.ner.ReferentToken._new767(_geo, li.get(0).getBeginToken(), li.get(0).getEndToken(), t.getMorph());
        ...
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            ...
            if (geo2 != null) {
                if ((comma1 && comma2 && com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(t, tt)) && com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(tt, ttt)) {
                    geo2.setHigher(geo1);
                    geo1.setHigher(_geo);
                    com.pullenti.ner.ReferentToken rt = com.pullenti.ner.ReferentToken._new767(geo2, t, ttt, ttt.getMorph());
                    kit.embedToken(rt);
                    t = rt;
                    goBack = true;
                    continue;
                    ...
                    if (com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(t, ttt)) {
                        geo2.setHigher(_geo);
                        geo1.setHigher(geo2);
                        com.pullenti.ner.ReferentToken rt = com.pullenti.ner.ReferentToken._new767(geo1, t, ttt, t.getMorph());
                        kit.embedToken(rt);
                        t = rt;
                        goBack = true;
                        continue;
                    ...
                    if (com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(ttt, t) && com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(t, tt)) {
                        _geo.setHigher(geo2);
                        geo1.setHigher(_geo);
                        com.pullenti.ner.ReferentToken rt = com.pullenti.ner.ReferentToken._new767(geo1, t, ttt, tt.getMorph());
                        kit.embedToken(rt);
                        t = rt;
                        goBack = true;
                        continue;
                    ...
                    if (com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(tt, t)) {
                        _geo.setHigher(geo1);
                        geo1.setHigher(geo2);
                        com.pullenti.ner.ReferentToken rt = com.pullenti.ner.ReferentToken._new767(_geo, t, ttt, t.getMorph());
                        kit.embedToken(rt);
                        t = rt;
                        goBack = true;
                        continue;
            ...
            if (com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(t, tt) && ((!com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(tt, t) || adj))) {
                geo1.setHigher(_geo);
                com.pullenti.ner.ReferentToken rt = com.pullenti.ner.ReferentToken._new767(geo1, t, tt, tt.getMorph());
            ...
            if (com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(tt, t) && ((!com.pullenti.ner.geo.internal.GeoOwnerHelper.canBeHigherToken(t, tt) || inp))) {
                ...
                if (bra && tt.getNext() != null && tt.getNext().isChar(')')) 
                    tt = tt.getNext();
                com.pullenti.ner.ReferentToken rt = com.pullenti.ner.ReferentToken._new767(_geo, t, tt, t.getMorph());
                kit.embedToken(rt);
                t = rt;
                goBack = true;
                continue;
    ...
    private com.pullenti.ner.ReferentToken tryAttachTerritoryAfterCity(com.pullenti.ner.Token t, com.pullenti.ner.core.AnalyzerDataWithOntology ad) {
        ...
        for (int i = 0; i < 2; i++) {
            com.pullenti.ner.geo.internal.TerrItemToken tit0 = com.pullenti.ner.geo.internal.TerrItemToken.tryParse(tt, ad.localOntology, false, false, null);
    ...
    public com.pullenti.ner.ReferentToken processReferent(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        ...
        java.util.ArrayList<com.pullenti.ner.core.TerminToken> toks = com.pullenti.ner.geo.internal.CityItemToken.M_CITYADJECTIVES.tryParseAll(begin, com.pullenti.ner.core.TerminParseAttr.FULLWORDSONLY, 0.0);
        begin.kit.recurseLevel--;
        if (toks != null) {
            for (com.pullenti.ner.core.TerminToken tok : toks) {
                ...
                return com.pullenti.ner.ReferentToken._new1290(city, tok.getBeginToken(), tok.getEndToken(), tok.getMorph(), begin.kit.getAnalyzerData(this));
            }
            return null;
        }
        ...
        if (!begin.getMorph()._getClass().isAdjective()) {
            ...
            if ((te.chars.isAllUpper() && te.chars.isCyrillicLetter() && te.getLengthChar() == 2) && te.getMorphClassInDictionary().isUndefined()) {
                ...
                if (cou == 1) 
                    return com.pullenti.ner.ReferentToken._new132(geo0, begin, begin, ad);
            }
            com.pullenti.ner.geo.internal.TerrItemToken tt0 = com.pullenti.ner.geo.internal.TerrItemToken.tryParse(begin, ad.localOntology, true, false, null);
            if (tt0 != null && tt0.terminItem != null && com.pullenti.unisharp.Utils.stringsEq(tt0.terminItem.getCanonicText(), "РАЙОН")) {
                com.pullenti.ner.geo.internal.TerrItemToken tt1 = com.pullenti.ner.geo.internal.TerrItemToken.tryParse(tt0.getEndToken().getNext(), ad.localOntology, true, false, null);
            ...
            if ((ctoks != null && ctoks.size() == 1 && ctoks.get(0).typ == com.pullenti.ner.geo.internal.CityItemToken.ItemType.NOUN) && com.pullenti.unisharp.Utils.stringsEq(ctoks.get(0).value, "ГОРОД")) {
                ...
                for (com.pullenti.ner.Token t = begin.getPrevious(); t != null; t = t.getPrevious()) {
                    ...
                    for (com.pullenti.ner.Referent g : geos) {
                        ...
                        if (gg != null) {
                            if (gg.isCity()) 
                                return com.pullenti.ner.ReferentToken._new1290(gg, begin, ctoks.get(0).getEndToken(), ctoks.get(0).getMorph(), ad);
                            if (gg.getHigher() != null && gg.getHigher().isCity()) 
                                return com.pullenti.ner.ReferentToken._new1290(gg.getHigher(), begin, ctoks.get(0).getEndToken(), ctoks.get(0).getMorph(), ad);
                        }
                    }
                }
            }
        ...
        begin.kit.recurseLevel++;
        com.pullenti.ner.geo.internal.TerrItemToken tt = com.pullenti.ner.geo.internal.TerrItemToken.tryParse(begin, ad.localOntology, true, false, null);
        begin.kit.recurseLevel--;
        if (tt == null || tt.ontoItem == null) {
            ...
            if ((tok != null && tok.get(0).item != null && (tok.get(0).item.referent instanceof GeoReferent)) && (((GeoReferent)com.pullenti.unisharp.Utils.cast(tok.get(0).item.referent, GeoReferent.class))).isState()) 
                tt = com.pullenti.ner.geo.internal.TerrItemToken._new1196(tok.get(0).getBeginToken(), tok.get(0).getEndToken(), tok.get(0).item);
        }
        if (tt == null) 
            return null;
        if (tt.ontoItem != null) {
        ...
        if (tt.ontoItem == null) {
            ...
            if (t1 == null) 
                return null;
            begin.kit.recurseLevel++;
            com.pullenti.ner.geo.internal.TerrItemToken ttyp = com.pullenti.ner.geo.internal.TerrItemToken.tryParse(t1, ad.localOntology, true, true, null);
            begin.kit.recurseLevel--;
    ...
    public com.pullenti.ner.ReferentToken processOntologyItem(com.pullenti.ner.Token begin) {
        ...
        for (com.pullenti.ner.Token t = begin; t != null; t = t.getNext()) {
            ...
            for (com.pullenti.ner.Token tt = t0; tt != null; tt = tt.getNext()) {
                if (tt.isCharOf(";")) 
                    break;
                com.pullenti.ner.geo.internal.TerrItemToken tit = com.pullenti.ner.geo.internal.TerrItemToken.tryParse(tt, null, false, false, null);
