...
public class GeoReferent extends com.pullenti.ner.Referent {
        ...
        if (isUnion() && !isState()) {
            ...
            for (com.pullenti.ner.Slot s : getSlots()) {
                if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), ATTR_REF) && (s.getValue() instanceof com.pullenti.ner.Referent)) 
                    res.append("; ").append((((com.pullenti.ner.Referent)com.pullenti.unisharp.Utils.cast(s.getValue(), com.pullenti.ner.Referent.class))).toString(true, lang, 0));
            }
            return res.toString();
        }
    ...
    private void _recalcTmpBits() {
        ...
        for (com.pullenti.ner.Slot t : getSlots()) {
            if (com.pullenti.unisharp.Utils.stringsEq(t.getTypeName(), ATTR_TYPE)) {
                ...
                if (com.pullenti.unisharp.Utils.stringsEq(val, "территория") || com.pullenti.unisharp.Utils.stringsEq(val, "територія") || com.pullenti.unisharp.Utils.stringsEq(val, "territory")) {
    ...
    public void mergeSlots2(com.pullenti.ner.Referent obj, com.pullenti.morph.MorphLang lang) {
        ...
        if (isTerritory()) {
            if (((getAlpha2() != null || this.findSlot(ATTR_TYPE, "государство", true) != null || this.findSlot(ATTR_TYPE, "держава", true) != null) || this.findSlot(ATTR_TYPE, "империя", true) != null || this.findSlot(ATTR_TYPE, "імперія", true) != null) || this.findSlot(ATTR_TYPE, "state", true) != null) {
                com.pullenti.ner.Slot s = this.findSlot(ATTR_TYPE, "территория", true);
                if (s != null) 
                    getSlots().remove(s);
            }
        }
    ...
    public void addOrgReferent(com.pullenti.ner.Referent _org) {
        ...
        for (com.pullenti.ner.Slot s : _org.getSlots()) {
            if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), "NAME")) {
                if (num == null) 
                    this.addName((String)com.pullenti.unisharp.Utils.cast(s.getValue(), String.class));
                else 
                    this.addName((s.getValue().toString() + "-" + num));
                nam = true;
            }
        ...
        if (!nam) 
            this.addName(_org.toString(true, com.pullenti.morph.MorphLang.UNKNOWN, 0).toUpperCase());
    }
}
