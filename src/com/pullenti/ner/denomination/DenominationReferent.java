    ...
    private static void addVars(String str, java.util.ArrayList<String> vars) {
        ...
        for (int k = 0; k < 2; k++) {
            ...
            for (i = 0; i < str.length(); i++) {
                String v;
                com.pullenti.unisharp.Outargwrapper<String> wrapv1143 = new com.pullenti.unisharp.Outargwrapper<String>();
                boolean inoutres1144 = com.pullenti.unisharp.Utils.tryGetValue(m_VarChars, str.charAt(i), wrapv1143);
                v = wrapv1143.value;
                if (!inoutres1144) 
                    break;
