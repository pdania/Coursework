...
public class WeaponAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.Collection<com.pullenti.ner.ReferentClass> getTypeSystem() {
        return java.util.Arrays.asList(new com.pullenti.ner.ReferentClass[] {com.pullenti.ner.weapon.internal.MetaWeapon.globalMeta});
    }
                        ...
                        if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_MODEL)) {
                            ...
                            for (int k = 0; k < 2; k++) {
                                if (!Character.isDigit(mod.charAt(0))) {
                                    ...
                                    com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2848 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
                                    boolean inoutres2849 = com.pullenti.unisharp.Utils.tryGetValue(objsByModel, mod, wrapli2848);
                                    li = wrapli2848.value;
                                    if (!inoutres2849) 
