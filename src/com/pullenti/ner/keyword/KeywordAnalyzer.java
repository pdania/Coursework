...
public class KeywordAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public int annotationMaxSentences = 3;
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        ...
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext(),cur++) {
            ...
            npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.of((com.pullenti.ner.core.NounPhraseParseAttr.ADJECTIVECANBELAST.value()) | (com.pullenti.ner.core.NounPhraseParseAttr.PARSEPREPOSITION.value())), 0);
            if (npt == null) {
                ...
                if (mc.isVerb() && !mc.isPreposition()) {
                    ...
                    if (t.isValue("МОЧЬ", null) || t.isValue("WOULD", null)) 
                        continue;
                    KeywordReferent kref = KeywordReferent._new1608(KeywordType.PREDICATE);
                    String norm = t.getNormalCaseText(com.pullenti.morph.MorphClass.VERB, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                    if (norm == null) 
                        norm = (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).getLemma();
                    ...
                    com.pullenti.ner.ReferentToken rt1 = com.pullenti.ner.ReferentToken._new767(ad.registerReferent(kref), t, t, t.getMorph());
                    kit.embedToken(rt1);
                    t = rt1;
                    continue;
                }
            ...
            for (com.pullenti.ner.Token tt = t; tt != null && tt.endChar <= npt.endChar; tt = tt.getNext()) {
                ...
                KeywordReferent kref = KeywordReferent._new1608(KeywordType.OBJECT);
                String norm = (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).getLemma();
                kref.addSlot(KeywordReferent.ATTR_VALUE, norm, false, 0);
                ...
                kref = (KeywordReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(kref), KeywordReferent.class);
                _setRank(kref, cur, max);
                com.pullenti.ner.ReferentToken rt1 = com.pullenti.ner.ReferentToken._new767(kref, tt, tt, tt.getMorph());
                kit.embedToken(rt1);
                if (tt == t && li.size() == 0) 
                    t0 = rt1;
                t = rt1;
            ...
            if (li.size() > 1) {
                ...
                String val = npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                ...
                kref = (KeywordReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(kref), KeywordReferent.class);
                _setRank(kref, cur, max);
                com.pullenti.ner.ReferentToken rt1 = com.pullenti.ner.ReferentToken._new767(kref, t0, t, npt.getMorph());
                kit.embedToken(rt1);
                t = rt1;
            }
        }
        ...
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext(),cur++) {
            ...
            com.pullenti.ner.ReferentToken rt1 = com.pullenti.ner.ReferentToken._new767(kwUn, t, t1, t.getMorph());
            kit.embedToken(rt1);
            t = rt1;
        }
    ...
    private static int _calcRank(com.pullenti.morph.DerivateGroup gr) {
        if (gr.isDummy) 
            return 0;
        int res = 0;
    ...
    private static void _addNormals(KeywordReferent kref, java.util.ArrayList<com.pullenti.morph.DerivateGroup> grs, String norm) {
        ...
        for (int k = 0; k < grs.size(); k++) {
            ...
            for (int i = 0; i < (grs.size() - 1); i++) {
                if (_calcRank(grs.get(i)) < _calcRank(grs.get(i + 1))) {
                    com.pullenti.morph.DerivateGroup gr = grs.get(i);
    ...
    private com.pullenti.ner.Token _addReferents(com.pullenti.ner.core.AnalyzerData ad, com.pullenti.ner.Token t, int cur, int max) {
        ...
        if (r instanceof com.pullenti.ner.denomination.DenominationReferent) {
            ...
            KeywordReferent kref0 = KeywordReferent._new1608(KeywordType.REFERENT);
        ...
        if (r instanceof com.pullenti.ner.money.MoneyReferent) {
            ...
            KeywordReferent kref0 = KeywordReferent._new1608(KeywordType.OBJECT);
        ...
        KeywordReferent kref = KeywordReferent._new1608(KeywordType.REFERENT);
        String norm = null;
