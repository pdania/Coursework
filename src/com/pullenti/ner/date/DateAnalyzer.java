...
public class DateAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public static class DateAnalizerData extends com.pullenti.ner.core.AnalyzerData {
        ...
        public com.pullenti.ner.Referent registerReferent(com.pullenti.ner.Referent referent) {
            ...
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent> wrapdr746 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent>();
            boolean inoutres747 = com.pullenti.unisharp.Utils.tryGetValue(m_Hash, key, wrapdr746);
            dr = wrapdr746.value;
            if (inoutres747) 
                return dr;
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        DateAnalizerData ad = (DateAnalizerData)com.pullenti.unisharp.Utils.cast(kit.getAnalyzerData(this), DateAnalizerData.class);
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            ...
            java.util.ArrayList<com.pullenti.ner.ReferentToken> rts = this.tryAttach(pli, high);
            if (rts != null) {
                ...
                for (int i = 0; i < rts.size(); i++) {
                    ...
                    if ((i < (rts.size() - 1)) && rt.tag == null) 
                        rt.referent.addOccurence(com.pullenti.ner.TextAnnotation._new748(kit.getSofa(), rt.beginChar, rt.endChar, rt.referent));
                    else {
                ...
                if ((dat != null && t.getPrevious() != null && t.getPrevious().isHiphen()) && t.getPrevious().getPrevious() != null && (t.getPrevious().getPrevious().getReferent() instanceof DateReferent)) {
                    ...
                    DateRangeReferent dr = (DateRangeReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateRangeReferent._new749(dat0, dat)), DateRangeReferent.class);
                ...
                if ((dat != null && t.getPrevious() != null && ((t.getPrevious().isHiphen() || t.getPrevious().isValue("ПО", null) || t.getPrevious().isValue("И", null)))) && (t.getPrevious().getPrevious() instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getPrevious().getPrevious(), com.pullenti.ner.NumberToken.class))).getIntValue() != null) {
                    ...
                    if (dat.getDay() > 0 && (num < dat.getDay()) && num > 0) {
                        if (dat.getHigher() != null) 
                            dat0 = DateReferent._new750(dat.getHigher(), num);
                        else if (dat.getMonth() > 0) 
                            dat0 = DateReferent._new751(dat.getMonth(), num);
                    }
                    else if (dat.getYear() > 0 && (num < dat.getYear()) && num > 1000) 
                        dat0 = DateReferent._new752(num);
                    if (dat0 != null) {
    ...
    public com.pullenti.ner.ReferentToken processReferent(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        ...
        if (begin.isValue("ДО", null) && (begin.getNext() instanceof com.pullenti.ner.ReferentToken) && (begin.getNext().getReferent() instanceof DateReferent)) {
            DateRangeReferent drr = DateRangeReferent._new754((DateReferent)com.pullenti.unisharp.Utils.cast(begin.getNext().getReferent(), DateReferent.class));
            com.pullenti.ner.ReferentToken res1 = new com.pullenti.ner.ReferentToken(drr, begin, begin.getNext(), null);
            res1.data = (DateAnalizerData)com.pullenti.unisharp.Utils.cast(begin.kit.getAnalyzerData(this), DateAnalizerData.class);
            return res1;
        }
        ...
        if (pli == null || pli.size() == 0) 
            return null;
        java.util.ArrayList<com.pullenti.ner.ReferentToken> rts = this.tryAttach(pli, true);
        if (rts == null || rts.size() == 0) 
            return null;
        DateAnalizerData ad = (DateAnalizerData)com.pullenti.unisharp.Utils.cast(begin.kit.getAnalyzerData(this), DateAnalizerData.class);
    ...
    private java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttach(java.util.ArrayList<com.pullenti.ner.date.internal.DateItemToken> dts, boolean high) {
        ...
        if ((dts.get(0).canBeHour() && dts.size() > 2 && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM) && dts.get(2).intValue >= 0 && (dts.get(2).intValue < 60)) {
            if (dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR || ((dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.NUMBER && ((dts.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR || dts.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.NUMBER))))) {
                if (dts.size() > 3 && dts.get(3).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM && com.pullenti.unisharp.Utils.stringsEq(dts.get(3).stringValue, dts.get(1).stringValue)) {
                    ...
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> res1 = this.tryAttach(dts1, false);
                    if (res1 != null && (res1.get(res1.size() - 1).referent instanceof DateReferent) && (((DateReferent)com.pullenti.unisharp.Utils.cast(res1.get(res1.size() - 1).referent, DateReferent.class))).getDay() > 0) {
                        DateReferent time = DateReferent._new755(dts.get(0).intValue, dts.get(2).intValue);
        ...
        boolean b = false;
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapyear800 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapmon801 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapday802 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
        b = this.applyRuleFormal(dts, high, wrapyear800, wrapmon801, wrapday802);
        year = wrapyear800.value;
        mon = wrapmon801.value;
        day = wrapday802.value;
        if (b) {
        ...
        if (dts.size() == 1 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.POINTER && com.pullenti.unisharp.Utils.stringsEq(dts.get(0).stringValue, "сегодня")) {
            java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
            res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new756(DatePointerType.TODAY), dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
            return res0;
        }
        if (dts.size() == 1 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.YEAR && dts.get(0).getYear() <= 0) {
            java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
            res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new756(DatePointerType.UNDEFINED), dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
            return res0;
        }
        ...
        if (!b) {
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapyear758 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapmon759 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapday760 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<Boolean> wrapyearIsDif761 = new com.pullenti.unisharp.Outargwrapper<Boolean>();
            b = this.applyRuleWithMonth(dts, high, wrapyear758, wrapmon759, wrapday760, wrapyearIsDif761);
            year = wrapyear758.value;
            mon = wrapmon759.value;
            day = wrapday760.value;
            yearIsDif = (wrapyearIsDif761.value != null ? wrapyearIsDif761.value : false);
        }
        if (!b) {
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapyear762 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapmon763 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapday764 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            b = this.applyRuleYearOnly(dts, wrapyear762, wrapmon763, wrapday764);
            year = wrapyear762.value;
            mon = wrapmon763.value;
            day = wrapday764.value;
        }
        if (!b) {
            if (dts.size() == 2 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MINUTE) {
                ...
                if (t00 != null && (((t00.isValue("ТЕЧЕНИЕ", null) || t00.isValue("ПРОТЯГОМ", null) || t00.isValue("ЧЕРЕЗ", null)) || t00.isValue("ТЕЧІЮ", null)))) {
                    ...
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                    DateReferent time = DateReferent._new755(dts.get(0).intValue, dts.get(1).intValue);
            ...
            if ((dts.size() == 4 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM) && dts.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH && dts.get(3).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.YEAR) {
                java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                DateReferent yea = DateReferent._new752(dts.get(3).intValue);
                res0.add(com.pullenti.ner.ReferentToken._new767(yea, dts.get(3).getBeginToken(), dts.get(3).getEndToken(), dts.get(3).getMorph()));
                DateReferent mon1 = DateReferent._new768(dts.get(0).intValue, yea);
                res0.add(com.pullenti.ner.ReferentToken._new769(mon1, dts.get(0).getBeginToken(), dts.get(0).getEndToken(), mon1));
                DateReferent mon2 = DateReferent._new768(dts.get(2).intValue, yea);
            ...
            if (((dts.size() >= 4 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.NUMBER && dts.get(0).canBeDay()) && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM && dts.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.NUMBER) && dts.get(2).canBeDay() && dts.get(3).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH) {
                if (dts.size() == 4 || ((dts.size() == 5 && dts.get(4).canBeYear()))) {
                    ...
                    if (dts.size() == 5) 
                        res0.add(new com.pullenti.ner.ReferentToken((yea = DateReferent._new752(dts.get(4).getYear())), dts.get(4).getBeginToken(), dts.get(4).getEndToken(), null));
                    DateReferent mo = DateReferent._new768(dts.get(3).intValue, yea);
                    res0.add(new com.pullenti.ner.ReferentToken(mo, dts.get(3).getBeginToken(), dts.get(dts.size() - 1).getEndToken(), null));
                    DateReferent da1 = DateReferent._new773(dts.get(0).intValue, mo);
                    res0.add(new com.pullenti.ner.ReferentToken(da1, dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
                    DateReferent da2 = DateReferent._new773(dts.get(2).intValue, mo);
            ...
            if ((dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH && dts.size() == 1 && dts.get(0).getEndToken().getNext() != null) && ((dts.get(0).getEndToken().getNext().isHiphen() || dts.get(0).getEndToken().getNext().isValue("ПО", null) || dts.get(0).getEndToken().getNext().isValue("НА", null)))) {
                com.pullenti.ner.ReferentToken rt = dts.get(0).kit.processReferent(ANALYZER_NAME, dts.get(0).getEndToken().getNext().getNext());
                if (rt != null) {
                    ...
                    if ((dr0 != null && dr0.getYear() > 0 && dr0.getMonth() > 0) && dr0.getDay() == 0 && dr0.getMonth() > dts.get(0).intValue) {
                        DateReferent drYear0 = DateReferent._new752(dr0.getYear());
                        java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                        res0.add(new com.pullenti.ner.ReferentToken(drYear0, dts.get(0).getEndToken(), dts.get(0).getEndToken(), null));
                        DateReferent drMon0 = DateReferent._new768(dts.get(0).intValue, drYear0);
            ...
            if (((dts.size() == 3 && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM && dts.get(1).getBeginToken().isHiphen()) && dts.get(0).canBeYear() && dts.get(2).canBeYear()) && (dts.get(0).intValue < dts.get(2).intValue)) {
                ...
                if (ok) {
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                    res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new752(dts.get(0).getYear()), dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
                    res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new752(dts.get(2).getYear()), dts.get(2).getBeginToken(), dts.get(2).getEndToken(), null));
                    return res0;
                }
            }
            ...
            if (dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.QUARTAL || dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HALFYEAR) {
                if (dts.size() == 1 || dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.YEAR) {
                    ...
                    if (dts.size() > 1) {
                        ii = 1;
                        yea = DateReferent._new752(dts.get(1).intValue);
                        res0.add(com.pullenti.ner.ReferentToken._new767(yea, dts.get(1).getBeginToken(), dts.get(1).getEndToken(), dts.get(1).getMorph()));
                    }
                    else {
                        int cou = 0;
            ...
            if ((dts.size() == 3 && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM && ((com.pullenti.unisharp.Utils.stringsEq(dts.get(1).stringValue, ".") || com.pullenti.unisharp.Utils.stringsEq(dts.get(1).stringValue, ":")))) && dts.get(0).canBeHour() && dts.get(2).canBeMinute()) {
                ...
                if (ok) {
                    ...
                    if (tt1.getNext() != null && tt1.getNext().isValue("ЧАС", null)) {
                        ...
                        if (dtsli != null) {
                            java.util.ArrayList<com.pullenti.ner.ReferentToken> res1 = this.tryAttach(dtsli, true);
            ...
            if ((dts.size() == 1 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH && dts.get(0).getBeginToken().getPrevious() != null) && dts.get(0).getBeginToken().getPrevious().getMorph()._getClass().isPreposition()) {
                if (dts.get(0).chars.isLatinLetter() && dts.get(0).chars.isAllLower()) {
                    ...
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                    res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new789(dts.get(0).intValue), dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
                    return res0;
                }
            }
            return null;
        ...
        if (cent != null) {
            DateReferent ce = DateReferent._new790((cent.newAge < 0 ? -cent.intValue : cent.intValue));
        ...
        if (year != null && year.getYear() > 0) {
            drYear = DateReferent._new752((year.newAge < 0 ? -year.getYear() : year.getYear()));
            if (!yearIsDif) {
                t1 = year.getEndToken();
            ...
            res.add(com.pullenti.ner.ReferentToken._new767(drYear, (t0 = year.getBeginToken()), year.getEndToken(), year.getMorph()));
        }
        if (mon != null) {
            drMon = DateReferent._new789(mon.intValue);
            if (drYear != null) 
            ...
            if (drYear == null && t1.getNext() != null && ((t1.getNext().isValue("ПО", null) || t1.getNext().isValue("НА", null)))) {
                com.pullenti.ner.ReferentToken rt = t1.kit.processReferent(ANALYZER_NAME, t1.getNext().getNext());
                if (rt != null) {
                    DateReferent dr0 = (DateReferent)com.pullenti.unisharp.Utils.cast(rt.referent, DateReferent.class);
                    if (dr0 != null && dr0.getYear() > 0 && dr0.getMonth() > 0) {
                        drYear = DateReferent._new752(dr0.getYear());
                        res.add(new com.pullenti.ner.ReferentToken(drYear, (t0 = t1), t1, null));
                        drMon.setHigher(drYear);
                    }
                }
            }
            res.add(com.pullenti.ner.ReferentToken._new767(drMon, t0, t1, mon.getMorph()));
            if (day != null) {
                drDay = DateReferent._new796(day.intValue);
                ...
                res.add(com.pullenti.ner.ReferentToken._new767(drDay, t0, t1, day.getMorph()));
                if (dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MINUTE) {
                    DateReferent hou = DateReferent._new798(drDay);
        ...
        if (point != null && res.size() > 0) {
            ...
            if (com.pullenti.unisharp.Utils.stringsEq(point.stringValue, "начало")) 
                poi.setPointer(DatePointerType.BEGIN);
            else if (com.pullenti.unisharp.Utils.stringsEq(point.stringValue, "середина")) 
                poi.setPointer(DatePointerType.CENTER);
            else if (com.pullenti.unisharp.Utils.stringsEq(point.stringValue, "конец")) 
        ...
        if (drDay != null && !yearIsDif) {
            com.pullenti.ner.ReferentToken rt = this.tryAttachTime(t1.getNext(), true);
            if (rt != null) {
        ...
        if (res.size() == 1) {
            ...
            if (dt0.getMonth() == 0) {
                ...
                if (tt != null && tt.isCharOf("(,")) {
                    com.pullenti.ner.date.internal.DateItemToken dit = com.pullenti.ner.date.internal.DateItemToken.tryAttach(tt.getNext(), null, false);
                    if (dit != null && dit.typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH) {
                        drMon = DateReferent._new799(dt0, dit.intValue);
    ...
    private com.pullenti.ner.ReferentToken tryAttachTimeLi(java.util.ArrayList<com.pullenti.ner.date.internal.DateItemToken> dts, boolean afterDate) {
        ...
        if (dts.size() == 1) {
            if (dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR && afterDate) {
                time = DateReferent._new755(dts.get(0).intValue, 0);
            ...
            time = DateReferent._new755(dts.get(0).intValue, dts.get(1).intValue);
            ...
            time = DateReferent._new755(dts.get(0).intValue, dts.get(2).intValue);
            t1 = dts.get(2).getEndToken();
        ...
        if (time == null) 
            return null;
        com.pullenti.ner.Token tt = this._corrTime(t1.getNext(), time);
        if (tt != null) 
            t1 = tt;
        int cou = 0;
    ...
    private boolean applyRuleWithMonth(java.util.ArrayList<com.pullenti.ner.date.internal.DateItemToken> its, boolean high, com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> year, com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> mon, com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> day, com.pullenti.unisharp.Outargwrapper<Boolean> yearIsDiff) {
        ...
        if (com.pullenti.morph.MorphLang.ooNoteq((com.pullenti.morph.MorphLang.ooBitand(lang, (com.pullenti.morph.MorphLang.ooBitor(com.pullenti.morph.MorphLang.ooBitor(com.pullenti.morph.MorphLang.RU, com.pullenti.morph.MorphLang.ooBitor(com.pullenti.morph.MorphLang.IT, com.pullenti.morph.MorphLang.BY)), com.pullenti.morph.MorphLang.UA)))), com.pullenti.morph.MorphLang.UNKNOWN)) {
            ...
            if (i == 1 && its.get(0).canBeDay()) {
                ...
                if (year.value == null) {
                    i1 = 1;
                    yearVal = this.findYear(its.get(0).getBeginToken());
                }
            }
            else if (i == 0) {
    ...
    private DateRangeReferent applyDateRange(com.pullenti.ner.core.AnalyzerData ad, java.util.ArrayList<com.pullenti.ner.date.internal.DateItemToken> its, com.pullenti.unisharp.Outargwrapper<com.pullenti.morph.MorphLang> lang) {
        ...
        if ((its.get(0).canBeYear() && com.pullenti.unisharp.Utils.stringsEq(its.get(1).stringValue, "-") && its.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.YEAR) && (its.get(0).getYear() < its.get(2).getYear())) {
            ...
            res.setDateFrom((DateReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateReferent._new752(its.get(0).getYear())), DateReferent.class));
            ...
            res.setDateTo((DateReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateReferent._new752(its.get(2).getYear())), DateReferent.class));
    ...
    private void applyDateRange0(com.pullenti.ner.core.AnalysisKit kit, com.pullenti.ner.core.AnalyzerData ad) {
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            ...
            if (com.pullenti.unisharp.Utils.stringsEq(str, "ON") && (t0 instanceof com.pullenti.ner.TextToken)) {
                ...
                if (tok != null) {
                    DateReferent dow = DateReferent._new808((int)tok.termin.tag);
            ...
            else if (com.pullenti.unisharp.Utils.stringsEq(str, "ПО") || com.pullenti.unisharp.Utils.stringsEq(str, "ДО")) {
                if ((t.getNext() instanceof com.pullenti.ner.ReferentToken) && (t.getNext().getReferent() instanceof DateReferent)) {
                    DateRangeReferent dr = DateRangeReferent._new754((DateReferent)com.pullenti.unisharp.Utils.cast(t.getNext().getReferent(), DateReferent.class));
            ...
            if (date1 == null) {
                date1 = (DateReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateReferent._new752(yearVal1)), DateReferent.class);
            ...
            if (date2 == null) {
                date2 = (DateReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateReferent._new752(yearVal2)), DateReferent.class);
                com.pullenti.ner.ReferentToken rt1 = new com.pullenti.ner.ReferentToken(date2, t1, t1, null);
                kit.embedToken(rt1);
                t1 = rt1;
            }
            t = new com.pullenti.ner.ReferentToken(ad.registerReferent(DateRangeReferent._new749(date1, date2)), t, t1, null);
            kit.embedToken((com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.ReferentToken.class));
        }
    }
