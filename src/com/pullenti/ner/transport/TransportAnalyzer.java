...
public class TransportAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.Collection<com.pullenti.ner.ReferentClass> getTypeSystem() {
        return java.util.Arrays.asList(new com.pullenti.ner.ReferentClass[] {com.pullenti.ner.transport.internal.MetaTransport.globalMeta});
    }
                        ...
                        if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), TransportReferent.ATTR_MODEL)) {
                            ...
                            for (int k = 0; k < 2; k++) {
                                if (!Character.isDigit(mod.charAt(0))) {
                                    ...
                                    com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2746 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
                                    boolean inoutres2747 = com.pullenti.unisharp.Utils.tryGetValue(objsByModel, mod, wrapli2746);
                                    li = wrapli2746.value;
                                    if (!inoutres2747) 
                                        objsByModel.put(mod, (li = new java.util.ArrayList<com.pullenti.ner.Referent>()));
                                    if (!li.contains(rt.referent)) 
                                        li.add(rt.referent);
                                    models.addStr(mod, li, null, false);
                                }
                                if (k > 0) 
                                    break;
                            ...
                            objByNames.add(com.pullenti.ner.core.Termin._new135(s.getValue().toString(), rt.referent));
                    }
                }
            }
        }
