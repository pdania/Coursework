...
public class MiscHelper {
    ...
    public static com.pullenti.ner.Token checkNumberPrefix(com.pullenti.ner.Token t) {
        ...
        if (((com.pullenti.unisharp.Utils.stringsEq(s, "НОМЕР") || com.pullenti.unisharp.Utils.stringsEq(s, "№") || com.pullenti.unisharp.Utils.stringsEq(s, "N")) || com.pullenti.unisharp.Utils.stringsEq(s, "NO") || com.pullenti.unisharp.Utils.stringsEq(s, "NN")) || com.pullenti.unisharp.Utils.stringsEq(s, "НР")) {
            t1 = t.getNext();
    ...
    public static String getTextValueOfMetaToken(com.pullenti.ner.MetaToken mt, GetTextAttr attrs) {
        ...
        if (mt instanceof NounPhraseMultivarToken) {
            ...
            res.append(_getTextValue_(nt.source.adjectives.get(nt.adjIndex).getBeginToken(), nt.source.adjectives.get(nt.adjIndex).getEndToken(), attrs, null)).append(" ");
                            ...
                            if (it.getGender() == npt.getMorph().getGender() || (((it.getGender().value()) & (npt.getMorph().getGender().value()))) != (com.pullenti.morph.MorphGender.UNDEFINED.value())) {
                                if (!((com.pullenti.morph.MorphCase.ooBitand(it.getCase(), npt.getMorph().getCase()))).isUndefined()) {
                                    if (it.getNumber() == npt.getMorph().getNumber() || (((it.getNumber().value()) & (npt.getMorph().getNumber().value()))) != (com.pullenti.morph.MorphNumber.UNDEFINED.value())) {
                                        ...
                                        com.pullenti.morph.MorphBaseInfo bi = com.pullenti.morph.MorphBaseInfo._new577(com.pullenti.morph.MorphClass.ADJECTIVE, npt.getMorph().getGender(), npt.getMorph().getNumber(), npt.getMorph().getLanguage());
            ...
            for (com.pullenti.ner.Token t = npt.getBeginToken(); t != null && t.endChar <= npt.endChar; t = t.getNext()) {
                ...
                if (t instanceof com.pullenti.ner.NumberToken) 
                    ...
                    if (!t.chars.isLetter()) {
                        ...
                        com.pullenti.morph.MorphBaseInfo mbi = com.pullenti.morph.MorphBaseInfo._new578(npt.getMorph().getGender(), cas, com.pullenti.morph.MorphNumber.SINGULAR);
                        if (pluralNumber) 
    ...
    public static String getTextMorphVarByCaseAndNumberEx(String str, com.pullenti.morph.MorphCase cas, com.pullenti.morph.MorphNumber num, String numVal) {
        ...
        if (com.pullenti.unisharp.Utils.stringsEq(str, "лет")) 
            str = "год";
        com.pullenti.ner.AnalysisResult ar = com.pullenti.ner.ProcessorService.getEmptyProcessor().process(com.pullenti.ner.SourceOfAnalysis._new579(str, false), null, null);
        if (ar == null || ar.firstToken == null) 
            return str;
        NounPhraseToken npt = NounPhraseHelper.tryParse(ar.firstToken, NounPhraseParseAttr.PARSENUMERICASADJECTIVE, 0);
        ...
        com.pullenti.morph.MorphBaseInfo adjBi = com.pullenti.morph.MorphBaseInfo._new580(com.pullenti.morph.MorphClass.ooBitor(com.pullenti.morph.MorphClass.ADJECTIVE, com.pullenti.morph.MorphClass.NOUN), cas, num, npt.getMorph().getGender());
        com.pullenti.morph.MorphBaseInfo nounBi = com.pullenti.morph.MorphBaseInfo._new581(npt.noun.getMorph()._getClass(), cas, num);
        ...
        if (!com.pullenti.unisharp.Utils.isNullOrEmpty(numVal) && num == com.pullenti.morph.MorphNumber.UNDEFINED) {
            ...
            int n = 0;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn582 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            com.pullenti.unisharp.Utils.parseInteger(numVal, 0, null, wrapn582);
            n = (wrapn582.value != null ? wrapn582.value : 0);
        ...
        for (com.pullenti.ner.MetaToken a : npt.adjectives) {
            norm = a.getNormalCaseText(com.pullenti.morph.MorphClass.ADJECTIVE, false, com.pullenti.morph.MorphGender.UNDEFINED, false);
            val = com.pullenti.morph.Morphology.getWordform(norm, adjBi);
            if (val == null) 
                val = a.getSourceText();
        ...
        norm = npt.noun.getNormalCaseText(nounBi._getClass(), true, com.pullenti.morph.MorphGender.UNDEFINED, false);
        if (year != null) 
            val = year;
        else if (pair != null) 
            val = pair;
            ...
            val = com.pullenti.morph.Morphology.getWordform(norm, nounBi);
            if (com.pullenti.unisharp.Utils.stringsEq(val, "РЕБЕНОК") && nounBi.getNumber() == com.pullenti.morph.MorphNumber.PLURAL) 
                val = com.pullenti.morph.Morphology.getWordform("ДЕТИ", nounBi);
        ...
        if (npt.getEndToken().getNext() != null) {
            res.append(" ");
            res.append(str.substring(npt.getEndToken().getNext().beginChar));
        }
        return res.toString();
    }
    public MiscHelper() {
