...
public class GeneralRelationHelper {
    ...
    public static void refreshGenerals(com.pullenti.ner.Processor proc, com.pullenti.ner.core.AnalysisKit kit) {
        ...
        for (com.pullenti.ner.Analyzer a : proc.getAnalyzers()) {
            ...
            for (com.pullenti.ner.Referent r : ad.getReferents()) {
                Node nod = Node._new479(r, ad);
                allRefs.add(nod);
                r.setTag(nod);
                java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>> si;
                com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>> wrapsi482 = new com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>>();
                boolean inoutres483 = com.pullenti.unisharp.Utils.tryGetValue(all, a.getName(), wrapsi482);
                si = wrapsi482.value;
                if (!inoutres483) 
                ...
                for (String s : strs) {
                    ...
                    com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli480 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
                    boolean inoutres481 = com.pullenti.unisharp.Utils.tryGetValue(si, s, wrapli480);
                    li = wrapli480.value;
                    if (!inoutres481) 
        ...
        for (Node r : allRefs) {
            for (com.pullenti.ner.Slot s : r.ref.getSlots()) {
                if (s.getValue() instanceof com.pullenti.ner.Referent) {
                    ...
                    Node tn = (Node)com.pullenti.unisharp.Utils.cast(to.getTag(), Node.class);
                    if (tn == null) 
                        continue;
                    if (tn.refsFrom == null) 
                ...
                for (int i = 0; i < li.size(); i++) {
                    for (int j = i + 1; j < li.size(); j++) {
                        ...
                        if (li.get(i).canBeGeneralFor(li.get(j)) && !li.get(j).canBeGeneralFor(li.get(i))) {
                            n1 = (Node)com.pullenti.unisharp.Utils.cast(li.get(i).getTag(), Node.class);
                            n2 = (Node)com.pullenti.unisharp.Utils.cast(li.get(j).getTag(), Node.class);
                        }
                        else if (li.get(j).canBeGeneralFor(li.get(i)) && !li.get(i).canBeGeneralFor(li.get(j))) {
                            n1 = (Node)com.pullenti.unisharp.Utils.cast(li.get(j).getTag(), Node.class);
                            n2 = (Node)com.pullenti.unisharp.Utils.cast(li.get(i).getTag(), Node.class);
                        }
                        if (n1 != null && n2 != null) {
                            if (n1.genFrom == null) 
    ...
    private static void _correctReferents(com.pullenti.ner.Token t) {
        ...
        if (rt.referent != null && (rt.referent.getTag() instanceof com.pullenti.ner.Referent)) 
            rt.referent = (com.pullenti.ner.Referent)com.pullenti.unisharp.Utils.cast(rt.referent.getTag(), com.pullenti.ner.Referent.class);
    ...
    public static class Node {
        ...
        public static Node _new479(com.pullenti.ner.Referent _arg1, com.pullenti.ner.core.AnalyzerData _arg2) {
            Node res = new Node();
            res.ref = _arg1;
            res.ad = _arg2;
            return res;
