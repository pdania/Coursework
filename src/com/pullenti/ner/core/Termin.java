...
public class Termin {
    ...
    public static class Term {
        ...
        public static Term _new1976(com.pullenti.ner.TextToken _arg1, boolean _arg2) {
    ...
    public static class Abridge {
        ...
        public void addPart(String val, boolean hasDelim) {
            parts.add(com.pullenti.ner.core.Termin.AbridgePart._new642(val, hasDelim));
        }
        ...
        public com.pullenti.ner.core.TerminToken tryAttach(com.pullenti.ner.Token t0) {
            ...
            if (tail == null) {
                ...
                com.pullenti.ner.core.TerminToken res = com.pullenti.ner.core.TerminToken._new643(t0, te, t0 == te);
                if (point) 
    ...
    public static class AbridgePart {
        ...
        public static AbridgePart _new642(String _arg1, boolean _arg2) {
        ...
        public static AbridgePart _new644(String _arg1) {
            AbridgePart res = new AbridgePart();
            res.value = _arg1;
            return res;
        }
    ...
    public Abridge addAbridge(String abr) {
        ...
        if (i == 0) 
            return null;
        a.parts.add(AbridgePart._new644(abr.substring(0, 0 + i).toUpperCase()));
        abridges.add(a);
        if (((i + 1) < abr.length()) && abr.charAt(i) == '-') 
            ...
            for (; i < abr.length(); i++) {
                if (Character.isLetter(abr.charAt(i))) {
                    ...
                    AbridgePart p = AbridgePart._new644(abr.substring(i, i + j - i).toUpperCase());
                    if (j < abr.length()) {
     ...
     * @return 
     */
    public TerminToken tryParse(com.pullenti.ner.Token t0, TerminParseAttr pars, double simD) {
        if (t0 == null) 
            return null;
        if ((simD < 1) && simD > 0.05) 
            return this.tryParseSim(t0, simD, pars);
        String term = null;
        ...
        if (acronymSmart != null && (((pars.value()) & (TerminParseAttr.FULLWORDSONLY.value()))) == (TerminParseAttr.NO.value()) && term != null) {
            if (com.pullenti.unisharp.Utils.stringsEq(acronymSmart, term)) {
                if (t0.getNext() != null && t0.getNext().isChar('.') && !t0.isWhitespaceAfter()) 
                    return TerminToken._new646(t0, t0.getNext(), this);
                else 
                    return TerminToken._new646(t0, t0, this);
            }
            int i;
            com.pullenti.ner.TextToken t1 = (com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t0, com.pullenti.ner.TextToken.class);
            ...
            if (i >= acronym.length()) 
                return TerminToken._new646(t0, t1, this);
        }
        ...
        if (terms.size() > 0 && ((!ignoreTermsOrder || cou == 1))) {
            ...
            if (ok && i >= terms.size()) {
                ...
                if (t0 != t1 && t0.getMorph()._getClass().isAdjective()) {
                    NounPhraseToken npt = NounPhraseHelper.tryParse(t0, NounPhraseParseAttr.NO, 0);
                    if (npt != null && npt.endChar <= t1.endChar) 
                        mc = npt.getMorph();
                }
                return TerminToken._new651(t0, t1, mc);
            }
        }
    ...
    public TerminToken tryParseSim(com.pullenti.ner.Token t0, double simD, TerminParseAttr pars) {
        ...
        if (terms.size() > 0) {
            ...
            return TerminToken._new657(t0, t1, mc, this);
        }
        if (abridges != null && (((pars.value()) & (TerminParseAttr.FULLWORDSONLY.value()))) == (TerminParseAttr.NO.value())) {
            TerminToken res = null;
            for (Abridge a : abridges) {
    ...
    public static Termin _new130(String _arg1, String _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
        return res;
    }

    public static Termin _new135(String _arg1, Object _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        return res;
    }

    public static Termin _new136(String _arg1, Object _arg2, com.pullenti.morph.MorphLang _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.lang = _arg3;
        return res;
    ...
    public static Termin _new137(String _arg1, Object _arg2, Object _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.tag2 = _arg3;
        return res;
    ...
    public static Termin _new159(String _arg1, String _arg2, Object _arg3) {
        Termin res = new Termin(_arg1, null, false);
    ...
    public static Termin _new161(String _arg1, Object _arg2, String _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.acronym = _arg3;
        return res;
    ...
    public static Termin _new198(String _arg1, String _arg2, boolean _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
    ...
    public static Termin _new276(String _arg1, Object _arg2, com.pullenti.morph.MorphGender _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.setGender(_arg3);
        return res;
    ...
    public static Termin _new277(String _arg1, Object _arg2, com.pullenti.morph.MorphLang _arg3, com.pullenti.morph.MorphGender _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.lang = _arg3;
        res.setGender(_arg4);
    ...
    public static Termin _new279(String _arg1, Object _arg2, Object _arg3, com.pullenti.morph.MorphGender _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.tag2 = _arg3;
        res.setGender(_arg4);
    ...
    public static Termin _new280(String _arg1, Object _arg2, com.pullenti.morph.MorphLang _arg3, Object _arg4, com.pullenti.morph.MorphGender _arg5) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.lang = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new306(String _arg1, Object _arg2, String _arg3, Object _arg4, com.pullenti.morph.MorphGender _arg5) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.acronym = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new319(String _arg1, String _arg2, Object _arg3, Object _arg4, com.pullenti.morph.MorphGender _arg5) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new323(String _arg1, String _arg2, Object _arg3, com.pullenti.morph.MorphLang _arg4, Object _arg5, com.pullenti.morph.MorphGender _arg6) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.lang = _arg4;
    ...
    public static Termin _new324(String _arg1, String _arg2, Object _arg3, com.pullenti.morph.MorphGender _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
        res.tag = _arg3;
        res.setGender(_arg4);
    ...
    public static Termin _new328(String _arg1, Object _arg2, String _arg3, com.pullenti.morph.MorphGender _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.acronym = _arg3;
        res.setGender(_arg4);
    ...
    public static Termin _new347(Object _arg1, boolean _arg2) {
    ...
    public static Termin _new432(String _arg1, Object _arg2, Object _arg3, com.pullenti.morph.MorphLang _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.tag2 = _arg3;
        res.lang = _arg4;
    ...
    public static Termin _new472(String _arg1, com.pullenti.morph.MorphLang _arg2, Object _arg3) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.tag = _arg3;
        return res;
    }

    public static Termin _new499(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, String _arg4, Object _arg5) {
    ...
    public static Termin _new615(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, _arg2, _arg3);
        res.tag = _arg4;
        return res;
    }

    public static Termin _new724(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, String _arg4) {
        Termin res = new Termin(_arg1, _arg2, _arg3);
        res.setCanonicText(_arg4);
        return res;
    }

    public static Termin _new922(String _arg1, com.pullenti.morph.MorphLang _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.lang = _arg2;
        return res;
    }

    public static Termin _new934(String _arg1, com.pullenti.morph.MorphLang _arg2, Object _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.tag = _arg3;
        res.tag2 = _arg4;
        return res;
    ...
    public static Termin _new938(String _arg1, com.pullenti.morph.MorphLang _arg2, Object _arg3, String _arg4) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.tag = _arg3;
        res.acronym = _arg4;
        return res;
    ...
    public static Termin _new944(String _arg1, String _arg2, com.pullenti.morph.MorphLang _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.lang = _arg3;
        res.tag = _arg4;
    ...
    public static Termin _new947(String _arg1, Object _arg2, String _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.acronym = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new949(String _arg1, com.pullenti.morph.MorphLang _arg2, Object _arg3, String _arg4, Object _arg5) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.tag = _arg3;
        res.acronym = _arg4;
        res.tag2 = _arg5;
    ...
    public static Termin _new969(String _arg1, String _arg2, Object _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
        res.tag = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new1018(String _arg1, com.pullenti.morph.MorphLang _arg2, String _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, _arg2, false);
    ...
    public static Termin _new1137(String _arg1, String _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        return res;
    }

    public static Termin _new1172(String _arg1, com.pullenti.morph.MorphLang _arg2, String _arg3) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.setCanonicText(_arg3);
        return res;
    }

    public static Termin _new1274(String _arg1, com.pullenti.morph.MorphLang _arg2) {
        Termin res = new Termin(null, null, false);
        res.acronym = _arg1;
        res.lang = _arg2;
        return res;
    ...
    public static Termin _new1523(String _arg1, com.pullenti.morph.MorphLang _arg2, String _arg3) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.acronym = _arg3;
        return res;
    }

    public static Termin _new2366(String _arg1, Object _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.tag2 = _arg2;
        return res;
    }

    public static Termin _new2627(String _arg1, boolean _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.ignoreTermsOrder = _arg2;
        return res;
    }

    public static Termin _new2649(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, _arg2, _arg3);
        res.tag2 = _arg4;
        return res;
    }

    public static Termin _new2774(String _arg1, String _arg2, Object _arg3, String _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.acronym = _arg4;
    ...
    public static Termin _new2784(String _arg1, String _arg2, Object _arg3, String _arg4, boolean _arg5) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.acronym = _arg4;
    ...
    public static Termin _new2797(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, String _arg4, Object _arg5, Object _arg6) {
        Termin res = new Termin(_arg1, _arg2, _arg3);
        res.setCanonicText(_arg4);
        res.tag = _arg5;
        res.tag2 = _arg6;
    ...
    public static Termin _new2798(String _arg1, String _arg2, Object _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new2801(String _arg1, String _arg2, String _arg3, Object _arg4, Object _arg5, boolean _arg6) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.acronym = _arg3;
        res.tag = _arg4;
    ...
    public static Termin _new2825(String _arg1, String _arg2, Object _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
        res.tag = _arg3;
        return res;
    ...
    public static Termin _new2836(String _arg1, String _arg2, String _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.acronym = _arg3;
        res.tag = _arg4;
