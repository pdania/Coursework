...
public class NumberingHelper {
    ...
    public static int calcDelta(InstrToken1 prev, InstrToken1 next, boolean canSubNumbers) {
        ...
        if ((prev.numbers.size() - 1) == next.numbers.size() && prev.numbers.size() > 1) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11569 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1570 = com.pullenti.unisharp.Utils.parseInteger(prev.numbers.get(prev.numbers.size() - 2), 0, null, wrapn11569);
            n1 = (wrapn11569.value != null ? wrapn11569.value : 0);
            if (!inoutres1570) {
        ...
        if ((prev.numbers.size() - 2) == next.numbers.size() && prev.numbers.size() > 2) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11571 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1572 = com.pullenti.unisharp.Utils.parseInteger(prev.numbers.get(prev.numbers.size() - 3), 0, null, wrapn11571);
            n1 = (wrapn11571.value != null ? wrapn11571.value : 0);
            if (!inoutres1572) 
                return 0;
            if ((n1 + 1) != n2) 
                return 0;
        ...
        if ((prev.numbers.size() - 3) == next.numbers.size() && prev.numbers.size() > 3) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11573 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1574 = com.pullenti.unisharp.Utils.parseInteger(prev.numbers.get(prev.numbers.size() - 4), 0, null, wrapn11573);
            n1 = (wrapn11573.value != null ? wrapn11573.value : 0);
            if (!inoutres1574) 
                return 0;
            if ((n1 + 1) != n2) 
                return 0;
    ...
    public static void createNumber(FragToken owner, InstrToken1 itok) {
        if (itok.numBeginToken == null || itok.numEndToken == null) 
            return;
        FragToken num = FragToken._new1575(itok.numBeginToken, itok.numEndToken, com.pullenti.ner.instrument.InstrumentKind.NUMBER, true, itok);
    ...
    public static java.util.ArrayList<String> createDiap(String s1, String s2) {
        ...
        if (s2.startsWith(s1)) {
            ...
            if (((i + 1) < s2.length()) && s2.charAt(i) == '.' && Character.isDigit(s2.charAt(i + 1))) {
                com.pullenti.unisharp.Outargwrapper<Integer> wrapn21576 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres1577 = com.pullenti.unisharp.Utils.parseInteger(s2.substring(i + 1), 0, null, wrapn21576);
                n2 = (wrapn21576.value != null ? wrapn21576.value : 0);
                if (inoutres1577) {
        ...
        if ((((i = s1.lastIndexOf('.')))) > 0) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11580 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1581 = com.pullenti.unisharp.Utils.parseInteger(s1.substring(i + 1), 0, null, wrapn11580);
            n1 = (wrapn11580.value != null ? wrapn11580.value : 0);
            if (!inoutres1581) 
                return null;
            if (!s2.startsWith(pref)) 
                return null;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn21578 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1579 = com.pullenti.unisharp.Utils.parseInteger(s2.substring(i + 1), 0, null, wrapn21578);
            n2 = (wrapn21578.value != null ? wrapn21578.value : 0);
            if (!inoutres1579) 
                return null;
        }
        else {
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11584 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1585 = com.pullenti.unisharp.Utils.parseInteger(s1, 0, null, wrapn11584);
            n1 = (wrapn11584.value != null ? wrapn11584.value : 0);
            if (!inoutres1585) 
                return null;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn21582 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1583 = com.pullenti.unisharp.Utils.parseInteger(s2, 0, null, wrapn21582);
            n2 = (wrapn21582.value != null ? wrapn21582.value : 0);
            if (!inoutres1583) 
                return null;
        }
        if (n2 <= n1) 
