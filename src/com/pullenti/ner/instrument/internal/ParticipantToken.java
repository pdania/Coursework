...
public class ParticipantToken extends com.pullenti.ner.MetaToken {
    ...
    public String toString() {
        ...
        if (parts != null) {
            for (com.pullenti.ner.Referent p : parts) {
                res.append("; ").append(p.toString(true, null, 0));
            }
        }
        return res.toString();
    }

    public static ParticipantToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.instrument.InstrumentParticipant p1, com.pullenti.ner.instrument.InstrumentParticipant p2, boolean isContract) {
        if (t == null) 
            return null;
        ...
        if (p1 == null && p2 == null && isContract) {
                ...
                if (com.pullenti.unisharp.Utils.stringsEq(r1.getTypeName(), r2.getTypeName())) {
                    ...
                    for (; ttt != null; ttt = ttt.getNext()) {
                        ...
                        if (npt != null && npt.noun.isValue("СТОРОНА", null) && npt.getMorph().getNumber() != com.pullenti.morph.MorphNumber.SINGULAR) {
                            ParticipantToken re = _new1586(t, npt.getEndToken(), Kinds.NAMEDASPARTS);
                            re.parts = refs;
                            return re;
                        }
                        break;
            ...
            if ((r1 instanceof com.pullenti.ner._org.OrganizationReferent) || (r1 instanceof com.pullenti.ner.person.PersonReferent)) {
                ...
                if (r1 instanceof com.pullenti.ner.person.PersonReferent) {
                    ...
                    return null;
                for (com.pullenti.ner.Token ttt = (((com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.ReferentToken.class))).getBeginToken(); ttt != null && (ttt.endChar < t.endChar); ttt = ttt.getNext()) {
                    if (ttt.isChar('(')) 
                        hasBr = true;
                        ...
                        com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(ttt, com.pullenti.ner.core.NounPhraseParseAttr.REFERENTCANBENOUN, 0);
                        if (npt == null) 
                            break;
                        if (hasBr) {
                        ...
                        ParticipantToken re = _new1586(t, t, Kinds.NAMEDAS);
                        re.typ = npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                    ...
                    if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(ttt, false, false)) {
                        ...
                        if (npt != null) {
                            ...
                            if (ttok != null) 
                                ...
                                typ22 = ttt.getNormalCaseText(com.pullenti.morph.MorphClass.ADJECTIVE, false, com.pullenti.morph.MorphGender.UNDEFINED, false);
                            else if (brr != null) 
                                continue;
                            else 
                                break;
                        ...
                        ParticipantToken re = _new1586(t, ttt, Kinds.NAMEDAS);
                        re.typ = (typ22 != null ? typ22 : npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false));
                        re.parts = new java.util.ArrayList<com.pullenti.ner.Referent>();
                        re.parts.add(r1);
                        return re;
                    }
                        ...
                        com.pullenti.ner.ReferentToken prr = ttt.kit.processReferent("PERSONPROPERTY", ttt);
                        if (prr != null) {
                            ttt = prr.getEndToken();
                            continue;
                        }
                ...
                if (endSide != null || ((addRefs != null && t.getPrevious() != null && t.getPrevious().isAnd()))) {
                    ParticipantToken re = _new1586(t, (endSide != null ? endSide : t), Kinds.NAMEDAS);
                    re.typ = null;
                    re.parts = new java.util.ArrayList<com.pullenti.ner.Referent>();
                    re.parts.add(r1);
                    if (addRefs != null) 
            ...
            if (too != null && too.termin.tag != null && com.pullenti.unisharp.Utils.stringsNe(too.termin.getCanonicText(), "СТОРОНА")) {
                ...
                if (tt1 instanceof com.pullenti.ner.ReferentToken) {
                    ...
                    if ((r1 instanceof com.pullenti.ner.person.PersonReferent) || (r1 instanceof com.pullenti.ner._org.OrganizationReferent)) {
                        ParticipantToken re = _new1586(t, tt1, Kinds.NAMEDAS);
        ...
        for (; tt != null; tt = tt.getNext()) {
            ...
            if (tok == null) {
                ...
                if (tt.chars.isLetter()) {
                    if (term1 != null) {
                        com.pullenti.ner.core.TerminToken tok1 = term1.tryParse(tt, com.pullenti.ner.core.TerminParseAttr.NO, 0.0);
                        if (tok1 != null) {
                            if (_typ != null) {
                                if (!_isTypesEqual(addTyp1, _typ)) 
                                    break;
                    ...
                    if (term2 != null) {
                        com.pullenti.ner.core.TerminToken tok2 = term2.tryParse(tt, com.pullenti.ner.core.TerminParseAttr.NO, 0.0);
                        if (tok2 != null) {
                            if (_typ != null) {
                                if (!_isTypesEqual(addTyp2, _typ)) 
                                    break;
                    ...
                    if (named && tt.getMorphClassInDictionary().isNoun()) {
                        if (!tt.chars.isAllLower() || com.pullenti.ner.core.BracketHelper.isBracket(tt.getPrevious(), true)) {
                            if (com.pullenti.ner.decree.internal.DecreeToken.isKeyword(tt, false) == null) {
                                String val = tt.getNormalCaseText(com.pullenti.morph.MorphClass.NOUN, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                                if (_typ != null) {
                    ...
                    if ((tt instanceof com.pullenti.ner.TextToken) && tt.chars.isCyrillicLetter() && tt.chars.isCapitalUpper()) {
                        ...
                        if (dc.isUndefined() || dc.isNoun()) {
                            ...
                            if (dt != null) 
                                ...
                                ok = false;
                            if (ok) {
                                _typ = (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).getLemma();
                                t1 = tt;
                                continue;
                            }
                        }
                        if (dc.isAdjective()) {
                            ...
                            if (npt != null && npt.adjectives.size() > 0 && npt.noun.getMorphClassInDictionary().isNoun()) {
                                _typ = npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                                t1 = npt.getEndToken();
                                continue;
                            }
                        }
        ...
        if (br && t1.getNext() != null && com.pullenti.ner.core.BracketHelper.canBeEndOfSequence(t1.getNext(), false, null, false)) 
            t1 = t1.getNext();
        ParticipantToken res = _new1591(t, t1, (named ? Kinds.NAMEDAS : Kinds.PURE), _typ);
        if (t.isChar(':')) 
    ...
    public static com.pullenti.ner.ReferentToken tryAttachToExist(com.pullenti.ner.Token t, com.pullenti.ner.instrument.InstrumentParticipant p1, com.pullenti.ner.instrument.InstrumentParticipant p2) {
        if (t == null) 
            return null;
        if (t.beginChar >= 7674 && (t.beginChar < 7680)) {
        }
        ParticipantToken pp = ParticipantToken.tryAttach(t, p1, p2, false);
        com.pullenti.ner.instrument.InstrumentParticipant p = null;
    ...
    public static com.pullenti.ner.ReferentToken tryAttachRequisites(com.pullenti.ner.Token t, com.pullenti.ner.instrument.InstrumentParticipant cur, com.pullenti.ner.instrument.InstrumentParticipant other, boolean cantBeEmpty) {
        if (t == null || cur == null) 
            return null;
        ...
        for (; t != null; t = t.getNext()) {
            ...
            if ((((r instanceof com.pullenti.ner.person.PersonReferent) || (r instanceof com.pullenti.ner.address.AddressReferent) || (r instanceof com.pullenti.ner.uri.UriReferent)) || (r instanceof com.pullenti.ner._org.OrganizationReferent) || (r instanceof com.pullenti.ner.phone.PhoneReferent)) || (r instanceof com.pullenti.ner.person.PersonIdentityReferent) || (r instanceof com.pullenti.ner.bank.BankDataReferent)) {
                ...
                if (rt == null) 
                    rt = new com.pullenti.ner.ReferentToken(cur, t, t, null);
                if (cur.findSlot(com.pullenti.ner.instrument.InstrumentParticipant.ATTR_DELEGATE, r, true) != null) {
                }
                else 
                    cur.addSlot(com.pullenti.ner.instrument.InstrumentParticipant.ATTR_REF, r, false, 0);
                rt.setEndToken(t);
                err = 0;
            }
            else {
    ...
    public com.pullenti.ner.ReferentToken attachFirst(com.pullenti.ner.instrument.InstrumentParticipant p, int minChar, int maxChar) {
        com.pullenti.ner.Token t;
        com.pullenti.ner.Token tt0 = getBeginToken();
        java.util.ArrayList<com.pullenti.ner.Referent> refs = new java.util.ArrayList<com.pullenti.ner.Referent>();
        for (t = tt0.getPrevious(); t != null && t.beginChar >= minChar; t = t.getPrevious()) {
            if (t.isNewlineAfter()) {
        ...
        if (refs.size() > 0) {
            for (com.pullenti.ner.Referent r : refs) {
                if (r != refs.get(0) && (refs.get(0) instanceof com.pullenti.ner._org.OrganizationReferent) && (((r instanceof com.pullenti.ner.person.PersonReferent) || (r instanceof com.pullenti.ner.person.PersonPropertyReferent)))) 
                    p.addSlot(com.pullenti.ner.instrument.InstrumentParticipant.ATTR_DELEGATE, r, false, 0);
                else 
                    p.addSlot(com.pullenti.ner.instrument.InstrumentParticipant.ATTR_REF, r, false, 0);
            }
        }
        com.pullenti.ner.ReferentToken rt = new com.pullenti.ner.ReferentToken(p, tt0, getEndToken(), null);
        t = getEndToken().getNext();
        if (com.pullenti.ner.core.BracketHelper.isBracket(t, false)) 
            t = t.getNext();
        if (t != null && t.isChar(',')) 
            t = t.getNext();
        for (; t != null && ((maxChar == 0 || t.beginChar <= maxChar)); t = t.getNext()) {
            ...
            if (((((r instanceof com.pullenti.ner._org.OrganizationReferent) || (r instanceof com.pullenti.ner.phone.PhoneReferent) || (r instanceof com.pullenti.ner.person.PersonReferent)) || (r instanceof com.pullenti.ner.person.PersonPropertyReferent) || (r instanceof com.pullenti.ner.address.AddressReferent)) || (r instanceof com.pullenti.ner.uri.UriReferent) || (r instanceof com.pullenti.ner.person.PersonIdentityReferent)) || (r instanceof com.pullenti.ner.bank.BankDataReferent)) {
                ...
                if (t.getPrevious().isValue("КОТОРЫЙ", null) && t.getPrevious().getPrevious() != null && ((t.getPrevious().getPrevious().isValue("ИМЯ", null) || t.getPrevious().getPrevious().isValue("ЛИЦО", null)))) 
                    isDelegate = true;
                p.addSlot(((((r instanceof com.pullenti.ner.person.PersonReferent) || (r instanceof com.pullenti.ner.person.PersonPropertyReferent))) && isDelegate ? com.pullenti.ner.instrument.InstrumentParticipant.ATTR_DELEGATE : com.pullenti.ner.instrument.InstrumentParticipant.ATTR_REF), r, false, 0);
                rt.setEndToken(t);
                continue;
            }
            com.pullenti.ner.Token tt = _tryAttachContractGround(t, p, false);
        ...
        for (t = rt.getBeginToken(); t != null && t.endChar <= rt.endChar; t = t.getNext()) {
    ...
    private static com.pullenti.ner.Token _tryAttachContractGround(com.pullenti.ner.Token t, com.pullenti.ner.instrument.InstrumentParticipant ip, boolean canBePassport) {
        boolean ok = false;
        for (; t != null; t = t.getNext()) {
            ...
            if (t.isValue("УСТАВ", null)) {
                ip.setGround(t.getNormalCaseText(com.pullenti.morph.MorphClass.NOUN, true, com.pullenti.morph.MorphGender.UNDEFINED, false));
                return t;
            }
            if (t.isValue("ДОВЕРЕННОСТЬ", null)) {
                ...
                if (dts == null) {
                    ...
                    for (com.pullenti.ner.Token ttt = t.getNext(); ttt != null && ((ttt.endChar - t.endChar) < 200); ttt = ttt.getNext()) {
                        if (ttt.isComma()) 
                            continue;
    ...
    public static void initialize() {
        ...
        for (String s : new String[] {"АРЕНДОДАТЕЛЬ", "АРЕНДАТОР", "СУБАРЕНДАТОР", "НАЙМОДАТЕЛЬ", "НАНИМАТЕЛЬ", "АГЕНТ", "ПРИНЦИПАЛ", "ПРОДАВЕЦ", "ПОКУПАТЕЛЬ", "ЗАКАЗЧИК", "ИСПОЛНИТЕЛЬ", "ПОСТАВЩИК", "ПОДРЯДЧИК", "СУБПОДРЯДЧИК", "СТОРОНА", "ЛИЦЕНЗИАР", "ЛИЦЕНЗИАТ", "СТРАХОВЩИК", "СТРАХОВАТЕЛЬ", "ПРОВАЙДЕР", "АБОНЕНТ", "ЗАСТРОЙЩИК", "УЧАСТНИК ДОЛЕВОГО СТРОИТЕЛЬСТВА", "КЛИЕНТ", "ЗАЕМЩИК", "УПРАВЛЯЮЩИЙ"}) {
            m_Ontology.add(com.pullenti.ner.core.Termin._new135(s, m_Ontology));
        }
        t = com.pullenti.ner.core.Termin._new135("ГЕНПОДРЯДЧИК", m_Ontology);
        t.addVariant("ГЕНЕРАЛЬНЫЙ ПОДРЯДЧИК", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new135("ЗАИМОДАТЕЛЬ", m_Ontology);
    ...
    public static ParticipantToken _new1415(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
        ParticipantToken res = new ParticipantToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static ParticipantToken _new1586(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Kinds _arg3) {
        ParticipantToken res = new ParticipantToken(_arg1, _arg2);
        res.kind = _arg3;
        return res;
    }

    public static ParticipantToken _new1591(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Kinds _arg3, String _arg4) {
        ParticipantToken res = new ParticipantToken(_arg1, _arg2);
        res.kind = _arg3;
        res.typ = _arg4;
        return res;
    ...
    static {
        _globalInstance = new ParticipantToken(); 
    }
}
