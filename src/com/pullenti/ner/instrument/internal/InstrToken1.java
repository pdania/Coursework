...
public class InstrToken1 extends com.pullenti.ner.MetaToken {
    ...
    public static InstrToken1 parse(com.pullenti.ner.Token t, boolean ignoreDirectives, FragToken cur, int lev, InstrToken1 prev, boolean isCitat, int maxChar, boolean canBeTableCell, boolean isInIndex) {
        ...
        if (t.isChar('(')) {
            ...
            if (fr != null) 
                edt = _new1549(fr.getBeginToken(), fr.getEndToken(), Types.EDITIONS);
            else {
                com.pullenti.ner.Token t2 = _createEdition(t);
                if (t2 != null) 
                    edt = _new1549(t, t2, Types.EDITIONS);
            }
            if (edt != null) {
        ...
        InstrToken1 res = _new1551(t0, t, true);
                ...
                if (t.isChar((char)0x1E)) {
                    ...
                    if (rows != null && rows.size() > 0) {
                        ...
                        if (rows.get(0).cells.size() > 2 || rows.get(0).cells.size() == 0) {
                            ...
                            InstrToken1 it11 = parse(rows.get(0).getBeginToken(), true, null, 10, null, false, maxChar, canBeTableCell, false);
                            if (canBeTableCell) {
                                if (it11 != null) 
                                    return it11;
                            }
        ...
        if (dt == null && (((t.getReferent() instanceof com.pullenti.ner.person.PersonReferent) || (t.getReferent() instanceof com.pullenti.ner.instrument.InstrumentParticipant)))) {
            dt = com.pullenti.ner.decree.internal.DecreeToken._new863(t, t, com.pullenti.ner.decree.internal.DecreeToken.ItemType.OWNER);
        ...
        if (t.isValue("КОНСУЛЬТАНТПЛЮС", null) || t.isValue("ГАРАНТ", null)) {
            ...
            if (t1 != null && ((t1.isValue("ПРИМЕЧАНИЕ", null) || ok))) {
                if (t1.getNext() != null && t1.getNext().isChar('.')) 
                    t1 = t1.getNext();
                InstrToken1 re = _new1549(t, t1, Types.COMMENT);
        ...
        if (checkComment > 0 || t.isValue("О", "ПРО")) {
            ...
            if (ok) {
                InstrToken1 cmt = _new1549(t, t1, Types.COMMENT);
        ...
        String val = null;
        com.pullenti.unisharp.Outargwrapper<String> wrapval1560 = new com.pullenti.unisharp.Outargwrapper<String>();
        com.pullenti.ner.Token tt2 = _checkDirective(t, wrapval1560);
        val = wrapval1560.value;
        if (tt2 != null) {
            if (tt2.isNewlineAfter() || ((tt2.getNext() != null && ((tt2.getNext().isCharOf(":") || ((tt2.getNext().isChar('.') && tt2 != t)))) && ((tt2.getNext().isNewlineAfter() || t.chars.isAllUpper()))))) 
                return _new1555(t, (tt2.isNewlineAfter() ? tt2 : tt2.getNext()), Types.DIRECTIVE, val);
        }
        if ((lev < 3) && t != null) {
            if ((t.isValue("СОДЕРЖИМОЕ", "ВМІСТ") || t.isValue("СОДЕРЖАНИЕ", "ЗМІСТ") || t.isValue("ОГЛАВЛЕНИЕ", "ЗМІСТ")) || ((t.isValue("СПИСОК", null) && t.getNext() != null && t.getNext().isValue("РАЗДЕЛ", null)))) {
                ...
                if (t11 != null && t11.isNewlineBefore()) {
                    ...
                    if (first != null) {
                        ...
                        cou = 0;
                        for (tt = first.getBeginToken(); tt != null && tt.endChar <= first.endChar; tt = tt.getNext()) {
            ...
            if (tt != null && tt.isCharOf(".)]")) {
                ...
                for (; tt != null; tt = tt.getNext()) {
                    ...
                    if (tt.isNewlineAfter()) {
                        if (ok) 
                            return _new1549(t, tt, Types.COMMENT);
                        break;
                    }
                }
        }
        ...
        for (; t != null; t = t.getNext()) {
            ...
            if (t != res.getBeginToken() && _isFirstLine(t)) 
                break;
            String tmp;
            com.pullenti.unisharp.Outargwrapper<String> wraptmp1557 = new com.pullenti.unisharp.Outargwrapper<String>();
            tt2 = _checkDirective(t, wraptmp1557);
            tmp = wraptmp1557.value;
            if (tt2 != null) {
        ...
        if (res.numTyp != NumberTypes.UNDEFINED && res.getBeginToken() == res.numBeginToken && res.getEndToken() == res.numEndToken) {
            ...
            if (!ok) {
                InstrToken1 res1 = parse(res.getEndToken().getNext(), true, null, 0, null, false, 0, false, false);
                if (res1 != null) {
        ...
        if (res.typ == Types.LINE) {
            if (res.numTyp != NumberTypes.UNDEFINED) {
                ...
                for (String nn : res.numbers) {
                    int vv;
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapvv1558 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    boolean inoutres1559 = com.pullenti.unisharp.Utils.parseInteger(nn, 0, null, wrapvv1558);
                    vv = (wrapvv1558.value != null ? wrapvv1558.value : 0);
                    if (inoutres1559) {
    ...
    public static InstrToken1 _new1549(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Types _arg3) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static InstrToken1 _new1551(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
        res.allUpper = _arg3;
        return res;
    }

    public static InstrToken1 _new1555(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Types _arg3, String _arg4) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    ...
    public static InstrToken1 _new1568(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3, Types _arg4) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
