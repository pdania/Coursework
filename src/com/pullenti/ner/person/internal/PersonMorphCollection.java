...
public class PersonMorphCollection {
    ...
    public static class PersonMorphVariant {
        ...
        public static PersonMorphVariant _new2598(String _arg1, com.pullenti.morph.MorphGender _arg2, String _arg3) {
    ...
    public void add(String val, String shortval, com.pullenti.morph.MorphGender gen, boolean addOtherGenderVar) {
        ...
        if (gen == com.pullenti.morph.MorphGender.MASCULINE || gen == com.pullenti.morph.MorphGender.FEMINIE) {
            ...
            items.add(PersonMorphVariant._new2598(val, gen, shortval));
            if (addOtherGenderVar) {
                ...
                String v = com.pullenti.morph.Morphology.getWordform(val, com.pullenti.morph.MorphBaseInfo._new228(com.pullenti.morph.MorphClass._new2579(true), g0));
                if (v != null) 
                    items.add(PersonMorphVariant._new2598(v, g0, shortval));
            }
        }
        else {
    ...
    public com.pullenti.morph.MorphGender getGender() {
        ...
        for (PersonMorphVariant it : items) {
            res = com.pullenti.morph.MorphGender.of((res.value()) | (it.gender.value()));
        }
    ...
    static {
        _globalInstance = new PersonMorphCollection(); 
