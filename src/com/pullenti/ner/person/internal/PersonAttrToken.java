...
public class PersonAttrToken extends com.pullenti.ner.ReferentToken {
    ...
    public static void initialize() throws Exception, java.io.IOException, javax.xml.stream.XMLStreamException, org.xml.sax.SAXException {
        ...
        m_Termins.add(PersonAttrTermin._new2407("ТОВАРИЩ", PersonAttrTerminType.PREFIX));
        m_Termins.add(PersonAttrTermin._new2408("ТОВАРИШ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.PREFIX));
        for (String s : new String[] {"ГОСПОДИН", "ГРАЖДАНИН", "УРОЖЕНЕЦ", "МИСТЕР", "СЭР", "СЕНЬОР", "МОНСЕНЬОР", "СИНЬОР", "МЕСЬЕ", "МСЬЕ", "ДОН", "МАЭСТРО", "МЭТР"}) {
            t = PersonAttrTermin._new2409(s, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.MASCULINE);
        ...
        for (String s : new String[] {"ПАН", "ГРОМАДЯНИН", "УРОДЖЕНЕЦЬ", "МІСТЕР", "СЕР", "СЕНЬЙОР", "МОНСЕНЬЙОР", "МЕСЬЄ", "МЕТР", "МАЕСТРО"}) {
            t = PersonAttrTermin._new2410(s, com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.MASCULINE);
        ...
        for (String s : new String[] {"ГОСПОЖА", "ПАНИ", "ГРАЖДАНКА", "УРОЖЕНКА", "СЕНЬОРА", "СЕНЬОРИТА", "СИНЬОРА", "СИНЬОРИТА", "МИСС", "МИССИС", "МАДАМ", "МАДЕМУАЗЕЛЬ", "ФРАУ", "ФРОЙЛЯЙН", "ЛЕДИ", "ДОННА"}) {
            t = PersonAttrTermin._new2409(s, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        ...
        for (String s : new String[] {"ПАНІ", "ГРОМАДЯНКА", "УРОДЖЕНКА", "СЕНЬЙОРА", "СЕНЬЙОРА", "МІС", "МІСІС", "МАДАМ", "МАДЕМУАЗЕЛЬ", "ФРАУ", "ФРОЙЛЯЙН", "ЛЕДІ"}) {
            t = PersonAttrTermin._new2410(s, com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        ...
        t = PersonAttrTermin._new2410("MISTER", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("MR");
        t.addAbridge("MR.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2410("MISSIS", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("MRS");
        t.addAbridge("MSR.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2410("MISS", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("MS");
        t.addAbridge("MS.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2407("БЕЗРАБОТНЫЙ", PersonAttrTerminType.POSITION);
        ...
        m_Termins.add(t);
        t = PersonAttrTermin._new2408("БЕЗРОБІТНИЙ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        ...
        m_Termins.add(t);
        t = PersonAttrTermin._new2418("ЗАМЕСТИТЕЛЬ", "заместитель", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        t.addVariant("ЗАМЕСТИТЕЛЬНИЦА", false);
        t.addAbridge("ЗАМ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2419("ЗАСТУПНИК", com.pullenti.morph.MorphLang.UA, "заступник", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        t.addVariant("ЗАСТУПНИЦЯ", false);
        t.addAbridge("ЗАМ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2418("УПОЛНОМОЧЕННЫЙ", "уполномоченный", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2419("УПОВНОВАЖЕНИЙ", com.pullenti.morph.MorphLang.UA, "уповноважений", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2418("ЭКС-УПОЛНОМОЧЕННЫЙ", "экс-уполномоченный", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2419("ЕКС-УПОВНОВАЖЕНИЙ", com.pullenti.morph.MorphLang.UA, "екс-уповноважений", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2424("ИСПОЛНЯЮЩИЙ ОБЯЗАННОСТИ", PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
        t.addAbridge("И.О.");
        t.setCanonicText((t.acronym = "ИО"));
        m_Termins.add(t);
        t = PersonAttrTermin._new2425("ВИКОНУЮЧИЙ ОБОВЯЗКИ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
        t.addAbridge("В.О.");
        t.setCanonicText((t.acronym = "ВО"));
        m_Termins.add(t);
        t = PersonAttrTermin._new2424("ВРЕМЕННО ИСПОЛНЯЮЩИЙ ОБЯЗАННОСТИ", PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
        t.addAbridge("ВР.И.О.");
        t.setCanonicText((t.acronym = "ВРИО"));
        m_TerminVrio = t;
        m_Termins.add(t);
        t = PersonAttrTermin._new2407("ЗАВЕДУЮЩИЙ", PersonAttrTerminType.POSITION);
        t.addAbridge("ЗАВЕД.");
        t.addAbridge("ЗАВ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2408("ЗАВІДУВАЧ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("ЗАВІД.");
        t.addAbridge("ЗАВ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2407("СОТРУДНИК", PersonAttrTerminType.POSITION);
        t.addAbridge("СОТРУДН.");
        t.addAbridge("СОТР.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2408("СПІВРОБІТНИК", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("СПІВРОБ.");
        t.addAbridge("СПІВ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2407("АКАДЕМИК", PersonAttrTerminType.POSITION);
        t.addAbridge("АКАД.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2408("АКАДЕМІК", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("АКАД.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2407("ЧЛЕН-КОРРЕСПОНДЕНТ", PersonAttrTerminType.POSITION);
        t.addAbridge("ЧЛ.-КОРР.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2408("ЧЛЕН-КОРЕСПОНДЕНТ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("ЧЛ.-КОР.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2407("ДОЦЕНТ", PersonAttrTerminType.POSITION);
        t.addAbridge("ДОЦ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2407("ПРОФЕССОР", PersonAttrTerminType.POSITION);
        t.addAbridge("ПРОФ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2408("ПРОФЕСОР", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        t.addAbridge("ПРОФ.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2408("PROFESSOR", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.POSITION);
        t.addAbridge("PROF.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2424("КАНДИДАТ", PersonAttrTerminType2.GRADE, PersonAttrTerminType.POSITION);
        t.addAbridge("КАНД.");
        t.addAbridge("КАН.");
        t.addAbridge("К-Т");
        t.addAbridge("К.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2424("ДОКТОР", PersonAttrTerminType2.GRADE, PersonAttrTerminType.POSITION);
        t.addAbridge("ДОКТ.");
        t.addAbridge("ДОК.");
        t.addAbridge("Д-Р");
        t.addAbridge("Д.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2408("DOCTOR", com.pullenti.morph.MorphLang.EN, PersonAttrTerminType.PREFIX);
        t.addAbridge("DR");
        t.addAbridge("DR.");
        m_Termins.add(t);
        t = PersonAttrTermin._new2407("ДОКТОРАНТ", PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        t = PersonAttrTermin._new2408("ДОКТОРАНТ", com.pullenti.morph.MorphLang.UA, PersonAttrTerminType.POSITION);
        m_Termins.add(t);
        for (String s : new String[] {"КФН", "КТН", "КХН"}) {
            t = PersonAttrTermin._new2444(s, "кандидат наук", PersonAttrTerminType.POSITION, PersonAttrTerminType2.ABBR);
            m_Termins.add(t);
        }
        for (String s : new String[] {"ГЛАВНЫЙ", "МЛАДШИЙ", "СТАРШИЙ", "ВЕДУЩИЙ", "НАУЧНЫЙ"}) {
            t = PersonAttrTermin._new2424(s, PersonAttrTerminType2.ADJ, PersonAttrTerminType.POSITION);
            t.addAllAbridges(0, 0, 2);
            m_Termins.add(t);
        }
        for (String s : new String[] {"ГОЛОВНИЙ", "МОЛОДШИЙ", "СТАРШИЙ", "ПРОВІДНИЙ", "НАУКОВИЙ"}) {
            t = PersonAttrTermin._new2446(s, PersonAttrTerminType2.ADJ, PersonAttrTerminType.POSITION, com.pullenti.morph.MorphLang.UA);
            t.addAllAbridges(0, 0, 2);
            m_Termins.add(t);
        }
        for (String s : new String[] {"НЫНЕШНИЙ", "НОВЫЙ", "CURRENT", "NEW"}) {
            t = PersonAttrTermin._new2424(s, PersonAttrTerminType2.IGNOREDADJ, PersonAttrTerminType.POSITION);
            m_Termins.add(t);
        }
        for (String s : new String[] {"НИНІШНІЙ", "НОВИЙ"}) {
            t = PersonAttrTermin._new2446(s, PersonAttrTerminType2.IGNOREDADJ, PersonAttrTerminType.POSITION, com.pullenti.morph.MorphLang.UA);
            m_Termins.add(t);
        }
        for (String s : new String[] {"ТОГДАШНИЙ", "БЫВШИЙ", "ПРЕДЫДУЩИЙ", "FORMER", "PREVIOUS", "THEN"}) {
            t = PersonAttrTermin._new2424(s, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION);
            m_Termins.add(t);
        }
        for (String s : new String[] {"ТОДІШНІЙ", "КОЛИШНІЙ"}) {
            t = PersonAttrTermin._new2446(s, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION, com.pullenti.morph.MorphLang.UA);
            m_Termins.add(t);
        }
    ...
    private static byte[] deflate(byte[] zip) throws Exception, java.io.IOException {
        try (com.pullenti.unisharp.MemoryStream unzip = new com.pullenti.unisharp.MemoryStream()) {
            ...
            com.pullenti.morph.internal.MorphSerializeHelper.deflateGzip(_data, unzip);
            _data.close();
    ...
    private static void loadAttrs(com.pullenti.ner.core.TerminCollection termins, byte[] dat, com.pullenti.morph.MorphLang lang) throws Exception, java.io.IOException, javax.xml.stream.XMLStreamException, org.xml.sax.SAXException {
        ...
        try (com.pullenti.unisharp.MemoryStream tmp = new com.pullenti.unisharp.MemoryStream(deflate(dat))) {
            ...
            for (org.w3c.dom.Node x : (new com.pullenti.unisharp.XmlNodeListWrapper(xml.doc.getDocumentElement().getChildNodes())).arr) {
                ...
                if (com.pullenti.unisharp.Utils.stringsEq(val, "ОТЕЦ")) {
                }
                PersonAttrTermin pat = PersonAttrTermin._new2451(val, PersonAttrTerminType.POSITION, lang);
    ...
    public PersonItemToken kingSurname;
    ...
    public static PersonAttrToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnto, PersonAttrAttachAttrs attrs) {
        if (t == null) 
            return null;
        Object olev = null;
        int lev = 0;
        com.pullenti.unisharp.Outargwrapper<Object> wrapolev2455 = new com.pullenti.unisharp.Outargwrapper<Object>();
        boolean inoutres2456 = com.pullenti.unisharp.Utils.tryGetValue(t.kit.miscData, "pat", wrapolev2455);
        olev = wrapolev2455.value;
        if (!inoutres2456) 
            t.kit.miscData.put("pat", (lev = 1));
        else {
            lev = (int)olev;
            if (lev > 2) 
                return null;
            lev++;
            t.kit.miscData.put("pat", lev);
        }
        ...
        if (res == null) {
            if (t.getMorph()._getClass().isNoun()) {
                ...
                if (aterr != null) {
                    ...
                    if (rt != null) {
                        res = _new2452(rt.getBeginToken(), rt.getEndToken(), rt.getMorph());
            ...
            if (((((t instanceof com.pullenti.ner.TextToken)) && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "АК") && t.getNext() != null) && t.getNext().isChar('.') && t.getNext().getNext() != null) && !t.getNext().getNext().chars.isAllLower()) {
                res = _new2453(t, t.getNext(), PersonAttrTerminType.POSITION);
                res.setPropRef(com.pullenti.ner.person.PersonPropertyReferent._new2454("академик"));
                return res;
            }
            ...
            if (t.isValue("ГВАРДИИ", "ГВАРДІЇ")) {
                res = _TryAttach(t.getNext(), locOnto, attrs);
                if (res != null) {
        ...
        if (res.typ == PersonAttrTerminType.OTHER && res.age != null && res.value == null) {
            PersonAttrToken res1 = _TryAttach(res.getEndToken().getNext(), locOnto, attrs);
            if (res1 != null) {
        ...
        if (mc.isAdjective()) {
            ...
            if (npt != null && npt.endChar > res.endChar) {
                if (m_Termins.tryParse(npt.getEndToken(), com.pullenti.ner.core.TerminParseAttr.NO) == null) 
                    return null;
            }
        }
        if (res.typ == PersonAttrTerminType.PREFIX && (((((com.pullenti.unisharp.Utils.stringsEq(res.value, "ГРАЖДАНИН") || com.pullenti.unisharp.Utils.stringsEq(res.value, "ГРАЖДАНКА") || com.pullenti.unisharp.Utils.stringsEq(res.value, "УРОЖЕНЕЦ")) || com.pullenti.unisharp.Utils.stringsEq(res.value, "УРОЖЕНКА") || com.pullenti.unisharp.Utils.stringsEq(res.value, "ГРОМАДЯНИН")) || com.pullenti.unisharp.Utils.stringsEq(res.value, "ГРОМАДЯНКА") || com.pullenti.unisharp.Utils.stringsEq(res.value, "УРОДЖЕНЕЦЬ")) || com.pullenti.unisharp.Utils.stringsEq(res.value, "УРОДЖЕНКА"))) && res.getEndToken().getNext() != null) {
            ...
            if (r != null && com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), objNameGeo)) {
                ...
                PersonAttrToken aaa = _TryAttach(tt.getNext(), locOnto, attrs);
        ...
        if (res.typ == PersonAttrTerminType.KING || res.typ == PersonAttrTerminType.POSITION) {
            if (res.getBeginToken() == res.getEndToken() && res.chars.isCapitalUpper() && res.getWhitespacesAfterCount() == 1) {
                ...
                if (pit != null && pit.lastname != null && pit.lastname.isLastnameHasStdTail) {
                    com.pullenti.ner.ReferentToken rt1 = t.kit.processReferent("PERSON", t.getNext());
        ...
        if (!res.getBeginToken().chars.isAllLower()) {
            PersonItemToken pat = PersonItemToken.tryAttach(res.getBeginToken(), locOnto, PersonItemToken.ParseAttr.IGNOREATTRS, null);
        ...
        if (((com.pullenti.unisharp.Utils.stringsEq(s, "королева") || com.pullenti.unisharp.Utils.stringsEq(s, "король") || com.pullenti.unisharp.Utils.stringsEq(s, "князь"))) && res.chars.isCapitalUpper()) {
            java.util.ArrayList<PersonItemToken> pits = PersonItemToken.tryAttachList(res.getEndToken().getNext(), locOnto, PersonItemToken.ParseAttr.NO, 10);
        ...
        if (com.pullenti.unisharp.Utils.stringsEq(res.getPropRef().getName(), "министр")) {
            com.pullenti.ner.ReferentToken rt1 = res.kit.processReferent("ORGANIZATION", res.getEndToken().getNext());
        ...
        if (res.getBeginToken().getMorph()._getClass().isAdjective()) {
            com.pullenti.ner.ReferentToken r = res.kit.processReferent("GEO", res.getBeginToken());
            if (r != null) {
        ...
        if (res.getEndToken().getWhitespacesAfterCount() < 2) {
            ...
            if (te != null && te.isValue("В", null)) {
                ...
                if (((te instanceof com.pullenti.ner.ReferentToken) && ((com.pullenti.unisharp.Utils.stringsEq(te.getReferent().getTypeName(), objNameDate) || com.pullenti.unisharp.Utils.stringsEq(te.getReferent().getTypeName(), objNameDateRange))) && te.getNext() != null) && te.getNext().isChar(')')) 
                    ...
                    com.pullenti.ner.ReferentToken rt1 = te.kit.processReferent("DATE", te);
        ...
        if (res.getPropRef() != null && res.getPropRef().getKind() == com.pullenti.ner.person.PersonPropertyKind.KING) {
            ...
            if (t1 != null && t1.chars.isCapitalUpper() && t1.getMorph()._getClass().isAdjective()) {
                if ((((res.kingSurname = PersonItemToken.tryAttach(t1, locOnto, PersonItemToken.ParseAttr.IGNOREATTRS, null)))) != null) {
                    res.setEndToken(t1);
                    if ((t1.getNext() != null && t1.getNext().isAnd() && t1.getNext().getNext() != null) && t1.getNext().getNext().isValue("ВСЕЯ", null)) {
                        t1 = t1.getNext().getNext().getNext();
                        com.pullenti.ner.geo.GeoReferent _geo = (com.pullenti.ner.geo.GeoReferent)com.pullenti.unisharp.Utils.cast(((t1 == null ? null : t1.getReferent())), com.pullenti.ner.geo.GeoReferent.class);
                        if (_geo != null) {
                            res.setEndToken(t1);
                            res.getPropRef().addSlot(com.pullenti.ner.person.PersonPropertyReferent.ATTR_REF, _geo, false, 0);
                        }
                    }
                }
            }
            ...
            com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(res.getBeginToken(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);{
                    ...
                    if (tt0 != null) {
                        ...
                        for (com.pullenti.ner.Token tt = tt0.getPrevious(); tt != null && (cou < 200); tt = tt.getPrevious(),cou++) {
                            ...
                            if (pr != null) {
                                if ((((tt.getMorph().getGender().value()) & (gen.value()))) == (com.pullenti.morph.MorphGender.UNDEFINED.value())) 
                                    continue;
                                break;
                            }
                            ...
                            npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(tt0, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                        ...
                        if (pa != null) {
                            com.pullenti.ner.Token t1 = res.getEndToken().getNext();
                            com.pullenti.ner.ReferentToken pr = com.pullenti.ner.person.PersonAnalyzer.tryAttachPerson(t1, (com.pullenti.ner.person.PersonAnalyzer.PersonAnalyzerData)com.pullenti.unisharp.Utils.cast(res.kit.getAnalyzerData(pa), com.pullenti.ner.person.PersonAnalyzer.PersonAnalyzerData.class), false, 0, true);
                            if (pr != null && res.canHasPersonAfter == 1) {
                                if (pr.getBeginToken() == t1) {
                                    if (!pr.getMorph().getCase().isGenitive() && !pr.getMorph().getCase().isUndefined()) 
                                        ...
                                        if (com.pullenti.ner.person.PersonAnalyzer.tryAttachPerson(pr.getEndToken().getNext(), (com.pullenti.ner.person.PersonAnalyzer.PersonAnalyzerData)com.pullenti.unisharp.Utils.cast(res.kit.getAnalyzerData(pa), com.pullenti.ner.person.PersonAnalyzer.PersonAnalyzerData.class), false, 0, true) != null) {
                                        }
                                        else 
                                            pr = null;
                                    }
                                ...
                                java.util.ArrayList<PersonItemToken> pits = PersonItemToken.tryAttachList(t1, null, PersonItemToken.ParseAttr.NO, 10);
                                if (((pits != null && pits.size() > 1 && pits.get(0).firstname != null) && pits.get(1).firstname != null && pr.endChar > pits.get(0).endChar) && pits.get(0).getMorph().getCase().isGenitive()) {
                                    pr = null;
                                    int cou = 100;
        ...
        if (res.chars.isLatinLetter() && res.getPropRef() != null && (res.getWhitespacesAfterCount() < 2)) {
            PersonAttrToken rnext = tryAttach(res.getEndToken().getNext(), locOnto, PersonAttrAttachAttrs.NO);
    ...
    private static PersonAttrToken _TryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnto, PersonAttrAttachAttrs attrs) {
        if (t == null) 
            return null;
        if (t.getMorph()._getClass().isPronoun() && (((t.isValue("ЕГО", "ЙОГО") || t.isValue("ЕЕ", "ЇЇ") || t.isValue("HIS", null)) || t.isValue("HER", null)))) {
            PersonAttrToken res1 = tryAttach(t.getNext(), locOnto, attrs);
            if (res1 != null && res1.getPropRef() != null) {
                ...
                for (com.pullenti.ner.Token tt2 = t.getPrevious(); tt2 != null && (k < 10); tt2 = tt2.getPrevious(),k++) {
                    ...
                    if (com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), objNameOrg) || (r instanceof com.pullenti.ner.person.PersonReferent)) {
                        ...
                        else if ((((tt2.getMorph().getGender().value()) & (((com.pullenti.morph.MorphGender.MASCULINE.value()) | (com.pullenti.morph.MorphGender.NEUTER.value()))))) != (com.pullenti.morph.MorphGender.UNDEFINED.value())) 
                            ok = true;
                        if (ok) {
        ...
        if (nta != null) {
            if (nta.getMorph()._getClass().isAdjective() || ((t.getPrevious() != null && t.getPrevious().isComma())) || ((nta.getEndToken().getNext() != null && nta.getEndToken().getNext().isCharOf(",.")))) 
                return _new2457(t, nta.getEndToken(), PersonAttrTerminType.OTHER, nta.getValue().toString(), nta.getMorph());
        }
        if (t.isNewlineBefore()) {
            ...
            if (li != null && li.typ == com.pullenti.ner.mail.internal.MailLine.Types.BESTREGARDS) 
                return _new2459(li.getBeginToken(), li.getEndToken(), PersonAttrTerminType.BESTREGARDS, com.pullenti.ner.MorphCollection._new2458(com.pullenti.morph.MorphCase.NOMINATIVE));
        }
        ...
        if (tt == null) {
            ...
            if (nt != null) {
                if (((com.pullenti.unisharp.Utils.stringsEq(nt.getValue(), "1") || com.pullenti.unisharp.Utils.stringsEq(nt.getValue(), "2") || com.pullenti.unisharp.Utils.stringsEq(nt.getValue(), "3"))) && nt.getMorph()._getClass().isAdjective()) {
                    PersonAttrToken pat0 = _TryAttach(t.getNext(), locOnto, attrs);
            ...
            if ((rr instanceof com.pullenti.ner.person.PersonReferent) && com.pullenti.ner.core.MiscHelper.isEngAdjSuffix(t.getNext())) {
                PersonAttrToken res0 = _TryAttach(t.getNext().getNext().getNext(), locOnto, attrs);
        ...
        if (com.pullenti.ner.core.MiscHelper.isEngArticle(tt)) {
            PersonAttrToken res0 = _TryAttach(t.getNext(), locOnto, attrs);
            if (res0 != null) {
                res0.setBeginToken(t);
                return res0;
            }
        ...
        if ((com.pullenti.unisharp.Utils.stringsEq(tt.term, "Г") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "ГР") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "М")) || com.pullenti.unisharp.Utils.stringsEq(tt.term, "Д")) {
            if (tt.getNext() != null && tt.getNext().isHiphen() && (tt.getNext().getNext() instanceof com.pullenti.ner.TextToken)) {
                ...
                if (vars != null) {
                    PersonAttrToken res = _new2453(tt, tt.getNext().getNext(), PersonAttrTerminType.PREFIX);
        ...
        if (com.pullenti.unisharp.Utils.stringsEq(tt.term, "ГР") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "ГРАЖД")) {
            ...
            if (t1.getNext() instanceof com.pullenti.ner.NumberToken) 
                return null;
            return _new2461(tt, t1, PersonAttrTerminType.PREFIX, (tt.getMorph().getLanguage().isUa() ? "ГРОМАДЯНИН" : "ГРАЖДАНИН"));
        }
        com.pullenti.ner.core.NounPhraseToken npt0 = null;
        for (int step = 0; step < 2; step++) {
            java.util.ArrayList<com.pullenti.ner.core.TerminToken> toks = m_Termins.tryParseAll(t, com.pullenti.ner.core.TerminParseAttr.NO, 0.0);
            if (toks == null && t.isValue("ВРИО", null)) {
                toks = new java.util.ArrayList<com.pullenti.ner.core.TerminToken>();
                toks.add(com.pullenti.ner.core.TerminToken._new646(t, t, m_TerminVrio));
            }
                ...
                if (str.endsWith("MAN") || str.endsWith("PERSON") || str.endsWith("MIST")) {
                    toks = new java.util.ArrayList<com.pullenti.ner.core.TerminToken>();
                    toks.add(com.pullenti.ner.core.TerminToken._new646(t, t, PersonAttrTermin._new2408(str, t.getMorph().getLanguage(), PersonAttrTerminType.POSITION)));
                }
                else if (com.pullenti.unisharp.Utils.stringsEq(str, "MODEL") && (t.getWhitespacesAfterCount() < 2)) {
                    com.pullenti.ner.ReferentToken rt = t.kit.processReferent("PERSON", t.getNext());
            ...
            if ((toks == null && step == 0 && t.chars.isLatinLetter()) && (t.getWhitespacesAfterCount() < 2)) {
                ...
                if (npt1 != null && npt1.getBeginToken() != npt1.getEndToken()) {
                    java.util.ArrayList<PersonItemToken> pits = PersonItemToken.tryAttachList(t, locOnto, PersonItemToken.ParseAttr.of((PersonItemToken.ParseAttr.CANBELATIN.value()) | (PersonItemToken.ParseAttr.IGNOREATTRS.value())), 10);
                    if (pits != null && pits.size() > 1 && pits.get(0).firstname != null) 
                        npt1 = null;
                    int k = 0;
                    if (npt1 != null) {
                        for (com.pullenti.ner.Token tt2 = npt1.getBeginToken(); tt2 != null && tt2.endChar <= npt1.endChar; tt2 = tt2.getNext()) {
                            java.util.ArrayList<com.pullenti.ner.core.TerminToken> toks1 = m_Termins.tryParseAll(tt2, com.pullenti.ner.core.TerminParseAttr.NO, 0.0);
                            if (toks1 != null) {
                                step = 1;
                                toks = toks1;
                                npt0 = com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.NO, toks1.get(0).endChar);
                    ...
                    if ((mc.isMisc() || mc.isPreposition() || mc.isConjunction()) || mc.isPersonalPronoun() || mc.isPronoun()) {
                        ...
                        if ((t.getNext() != null && t.getNext().isHiphen() && !t.isWhitespaceAfter()) && !t.getNext().isWhitespaceAfter()) 
                            ...
                            tt1 = t.getNext();
                        java.util.ArrayList<com.pullenti.ner.core.TerminToken> toks1 = m_Termins.tryParseAll(tt1, com.pullenti.ner.core.TerminParseAttr.NO, 0.0);
                ...
                for (com.pullenti.ner.core.TerminToken tok : toks) {
                    ...
                    if (pat.typ == PersonAttrTerminType.PREFIX) {
                        if (step == 0 || ((com.pullenti.unisharp.Utils.stringsNe(pat.getCanonicText(), "ГРАЖДАНИН") && com.pullenti.unisharp.Utils.stringsNe(pat.getCanonicText(), "ГРОМАДЯНИН")))) 
                            return _new2467(tok.getBeginToken(), tok.getEndToken(), PersonAttrTerminType.PREFIX, pat.getCanonicText(), tok.getMorph(), pat.getGender());
                    }
                    if (pat.typ == PersonAttrTerminType.BESTREGARDS) {
                        ...
                        return _new2459(tok.getBeginToken(), end, PersonAttrTerminType.BESTREGARDS, com.pullenti.ner.MorphCollection._new2458(com.pullenti.morph.MorphCase.NOMINATIVE));
                    }
                    if (pat.typ == PersonAttrTerminType.POSITION || pat.typ == PersonAttrTerminType.PREFIX || pat.typ == PersonAttrTerminType.KING) {
                        ...
                        if (res != null) {
                            ...
                            if ((t.endChar < res.beginChar) && res.getPropRef() != null) {
                        ...
                        if (res != null) {
                            ...
                            if (pit != null && pit.typ == PersonItemToken.ItemType.INITIAL) {
                                boolean ok = false;
                                pit = PersonItemToken.tryAttach(pit.getEndToken().getNext(), null, PersonItemToken.ParseAttr.IGNOREATTRS, null);
                                if (pit != null && pit.typ == PersonItemToken.ItemType.INITIAL) {
                                    pit = PersonItemToken.tryAttach(pit.getEndToken().getNext(), null, PersonItemToken.ParseAttr.IGNOREATTRS, null);
                                    if (pit != null && pit.typ == PersonItemToken.ItemType.INITIAL) 
                                        ok = true;
                                ...
                                if (!ok) {
                                    if (_TryAttach(tok.getEndToken().getNext(), locOnto, attrs) != null) 
                                        ok = true;
                                }
                                if (!ok) 
                                    return null;
                            ...
                            if (npt0 != null) {
                                ...
                                String na0 = npt0.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false).toLowerCase();
                                ...
                                if (emptyAdj != null) {
                                    PersonAttrToken res1 = _new2470(res.getBeginToken(), res.getEndToken(), npt0.getMorph(), res);
            ...
            if ((te != null && te.getPrevious().isHiphen() && !te.isWhitespaceAfter()) && !te.isWhitespaceBefore()) {
                if (com.pullenti.ner.core.BracketHelper.isBracket(te, false)) {
                    ...
                    if (br != null && (te instanceof com.pullenti.ner.TextToken)) {
                        ppp = _new2452(t, br.getEndToken(), br.getEndToken().getPrevious().getMorph());
    ...
    private static java.util.ArrayList<com.pullenti.morph.MorphWordForm> getStdForms(String tail, String w1, String w2) {
        ...
        com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.morph.MorphWordForm>> wrapli12474 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.morph.MorphWordForm>>();
        boolean inoutres2475 = com.pullenti.unisharp.Utils.tryGetValue(m_StdForms, w1, wrapli12474);
        li1 = wrapli12474.value;
        if (!inoutres2475) {
            li1 = com.pullenti.morph.Morphology.getAllWordforms(w1, null);
        ...
        if (w2 != null) {
            com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.morph.MorphWordForm>> wrapli22472 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.morph.MorphWordForm>>();
            boolean inoutres2473 = com.pullenti.unisharp.Utils.tryGetValue(m_StdForms, w2, wrapli22472);
            li2 = wrapli22472.value;
            if (!inoutres2473) {
                li2 = com.pullenti.morph.Morphology.getAllWordforms(w2, null);
    ...
    private static PersonAttrToken createAttrPosition(com.pullenti.ner.core.TerminToken tok, com.pullenti.ner.core.IntOntologyCollection locOnto, PersonAttrAttachAttrs attrs) {
        ...
        if (ty2 == PersonAttrTerminType2.ABBR) {
            ...
            return _new2476(tok.getBeginToken(), tok.getEndToken(), pr0, PersonAttrTerminType.POSITION);
        }
        if (ty2 == PersonAttrTerminType2.IO || ty2 == PersonAttrTerminType2.IO2) {
            for (int k = 0; ; k++) {
                ...
                if (tt != null && tt.getMorph()._getClass().isPreposition()) 
                    tt = tt.getNext();
                PersonAttrToken resPat = _new2453(tok.getBeginToken(), tok.getEndToken(), PersonAttrTerminType.POSITION);
                ...
                if (tt != null && (tt.getReferent() instanceof com.pullenti.ner.person.PersonPropertyReferent)) {
                    ...
                    if (pat == null) {
                        ...
                        if (npt == null || npt.getEndToken() == tok.getEndToken().getNext()) 
                            continue;
                        pat = tryAttach(npt.getEndToken(), locOnto, PersonAttrAttachAttrs.NO);
                ...
                for (; ts != null; ts = ts.getNext()) {
                    if (ts.getMorph()._getClass().isPreposition()) {
                        if (ts.isValue("В", null) || ts.isValue("ПО", null)) {
                            ...
                            com.pullenti.ner.ReferentToken rt11 = ts.kit.processReferent("NAMEDENTITY", ts.getNext());
                            if (rt11 != null) {
                        ...
                        if (ts.isValue("ПО", null) && ts.getNext() != null) {
                            com.pullenti.ner.core.NounPhraseToken nnn = com.pullenti.ner.core.NounPhraseHelper.tryParse(ts.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                            if (nnn != null) 
                            ...
                            if (ts.getNext() != null && ts.getNext().isAnd() && nnn != null) {
                                com.pullenti.ner.core.NounPhraseToken nnn2 = com.pullenti.ner.core.NounPhraseHelper.tryParse(ts.getNext().getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                    ...
                    if (ts != resPat.getEndToken().getNext() && ts.chars.isAllLower()) {
                        com.pullenti.ner.core.NounPhraseToken nnn = com.pullenti.ner.core.NounPhraseHelper.tryParse(ts, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                        if (nnn == null) 
                            break;
                        ts = (te = nnn.getEndToken());
                        continue;
                ...
                com.pullenti.unisharp.Outargwrapper<String> wrapnam2478 = new com.pullenti.unisharp.Outargwrapper<String>(nam);
                resPat.setBeginToken(_analizeVise(resPat.getBeginToken(), wrapnam2478));
                nam = wrapnam2478.value;
        ...
        if (ty2 == PersonAttrTerminType2.ADJ) {
            PersonAttrToken pat = _TryAttach(tok.getEndToken().getNext(), locOnto, attrs);
            if (pat == null || pat.typ != PersonAttrTerminType.POSITION) 
                return null;
            if (tok.beginChar == tok.endChar && !tok.getBeginToken().getMorph()._getClass().isUndefined()) 
                return null;
        ...
        if (ty2 == PersonAttrTerminType2.GRADE) {
            ...
            if (tok.getBeginToken().isValue("КАНДИДАТ", null)) {
                ...
                if (tt != null) {
                    ...
                    if (pat2 != null) {
                        PersonAttrToken res0 = _new2453(tok.getBeginToken(), pat2.getEndToken(), PersonAttrTerminType.POSITION);
                        res0.setPropRef(com.pullenti.ner.person.PersonPropertyReferent._new2454("кандидат"));
        ...
        com.pullenti.unisharp.Outargwrapper<String> wrapname2490 = new com.pullenti.unisharp.Outargwrapper<String>(name);
        t0 = _analizeVise(t0, wrapname2490);
        name = wrapname2490.value;
        ...
        if ((t1.getNext() != null && t1.getNext().isHiphen() && !t1.isWhitespaceAfter()) && !t1.getNext().isWhitespaceAfter()) {
            if (com.pullenti.morph.CharsInfo.ooEq(t1.getNext().getNext().chars, t1.chars) || m_Termins.tryParse(t1.getNext().getNext(), com.pullenti.ner.core.TerminParseAttr.NO) != null || ((t1.getNext().getNext().chars.isAllLower() && t1.getNext().getNext().chars.isCyrillicLetter()))) {
                ...
                if (npt != null && npt.getEndToken() == t1.getNext().getNext()) {
                    name = npt.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false).toLowerCase();
                    t1 = npt.getEndToken();
                }
            }
        }
        ...
        for (com.pullenti.ner.Token t = t1.getNext(); t != null; t = t.getNext()) {
            ...
            if (t.isNewlineBefore()) {
                ...
                if (!ok) {
                    com.pullenti.ner.core.NounPhraseToken npt00 = com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.PARSEPREPOSITION, 0);
                    if (npt00 != null && npt00.getEndToken().getNext() != null && !_isPerson(t)) {
                        ...
                        for (com.pullenti.ner.Token ttt = tt1.getNext(); ttt != null; ttt = ttt.getNext()) {
                            if (!ttt.isCommaAnd()) 
                                break;
                            npt00 = com.pullenti.ner.core.NounPhraseHelper.tryParse(ttt.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                            if (npt00 == null) 
                                break;
                        ...
                        if (zap && !and) {
                            ...
                            if (_isPerson(tt1.getNext())) 
                                ...
                                if (_isPerson(tt1.getNext().getNext())) 
                                    ...
                                    String ccc;
                                    com.pullenti.unisharp.Outargwrapper<String> wrapccc2481 = new com.pullenti.unisharp.Outargwrapper<String>();
                                    com.pullenti.ner.Token ttt = tryAttachCategory(tt1.getNext().getNext(), wrapccc2481);
                                    ccc = wrapccc2481.value;
                                    if (ttt != null) 
                                        ok = true;
                                }
                            }
            ...
            if (pat != null) {
                if (pat.getMorph().getNumber() == com.pullenti.morph.MorphNumber.PLURAL && !pat.getMorph().getCase().isNominative()) {
                    ...
                    com.pullenti.ner.ReferentToken ppp = t.kit.processReferent("PERSON", pat.getEndToken().getNext().getNext());
                    if (ppp != null) {
                        t1 = (tname1 = (t = pat.getEndToken()));
                        continue;
                    }
            ...
            else if ((te.isHiphen() && te.getNext() != null && !te.isWhitespaceBefore()) && !te.isWhitespaceAfter() && com.pullenti.morph.CharsInfo.ooEq(te.getPrevious().chars, te.getNext().chars)) 
                continue;
            ...
            if ((te.chars.isLatinLetter() && te.getLengthChar() > 1 && !t0.chars.isLatinLetter()) && !te.chars.isAllLower()) {
                if (r == null || com.pullenti.unisharp.Utils.stringsNe(r.getTypeName(), objNameOrg)) {
                    com.pullenti.unisharp.Outargwrapper<String> wrapcategory2482 = new com.pullenti.unisharp.Outargwrapper<String>();
                    com.pullenti.ner.Token tt = tryAttachCategory(t, wrapcategory2482);
                    category = wrapcategory2482.value;
            ...
            if (r != null) {
                ...
                if ((com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), objNameGeo) || com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), objNameAddr) || com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), objNameOrg)) || com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), objNameTransport)) {
                    ...
                    boolean posol = ((com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), objNameGeo) || com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), objNameOrg))) && com.pullenti.morph.LanguageHelper.endsWithEx(name, "посол", "представитель", null, null);
                    if (posol) {
                        t = t1;
                        continue;
                    }
            ...
            if (category == null) {
                com.pullenti.unisharp.Outargwrapper<String> wrapcategory2483 = new com.pullenti.unisharp.Outargwrapper<String>();
                com.pullenti.ner.Token tt = tryAttachCategory(t, wrapcategory2483);
                category = wrapcategory2483.value;
                if (tt != null && name != null) {
                    t = (t1 = tt);
                    continue;
                }
            ...
            if (!t.chars.isAllLower()) {
                PersonItemToken pit = PersonItemToken.tryAttach(t, locOnto, PersonItemToken.ParseAttr.of((PersonItemToken.ParseAttr.CANBELATIN.value()) | (PersonItemToken.ParseAttr.IGNOREATTRS.value())), null);
                if (pit != null) {
                    ...
                    if (pit.firstname != null && pit.firstname.isInDictionary) 
                        break;
                    java.util.ArrayList<PersonItemToken> pits = PersonItemToken.tryAttachList(t, locOnto, PersonItemToken.ParseAttr.of((PersonItemToken.ParseAttr.NO.value()) | (PersonItemToken.ParseAttr.IGNOREATTRS.value())), 6);
                    if (pits != null && pits.size() > 0) {
                        if (pits.size() == 2) {
            ...
            if (!t.chars.isAllLower()) {
                if (t.kit.miscData.containsKey("TestAttr")) {
                    ...
                    java.util.ArrayList<PersonItemToken> pits = PersonItemToken.tryAttachList(t, null, PersonItemToken.ParseAttr.IGNOREATTRS, 10);
                    if (pits != null && pits.size() > 1) {
                        ...
                        java.util.ArrayList<PersonIdentityToken> li = PersonIdentityToken.tryAttach(pits, 0, com.pullenti.morph.MorphBaseInfo._new2484(com.pullenti.morph.MorphCase.ALLCASES), null, false, false);
                        t.kit.miscData.remove("TestAttr");
                        if (li.size() > 0 && li.get(0).coef > 1) {
                            t.kit.miscData.put("TestAttr", null);
                            java.util.ArrayList<PersonIdentityToken> li1 = PersonIdentityToken.tryAttach(pits, iii, com.pullenti.morph.MorphBaseInfo._new2484(com.pullenti.morph.MorphCase.ALLCASES), null, false, false);
                            t.kit.miscData.remove("TestAttr");
                            if (li1.size() == 0) 
                                break;
                            ...
                            t.kit.miscData.put("TestAttr", null);
                            java.util.ArrayList<PersonIdentityToken> li1 = PersonIdentityToken.tryAttach(pits, 1, com.pullenti.morph.MorphBaseInfo._new2484(com.pullenti.morph.MorphCase.ALLCASES), null, false, false);
                            t.kit.miscData.remove("TestAttr");
            ...
            if ((npt == null && (t instanceof com.pullenti.ner.NumberToken) && (t.getWhitespacesAfterCount() < 3)) && (t.getWhitespacesBeforeCount() < 3)) {
                com.pullenti.ner.core.NounPhraseToken npt00 = com.pullenti.ner.core.NounPhraseHelper.tryParse(t.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                if (npt00 != null) {
            ...
            if (npt != null) {
                ...
                test = true;
            if (test) {
                com.pullenti.ner.ReferentToken rto = t.kit.processReferent("ORGANIZATION", t);
                if (rto != null) {
                ...
                if (rto != null && rto.endChar >= t.endChar && rto.beginChar == t.beginChar) {
                    ...
                    if (t.getNext() != null && t.getNext().isAnd()) {
                        com.pullenti.ner.ReferentToken rto2 = t.kit.processReferent("ORGANIZATION", t.getNext().getNext());
                        if (rto2 != null && rto2.beginChar == t.getNext().getNext().beginChar) {
            ...
            if (t.getMorph()._getClass().isPreposition()) {
                ...
                if (npt == null && t.getNext() != null && t.getNext().getMorph()._getClass().isAdverb()) 
                    npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t.getNext().getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                if (npt != null && _existsInDoctionary(npt.getEndToken())) {
                    ...
                    if ((t.isValue("ПО", null) && npt.getMorph().getCase().isDative() && !npt.noun.isValue("ИМЯ", "ІМЯ")) && !npt.noun.isValue("ПРОЗВИЩЕ", "ПРІЗВИСЬКО") && !npt.noun.isValue("ПРОЗВАНИЕ", "ПРОЗВАННЯ")) {
                        ...
                        if (npt.noun.isValue("РАБОТА", "РОБОТА") || npt.noun.isValue("ПОДДЕРЖКА", "ПІДТРИМКА") || npt.noun.isValue("СОПРОВОЖДЕНИЕ", "СУПРОВІД")) {
                            com.pullenti.ner.core.NounPhraseToken npt2 = com.pullenti.ner.core.NounPhraseHelper.tryParse(npt.getEndToken().getNext(), com.pullenti.ner.core.NounPhraseParseAttr.PARSEPREPOSITION, 0);
                            if (npt2 != null) 
                                npt = npt2;
                        }
                    }
                ...
                if (npt != null && !((com.pullenti.morph.MorphClass.ooBitand(npt.getMorph()._getClass(), npt0.getMorph()._getClass()))).isUndefined()) {
                    if (com.pullenti.morph.CharsInfo.ooEq(npt0.chars, npt.chars)) {
                        t = (t1 = (tname1 = npt.getEndToken()));
                        npt0 = null;
                        continue;
                    }
                ...
                npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                if (npt != null && !((com.pullenti.morph.MorphClass.ooBitand(npt.getMorph()._getClass(), npt0.getMorph()._getClass()))).isUndefined()) {
                    if (com.pullenti.morph.CharsInfo.ooEq(npt0.chars, npt.chars) && npt.getEndToken().getNext() != null && npt.getEndToken().getNext().isAnd()) {
                        com.pullenti.ner.core.NounPhraseToken npt1 = com.pullenti.ner.core.NounPhraseHelper.tryParse(npt.getEndToken().getNext().getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                        if (npt1 != null && !((com.pullenti.morph.MorphClass.ooBitand(npt1.getMorph()._getClass(), com.pullenti.morph.MorphClass.ooBitand(npt.getMorph()._getClass(), npt0.getMorph()._getClass())))).isUndefined()) {
                            if (com.pullenti.morph.CharsInfo.ooEq(npt0.chars, npt1.chars)) {
            ...
            if (t.chars.isLastLower() && t.getLengthChar() > 2 && !t0.chars.isAllUpper()) {
                t1 = (tname1 = t);
                continue;
            }
        ...
        if (category != null) 
            ...
            com.pullenti.unisharp.Outargwrapper<String> wrapcategory2487 = new com.pullenti.unisharp.Outargwrapper<String>();
            com.pullenti.ner.Token tt = tryAttachCategory(t1.getNext(), wrapcategory2487);
            category = wrapcategory2487.value;
            if (tt != null) {
                name = (name + " " + category);
                t1 = tt;
            }
        ...
        pr.setName(name);
        PersonAttrToken res = _new2488(t0, t1, PersonAttrTerminType.POSITION, pr, tok.getMorph());
        ...
        if (i >= 0) {
            i += 11;
            PersonAttrToken res1 = _new2459(t0, t1, PersonAttrTerminType.POSITION, tok.getMorph());
            res1.setPropRef(new com.pullenti.ner.person.PersonPropertyReferent());
    ...
    private static boolean _isPerson(com.pullenti.ner.Token t) {
        ...
        if (!t.chars.isLetter() || t.chars.isAllLower()) 
            return false;
        com.pullenti.ner.ReferentToken rt00 = t.kit.processReferent("PERSON", t);
    ...
    private static com.pullenti.ner.Token _analizeVise(com.pullenti.ner.Token t0, com.pullenti.unisharp.Outargwrapper<String> name) {
        ...
        if (t0.getPrevious() != null && t0.getPrevious().isHiphen() && (t0.getPrevious().getPrevious() instanceof com.pullenti.ner.TextToken)) {
            ...
            if (t0.getPrevious() != null && t0.getPrevious().getPrevious() != null) {
                ...
                else if (com.pullenti.morph.CharsInfo.ooEq(t0.getPrevious().getPrevious().chars, t0.chars) && !t0.isWhitespaceBefore() && !t0.getPrevious().isWhitespaceBefore()) {
                    com.pullenti.ner.core.NounPhraseToken npt00 = com.pullenti.ner.core.NounPhraseHelper.tryParse(t0.getPrevious().getPrevious(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                    if (npt00 != null) {
                        name.value = npt00.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false).toLowerCase();
                        t0 = t0.getPrevious().getPrevious();
                    }
                }
            }
    ...
    private static PersonAttrToken createAttrGrade(com.pullenti.ner.core.TerminToken tok) {
        ...
        if (t1 == null) 
            return null;
        com.pullenti.ner.person.PersonPropertyReferent pr = new com.pullenti.ner.person.PersonPropertyReferent();
        pr.setName((tok.termin.getCanonicText().toLowerCase() + " наук"));
        return _new2491(tok.getBeginToken(), t1, PersonAttrTerminType.POSITION, pr, tok.getMorph(), false);
    }
    ...
    private static com.pullenti.ner.Token _findGradeLast(com.pullenti.ner.Token t, com.pullenti.ner.Token t0) {
        ...
        for (; t != null; t = t.getNext()) {
            ...
            if (t.isValue("Н", null)) {
                if (t0.getLengthChar() > 1 || com.pullenti.morph.CharsInfo.ooNoteq(t0.chars, t.chars)) 
                    return null;
    ...
    public static com.pullenti.ner.person.PersonPropertyKind checkKind(com.pullenti.ner.person.PersonPropertyReferent pr) {
        ...
        for (String nn : com.pullenti.unisharp.Utils.split(n, String.valueOf(' ') + String.valueOf('-'), false)) {
            java.util.ArrayList<com.pullenti.ner.core.Termin> li = m_Termins.tryAttachStr(nn, com.pullenti.morph.MorphLang.RU);
            if (li == null || li.size() == 0) 
                li = m_Termins.tryAttachStr(n, com.pullenti.morph.MorphLang.UA);
            if (li != null && li.size() > 0) {
    ...
    public static com.pullenti.ner.core.TerminToken tryAttachWord(com.pullenti.ner.Token t) {
    ...
    public static PersonAttrToken _new2452(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.setMorph(_arg3);
        return res;
    }

    public static PersonAttrToken _new2453(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static PersonAttrToken _new2457(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.age = _arg4;
        res.setMorph(_arg5);
    ...
    public static PersonAttrToken _new2459(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, com.pullenti.ner.MorphCollection _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static PersonAttrToken _new2461(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, String _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    ...
    public static PersonAttrToken _new2467(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5, com.pullenti.morph.MorphGender _arg6) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.setMorph(_arg5);
    ...
    public static PersonAttrToken _new2470(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.MorphCollection _arg3, PersonAttrToken _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.setMorph(_arg3);
    ...
    public static PersonAttrToken _new2476(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.person.PersonPropertyReferent _arg3, PersonAttrTerminType _arg4) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
    ...
    public static PersonAttrToken _new2488(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, com.pullenti.ner.person.PersonPropertyReferent _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
    ...
    public static PersonAttrToken _new2491(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, PersonAttrTerminType _arg3, com.pullenti.ner.person.PersonPropertyReferent _arg4, com.pullenti.ner.MorphCollection _arg5, boolean _arg6) {
        PersonAttrToken res = new PersonAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setPropRef(_arg4);
        res.setMorph(_arg5);
    ...
    static {
        _globalInstance = new PersonAttrToken(); 
