...
public class PersonItemToken extends com.pullenti.ner.MetaToken {
    ...
    public static class MorphPersonItemVariant extends com.pullenti.morph.MorphBaseInfo {
        ...
        public static MorphPersonItemVariant _new2584(String _arg1, com.pullenti.morph.MorphBaseInfo _arg2, boolean _arg3, String _arg4) {
    ...
    public static class MorphPersonItem {
        ...
        public void mergeHiphen(MorphPersonItem second) {
            ...
            for (com.pullenti.ner.person.internal.PersonItemToken.MorphPersonItemVariant v : vars) {
                ...
                for (com.pullenti.ner.person.internal.PersonItemToken.MorphPersonItemVariant vv : second.vars) {
                    if ((((vv.getGender().value()) & (v.getGender().value()))) != (com.pullenti.morph.MorphGender.UNDEFINED.value())) {
        ...
        public void correctLastnameVariants() {
            ...
            for (com.pullenti.ner.person.internal.PersonItemToken.MorphPersonItemVariant v : vars) {
                if (v.value != null && (((endsWithStdSurname(v.value) || com.pullenti.morph.LanguageHelper.endsWith(v.value, "АЯ") || com.pullenti.morph.LanguageHelper.endsWith(v.value, "ОЙ")) || com.pullenti.morph.LanguageHelper.endsWith(v.value, "ИЙ") || com.pullenti.morph.LanguageHelper.endsWith(v.value, "ЫЙ")))) {
        ...
        public static void initialize() {
            ...
            m_LatsnameSexStdTails = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"ОВ", "ОВА", "ЕВ", "ЄВ", "ЕВА", "ЄВA", "ИН", "ИНА", "ІН", "ІНА", "ИЙ", "АЯ"}));
        ...
        public static MorphPersonItem _new2532(boolean _arg1) {
            MorphPersonItem res = new MorphPersonItem();
            res.isHasStdPostfix = _arg1;
            return res;
        }
    
        public static MorphPersonItem _new2540(String _arg1) {
            MorphPersonItem res = new MorphPersonItem();
            res.term = _arg1;
            return res;
        }
    
        public static MorphPersonItem _new2543(String _arg1, boolean _arg2) {
            MorphPersonItem res = new MorphPersonItem();
            res.term = _arg1;
        ...
        public static MorphPersonItem _new2574(boolean _arg1) {
            MorphPersonItem res = new MorphPersonItem();
    ...
    private void addPostfixInfo(String postfix, com.pullenti.morph.MorphGender gen) {
        ...
        if (firstname != null) 
            ...
            firstname = MorphPersonItem._new2532(true);
            firstname.vars.add(new MorphPersonItemVariant(value, com.pullenti.morph.MorphBaseInfo._new2533(gen), false));
            if (lastname == null) 
                lastname = firstname;
        }
        if (middlename != null) 
    ...
    public static PersonItemToken tryAttachLatin(com.pullenti.ner.Token t) {
        ...
        if (com.pullenti.unisharp.Utils.stringsEq(tt.term, "JR") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "JNR") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "JUNIOR")) {
            ...
            if (tt.getNext() != null && tt.getNext().isChar('.')) 
                t1 = tt.getNext();
            return _new2534(tt, t1, ItemType.SUFFIX, "JUNIOR");
        }
        if ((com.pullenti.unisharp.Utils.stringsEq(tt.term, "SR") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "SNR") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "SENIOR")) || com.pullenti.unisharp.Utils.stringsEq(tt.term, "FITZ") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "FILS")) {
            ...
            if (tt.getNext() != null && tt.getNext().isChar('.')) 
                t1 = tt.getNext();
            return _new2534(tt, t1, ItemType.SUFFIX, "SENIOR");
        }
        ...
        if (initials) {
            PersonItemToken rii = _new2536(tt, tt, ItemType.INITIAL, tt.term, tt.chars);
            if (tt.getNext() != null && tt.getNext().isChar('.')) 
        ...
        if (tt.getLengthChar() == 1) {
            ...
            if (tt.getNext().isChar('.')) 
                return _new2536(tt, tt.getNext(), ItemType.INITIAL, tt.term, tt.chars);
            ...
            if (!com.pullenti.morph.LanguageHelper.isLatinVowel(tt.term.charAt(0)) || tt.getWhitespacesAfterCount() != 1) {
                ...
                if (nex != null && nex.typ == ItemType.VALUE) 
                    return _new2536(tt, tt, ItemType.INITIAL, tt.term, tt.chars);
                return null;
            }
            if (com.pullenti.unisharp.Utils.stringsEq(tt.term, "I")) 
                return null;
            return _new2536(tt, tt, ItemType.VALUE, tt.term, tt.chars);
        }
        ...
        if (cla.isProperName() || ((cla.isProper() && ((tt.getMorph().getGender() == com.pullenti.morph.MorphGender.MASCULINE || tt.getMorph().getGender() == com.pullenti.morph.MorphGender.FEMINIE))))) {
            res.firstname = MorphPersonItem._new2540(res.value);
        ...
        if (cla.isProperSurname()) {
            res.lastname = MorphPersonItem._new2540(res.value);
            for (com.pullenti.morph.MorphBaseInfo wf : tt.getMorph().getItems()) {
                if ((((com.pullenti.morph.MorphWordForm)com.pullenti.unisharp.Utils.cast(wf, com.pullenti.morph.MorphWordForm.class))).isInDictionary()) {
        ...
        if (ots != null) {
            if (ots.get(0).termin.ignoreTermsOrder) 
                return _new2542(ots.get(0).getBeginToken(), ots.get(0).getEndToken(), ItemType.REFERENT, (com.pullenti.ner.person.PersonReferent)com.pullenti.unisharp.Utils.cast(ots.get(0).item.tag, com.pullenti.ner.person.PersonReferent.class), ots.get(0).getMorph());
            res.lastname = MorphPersonItem._new2543(ots.get(0).termin.getCanonicText(), true);
            for (com.pullenti.ner.core.IntOntologyToken ot : ots) {
                if (ot.termin != null) {
                    ...
                    if (ot.termin.getGender() == com.pullenti.morph.MorphGender.MASCULINE || ot.termin.getGender() == com.pullenti.morph.MorphGender.FEMINIE) 
                        mi = com.pullenti.morph.MorphBaseInfo._new2533(ot.termin.getGender());
        ...
        if (res.value.startsWith("MAC")) {
            ...
            res.lastname = MorphPersonItem._new2532(true);
            res.lastname.vars.add(new MorphPersonItemVariant(res.value, new com.pullenti.morph.MorphBaseInfo(), true));
        }
        return res;
    }

    public static PersonItemToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnt, ParseAttr attrs, java.util.ArrayList<PersonItemToken> prevList) {
        if (t == null) 
            return null;
        ...
        if (t instanceof com.pullenti.ner.NumberToken) {
            ...
            if (nt.getBeginToken() == nt.getEndToken() && nt.typ == com.pullenti.ner.NumberSpellingType.WORDS && ((!nt.getBeginToken().chars.isAllLower() || (((attrs.value()) & (ParseAttr.MUSTBEITEMALWAYS.value()))) != (ParseAttr.NO.value())))) {
                PersonItemToken res00 = tryAttach(nt.getBeginToken(), locOnt, attrs, prevList);
                if (res00 != null) {
                    res00.setBeginToken(res00.setEndToken(t));
                    return res00;
                }
        ...
        if (t instanceof com.pullenti.ner.ReferentToken) {
            ...
            if (rt.getBeginToken() == rt.getEndToken() && rt.getBeginToken().chars.isCapitalUpper()) {
                PersonItemToken res00 = tryAttach(rt.getBeginToken(), locOnt, attrs, prevList);
                if (res00 != null) {
                    PersonItemToken res01 = tryAttach(t.getNext(), locOnt, attrs, prevList);
        ...
        if ((((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 2 && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "JI")) && t.chars.isAllUpper() && !t.isWhitespaceAfter()) && t.getNext() != null && t.getNext().isChar('.')) {
            PersonItemToken re1 = _new2534(t, t.getNext(), ItemType.INITIAL, "Л");
        ...
        if ((((((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 1 && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "J")) && t.chars.isAllUpper() && !t.isWhitespaceAfter()) && (t.getNext() instanceof com.pullenti.ner.NumberToken) && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).getValue(), "1")) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT && t.getNext().getNext() != null) && t.getNext().getNext().isChar('.')) {
            PersonItemToken re1 = _new2534(t, t.getNext().getNext(), ItemType.INITIAL, "Л");
            re1.chars.setCyrillicLetter(true);
            re1.chars.setAllUpper(true);
            return re1;
        }
        if ((((((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 1 && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "I")) && t.chars.isAllUpper() && !t.isWhitespaceAfter()) && (t.getNext() instanceof com.pullenti.ner.NumberToken) && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).getValue(), "1")) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT && t.getNext().getNext() != null) && t.getNext().getNext().isChar('.')) {
            if (prevList != null && prevList.get(0).chars.isCyrillicLetter()) {
                PersonItemToken re1 = _new2534(t, t.getNext().getNext(), ItemType.INITIAL, "П");
                re1.chars.setCyrillicLetter(true);
                re1.chars.setAllUpper(true);
                return re1;
            }
        }
        if (locOnt != null && locOnt.getItems().size() > 1000) 
            locOnt = null;
        ...
        if (t.chars.isLatinLetter() && (((attrs.value()) & (ParseAttr.CANBELATIN.value()))) != (ParseAttr.NO.value())) {
            java.util.ArrayList<com.pullenti.ner.core.IntOntologyToken> ots = null;
            if (locOnt != null) 
                ots = locOnt.tryAttach(t, com.pullenti.ner.person.PersonReferent.OBJ_TYPENAME, false);
            if (t != null && t.kit.ontology != null && ots == null) 
                ots = t.kit.ontology.attachToken(com.pullenti.ner.person.PersonReferent.OBJ_TYPENAME, t);
            if (ots != null && (t instanceof com.pullenti.ner.TextToken)) {
                if (ots.get(0).termin.ignoreTermsOrder) 
                    return _new2542(ots.get(0).getBeginToken(), ots.get(0).getEndToken(), ItemType.REFERENT, (com.pullenti.ner.person.PersonReferent)com.pullenti.unisharp.Utils.cast(ots.get(0).item.tag, com.pullenti.ner.person.PersonReferent.class), ots.get(0).getMorph());
                res = _new2550(ots.get(0).getBeginToken(), ots.get(0).getEndToken(), (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, ots.get(0).chars);
                res.lastname = MorphPersonItem._new2543(ots.get(0).termin.getCanonicText(), true);
                for (com.pullenti.ner.core.IntOntologyToken ot : ots) {
                    if (ot.termin != null) {
                        com.pullenti.morph.MorphBaseInfo mi = ot.getMorph();
        ...
        if (((t instanceof com.pullenti.ner.NumberToken) && t.getLengthChar() == 1 && (((attrs.value()) & (ParseAttr.CANINITIALBEDIGIT.value()))) != (ParseAttr.NO.value())) && t.getNext() != null && t.getNext().isCharOf(".„")) {
            if (com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getValue(), "1")) 
                return _new2536(t, t.getNext(), ItemType.INITIAL, "І", com.pullenti.morph.CharsInfo._new2553(true));
            if (com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getValue(), "0")) 
                return _new2536(t, t.getNext(), ItemType.INITIAL, "О", com.pullenti.morph.CharsInfo._new2553(true));
            if (com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getValue(), "3")) 
                return _new2536(t, t.getNext(), ItemType.INITIAL, "З", com.pullenti.morph.CharsInfo._new2553(true));
        }
        if ((((t instanceof com.pullenti.ner.NumberToken) && t.getLengthChar() == 1 && (((attrs.value()) & (ParseAttr.CANINITIALBEDIGIT.value()))) != (ParseAttr.NO.value())) && t.getNext() != null && t.getNext().chars.isAllLower()) && !t.isWhitespaceAfter() && t.getNext().getLengthChar() > 2) {
            ...
            if (com.pullenti.unisharp.Utils.stringsEq(num, "3") && t.getNext().chars.isCyrillicLetter()) 
                return _new2536(t, t.getNext(), ItemType.VALUE, "З" + (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.TextToken.class))).term, com.pullenti.morph.CharsInfo._new2559(true, true));
            if (com.pullenti.unisharp.Utils.stringsEq(num, "0") && t.getNext().chars.isCyrillicLetter()) 
                return _new2536(t, t.getNext(), ItemType.VALUE, "О" + (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.TextToken.class))).term, com.pullenti.morph.CharsInfo._new2559(true, true));
        }
        if (((((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 1 && t.chars.isLetter()) && t.chars.isAllUpper() && (t.getWhitespacesAfterCount() < 2)) && (t.getNext() instanceof com.pullenti.ner.TextToken) && t.getNext().getLengthChar() == 1) && t.getNext().chars.isAllLower()) {
            ...
            if (cou < 5) {
                if (prevList != null && prevList.size() > 0 && prevList.get(prevList.size() - 1).typ == ItemType.INITIAL) {
                    ...
                    PersonItemToken ne = tryAttach(t1.getNext(), locOnt, attrs, null);
            ...
            for (com.pullenti.ner.Token tt = t; tt != null && tt.endChar <= t1.endChar; tt = tt.getNext()) {
                ch = (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).getSourceText().charAt(0);
            ...
            res = _new2534(t, t1, ItemType.VALUE, val.toString());
            res.chars = com.pullenti.morph.CharsInfo._new2564(true, isCyr, !isCyr, true);
            return res;
        }
        if ((((attrs.value()) & (ParseAttr.MUSTBEITEMALWAYS.value()))) != (ParseAttr.NO.value()) && (t instanceof com.pullenti.ner.TextToken) && !t.chars.isAllLower()) {
            res = _new2565(t, t, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term);
            return res;
        }
        if (((t.chars.isAllUpper() && t.getLengthChar() == 1 && prevList != null) && prevList.size() > 0 && (t.getWhitespacesBeforeCount() < 2)) && prevList.get(0).chars.isCapitalUpper()) {
            ...
            if ((last.typ == ItemType.VALUE && last.lastname != null && last.lastname.isInDictionary) && prevList.size() == 1) 
                ...
                ok = true;
            if (ok) 
                return _new2566(t, t, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, ItemType.INITIAL);
        }
        return null;
    }

    private static PersonItemToken _tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnt, ParseAttr attrs, java.util.ArrayList<PersonItemToken> prevList) {
        com.pullenti.ner.TextToken tt = (com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class);
        if (tt == null) {
            if (t.chars.isLetter() && t.chars.isCapitalUpper() && (t instanceof com.pullenti.ner.ReferentToken)) {
                ...
                if (rt.getBeginToken() == rt.getEndToken() && !((rt.referent instanceof com.pullenti.ner.person.PersonReferent))) {
                    PersonItemToken res0 = _tryAttach(rt.getBeginToken(), locOnt, attrs, null);
                    if (res0 == null) {
                        res0 = _new2567(rt, rt, rt.referent.toString(true, t.kit.baseLanguage, 0).toUpperCase(), rt.chars, rt.getMorph());
                        res0.lastname = MorphPersonItem._new2540(res0.value);
                    }
                    else 
                    ...
                    if ((t.getNext() != null && t.getNext().isHiphen() && (t.getNext().getNext() instanceof com.pullenti.ner.TextToken)) && t.getNext().getNext().getMorphClassInDictionary().isProperSecname()) {
                        PersonItemToken res1 = tryAttach(t.getNext().getNext(), locOnt, ParseAttr.NO, null);
        ...
        if (tt.getLengthChar() == 1 || com.pullenti.unisharp.Utils.stringsEq(tt.term, "ДЖ")) {
            if (tt.getNext() == null) 
                return null;
            String ini = tt.term;
            com.pullenti.morph.CharsInfo ci = new com.pullenti.morph.CharsInfo(tt.chars);
            if (!tt.chars.isCyrillicLetter()) {
            ...
            if ((tt.getNext().getWhitespacesAfterCount() < 2) && (tt.getWhitespacesAfterCount() < 2) && ((com.pullenti.unisharp.Utils.stringsEq(tt.term, "Д") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "О") || com.pullenti.unisharp.Utils.stringsEq(tt.term, "Н")))) {
                if (com.pullenti.ner.core.BracketHelper.isBracket(tt.getNext(), false) && (tt.getNext().getNext() instanceof com.pullenti.ner.TextToken)) {
                    if (tt.getNext().getNext().chars.isCyrillicLetter()) {
                        PersonItemToken pit0 = tryAttach(tt.getNext().getNext(), locOnt, ParseAttr.of((attrs.value()) | (ParseAttr.CANBELOWER.value())), prevList);
                        if (pit0 != null) {
                            pit0.setBeginToken(tt);
                            if (pit0.value != null) 
            ...
            if (!com.pullenti.morph.LanguageHelper.isCyrillicVowel(tt.term.charAt(0)) || tt.getWhitespacesAfterCount() != 1) 
                return null;
            return _new2536(tt, tt, ItemType.VALUE, tt.term, tt.chars);
        }
        if (!tt.chars.isCyrillicLetter()) 
        ...
        if (ots != null) {
            res = _new2550(ots.get(0).getBeginToken(), ots.get(0).getEndToken(), tt.term, ots.get(0).chars);
            res.lastname = MorphPersonItem._new2574(true);
            res.lastname.term = ots.get(0).termin.getCanonicText();
            for (com.pullenti.ner.core.IntOntologyToken ot : ots) {
                if (ot.termin != null) {
                    com.pullenti.morph.MorphBaseInfo mi = ot.getMorph();
                    if (ot.termin.getGender() == com.pullenti.morph.MorphGender.MASCULINE) {
                        if ((((t.getMorph().getGender().value()) & (com.pullenti.morph.MorphGender.FEMINIE.value()))) != (com.pullenti.morph.MorphGender.UNDEFINED.value())) 
                            continue;
                        mi = com.pullenti.morph.MorphBaseInfo._new2533(ot.termin.getGender());
                    }
                    else if (ot.termin.getGender() == com.pullenti.morph.MorphGender.FEMINIE) {
                        if ((((t.getMorph().getGender().value()) & (com.pullenti.morph.MorphGender.MASCULINE.value()))) != (com.pullenti.morph.MorphGender.UNDEFINED.value())) 
                            continue;
                        mi = com.pullenti.morph.MorphBaseInfo._new2533(ot.termin.getGender());
                    }
                    else 
            ...
            res = _new2567(t, t, tt.term, tt.chars, tt.getMorph());
            if (M_SURPREFIXES.contains(tt.term)) {
                if (((tt.isValue("БЕН", null) || tt.isValue("ВАН", null))) && (((attrs.value()) & (ParseAttr.ALTVAR.value()))) != (ParseAttr.NO.value()) && ((tt.getNext() == null || !tt.getNext().isHiphen()))) {
                    ...
                    if (tt.getNext() != null) {
                        ...
                        else if ((((attrs.value()) & (ParseAttr.SURNAMEPREFIXNOTMERGE.value()))) != (ParseAttr.NO.value()) && t1.chars.isAllLower()) 
                            tt = null;
                        else 
        ...
        for (com.pullenti.morph.MorphBaseInfo wff : tt.getMorph().getItems()) {
            ...
            else if ((wf._getClass().isAdjective() && adj == null && !(((wf.normalFull != null ? wf.normalFull : wf.normalCase))).endsWith("ОВ")) && !(((wf.normalFull != null ? wf.normalFull : wf.normalCase))).endsWith("ИН") && (((wf.isInDictionary() || wf.normalCase.endsWith("ЫЙ") || wf.normalCase.endsWith("ИЙ")) || wf.normalCase.endsWith("АЯ") || wf.normalCase.endsWith("ЯЯ")))) 
                adj = wf;
            ...
            if (wf._getClass().isProperSurname() || surPrefix != null) {
                if (res.lastname == null) 
                    res.lastname = MorphPersonItem._new2540(tt.term);
                if (adj != null) {
            ...
            if (wf._getClass().isProperName() && wf.getNumber() != com.pullenti.morph.MorphNumber.PLURAL) {
                ...
                if (ok) {
                    if (res.firstname == null) 
                        res.firstname = MorphPersonItem._new2540(tt.term);
            ...
            if (!MorphPersonItem.endsWithStdSurname(tt.term)) {
                if (wf._getClass().isProperSecname()) {
                    if (res.middlename == null) 
                        res.middlename = MorphPersonItem._new2540(tt.term);
                ...
                if (g != com.pullenti.morph.MorphGender.MASCULINE && g != com.pullenti.morph.MorphGender.FEMINIE) {
                    ...
                    for (ShortNameHelper.ShortnameVar kp : di) {
                        if (fi) {
                            ...
                            com.pullenti.morph.MorphBaseInfo mi = com.pullenti.morph.MorphBaseInfo._new2533(kp.gender);
                            res.firstname.vars.add(MorphPersonItemVariant._new2584(kp.name, mi, false, val));
                        }
                    }
                }
                else {
                    ...
                    for (ShortNameHelper.ShortnameVar kp : di) {
                        if (kp.gender == g) {
                            if ((++cou) < 2) {
                                ...
                                res.firstname.vars.add(i + 1, MorphPersonItemVariant._new2584(kp.name, res.firstname.vars.get(i), false, val));
                        }
                    }
                }
            }
        }
        if (res != null && res.isInDictionary && res.firstname == null) {
            com.pullenti.ner.core.StatisticCollection.WordInfo wi = res.kit.statistics.getWordInfo(res.getBeginToken());
        ...
        if (res.getEndToken().getNext() != null && res.getEndToken().getNext().isHiphen() && (res.getEndToken().getNext().getNext() instanceof com.pullenti.ner.TextToken)) {
            ...
            else if ((!res.isWhitespaceAfter() && !res.getEndToken().getNext().isWhitespaceAfter() && com.pullenti.morph.CharsInfo.ooEq(res.getEndToken().getNext().getNext().chars, res.getBeginToken().chars)) && res.getBeginToken() == res.getEndToken()) {
                PersonItemToken res1 = tryAttach(res.getEndToken().getNext().getNext(), locOnt, ParseAttr.NO, null);
    ...
    public static java.util.ArrayList<PersonItemToken> tryAttachList(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locOnt, ParseAttr attrs, int maxCount) {
        if (t == null) 
            return null;
        ...
        if ((t != null && t.isChar('.') && pit.typ == ItemType.VALUE) && pit.getLengthChar() > 3) {
            ...
            if (Character.isUpperCase(str.charAt(0)) && Character.isUpperCase(str.charAt(str.length() - 1))) {
                ...
                if (ok) {
                    ...
                    PersonItemToken pit2 = _new2534(t, t, ItemType.INITIAL, str.substring(str.length() - 1));
                    res.add(pit2);
                    t = t.getNext();
                }
            }
        ...
        for (; t != null; t = (t == null ? null : t.getNext())) {
            ...
            if (tt.isHiphen() && tt.getNext() != null) {
                if (!tt.isWhitespaceAfter() && !tt.isWhitespaceBefore()) 
                    tt = t.getNext();
                else if (com.pullenti.morph.CharsInfo.ooEq(tt.getPrevious().chars, tt.getNext().chars) && !tt.isNewlineAfter()) 
                    tt = tt.getNext();
            }
            ...
            else if ((tt.isChar('(') && (tt.getNext() instanceof com.pullenti.ner.TextToken) && com.pullenti.morph.CharsInfo.ooEq(tt.getNext().chars, tt.getPrevious().chars)) && tt.getNext().getNext() != null && tt.getNext().getNext().isChar(')')) {
                PersonItemToken pit0 = res.get(res.size() - 1);
                PersonItemToken pit11 = tryAttach(tt.getNext(), locOnt, attrs, null);
                if (pit0.firstname != null && pit11 != null && pit11.firstname != null) {
                    ...
                    if (pit11 != null && pit11.lastname != null) {
                        ...
                        if ((pit11.lastname.isInDictionary || pit11.lastname.isLastnameHasStdTail || pit11.lastname.isHasStdPostfix)) 
                            ...
                            PersonItemToken pit22 = tryAttach(tt.getNext().getNext().getNext(), locOnt, attrs, null);
                            if (pit22 != null) {
                ...
                if (pit1.typ == ItemType.INITIAL) {
                    if (pit1.chars.isCyrillicLetter()) {
                        ...
                        if (v != ((char)0)) {
                            ...
                            ok = true;
                            pit1.chars = com.pullenti.morph.CharsInfo._new2587(true);
                        }
                            ...
                            if (v != ((char)0)) {
                                ...
                                ok = true;
                                pit.chars = com.pullenti.morph.CharsInfo._new2553(true);
                                pit = pit1;
                            }
                        }
                    }
                        ...
                        if (v != ((char)0)) {
                            pit1.value = (String.valueOf(v));
                            ok = true;
                            pit1.chars = com.pullenti.morph.CharsInfo._new2553(true);
                        }
                        else if (pit.typ == ItemType.INITIAL) {
                            ...
                            if (v != ((char)0)) {
                                pit.value = (String.valueOf(v));
                                ok = true;
                                pit.chars = com.pullenti.morph.CharsInfo._new2587(true);
                                pit = pit1;
                            }
                        }
                    }
            ...
            if (pit1.typ == ItemType.VALUE || ((pit1.typ == ItemType.SUFFIX && pit1.isNewlineBefore()))) {
                if (locOnt != null && (((attrs.value()) & (ParseAttr.IGNOREATTRS.value()))) == (ParseAttr.NO.value())) {
                    PersonAttrToken pat = PersonAttrToken.tryAttach(pit1.getBeginToken(), locOnt, PersonAttrToken.PersonAttrAttachAttrs.NO);
                    if (pat != null) {
        ...
        if (res.size() == 1 && res.get(0).isNewlineBefore() && res.get(0).isNewlineAfter()) {
            if (res.get(0).lastname != null && ((res.get(0).lastname.isHasStdPostfix || res.get(0).lastname.isInDictionary || res.get(0).lastname.isLastnameHasStdTail))) {
                java.util.ArrayList<PersonItemToken> res1 = tryAttachList(res.get(0).getEndToken().getNext(), locOnt, ParseAttr.CANBELATIN, maxCount);
                if (res1 != null && res1.size() > 0) {
                    if (res1.size() == 2 && ((res1.get(0).firstname != null || res1.get(1).middlename != null)) && res1.get(1).isNewlineAfter()) 
                        ...
                        java.util.ArrayList<PersonItemToken> res2 = tryAttachList(res1.get(0).getEndToken().getNext(), locOnt, ParseAttr.CANBELATIN, maxCount);
        ...
        for (int i = 0; i < res.size(); i++) {
            if (res.get(i).firstname != null && res.get(i).getBeginToken().isValue("СВЕТА", null)) {
                ...
                if (res.get(i).lastname == null) {
                    res.get(i).lastname = MorphPersonItem._new2532(true);
        ...
        if (res.size() > 1 && res.get(0).isInDictionary && (((attrs.value()) & (ParseAttr.MUSTBEITEMALWAYS.value()))) == (ParseAttr.NO.value())) {
     ...
     * @param t 
     * @param prevPersTemplate шаблон от предыдущей персоны (поможет принять решение в случае ошибки)
     * @return 
     */
    public static com.pullenti.ner.ReferentToken tryParsePerson(com.pullenti.ner.Token t, FioTemplateType prevPersTemplate) {
        ...
        if (t.getReferent() instanceof com.pullenti.ner.person.PersonReferent) {
            ...
            if (rt.getBeginToken() == rt.getEndToken()) {
                ...
                if (tt1 != null && (tt1.getWhitespacesBeforeCount() < 2)) {
                    java.util.ArrayList<PersonItemToken> pits0 = PersonItemToken.tryAttachList(tt1, null, ParseAttr.CANINITIALBEDIGIT, 10);
                    if (pits0 != null && pits0.get(0).typ == ItemType.INITIAL) {
                        ...
                        if (str != null && str.startsWith(pits0.get(0).value)) {
                            com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2592(rt.referent, t, pits0.get(0).getEndToken(), FioTemplateType.SURNAMEI.value());
                    ...
                    if (((((tt1 instanceof com.pullenti.ner.TextToken) && tt1.getLengthChar() == 1 && tt1.chars.isAllUpper()) && tt1.chars.isCyrillicLetter() && (tt1.getNext() instanceof com.pullenti.ner.TextToken)) && (tt1.getWhitespacesAfterCount() < 2) && tt1.getNext().getLengthChar() == 1) && tt1.getNext().chars.isAllUpper() && tt1.getNext().chars.isCyrillicLetter()) {
                        ...
                        if (str != null && str.startsWith((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt1, com.pullenti.ner.TextToken.class))).term)) {
                            ...
                            if (str2 == null || str2.startsWith((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt1.getNext(), com.pullenti.ner.TextToken.class))).term)) {
                                com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2592(rt.referent, t, tt1.getNext(), FioTemplateType.NAMEISURNAME.value());
                                if (str2 == null) 
        ...
        java.util.ArrayList<PersonItemToken> pits = PersonItemToken.tryAttachList(t, null, ParseAttr.of((ParseAttr.CANINITIALBEDIGIT.value()) | (ParseAttr.CANBELATIN.value())), 10);
        if ((pits == null && (t instanceof com.pullenti.ner.TextToken) && t.chars.isAllLower()) && t.getLengthChar() > 3) {
            PersonItemToken pi = PersonItemToken.tryAttach(t, null, ParseAttr.of((ParseAttr.CANINITIALBEDIGIT.value()) | (ParseAttr.CANBELATIN.value()) | (ParseAttr.CANBELOWER.value())), null);
            if (pi != null && pi.lastname != null && ((pi.lastname.isInDictionary || pi.lastname.isLastnameHasStdTail))) {
                pits = PersonItemToken.tryAttachList(pi.getEndToken().getNext(), null, ParseAttr.of((ParseAttr.CANINITIALBEDIGIT.value()) | (ParseAttr.CANBELATIN.value())), 10);
        ...
        if (pits != null && prevPersTemplate != FioTemplateType.UNDEFINED && pits.get(0).typ == ItemType.VALUE) {
            ...
            if (((tt1 instanceof com.pullenti.ner.TextToken) && tt1.chars.isLetter() && tt1.chars.isAllUpper()) && tt1.getLengthChar() == 1 && (tt1.getWhitespacesBeforeCount() < 2)) {
                PersonItemToken ii = _new2536(tt1, tt1, ItemType.INITIAL, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt1, com.pullenti.ner.TextToken.class))).term, tt1.chars);
                pits.add(ii);
            }
            if (pits.size() == 1 && pits.get(0).isNewlineAfter() && ((prevPersTemplate == FioTemplateType.SURNAMEI || prevPersTemplate == FioTemplateType.SURNAMEII))) {
                java.util.ArrayList<PersonItemToken> ppp = PersonItemToken.tryAttachList(pits.get(0).getEndToken().getNext(), null, ParseAttr.CANBELATIN, 10);
        ...
        if (pits != null && pits.size() == 1 && pits.get(0).typ == ItemType.VALUE) {
            ...
            if (((tt instanceof com.pullenti.ner.TextToken) && tt.getLengthChar() == 2 && tt.chars.isAllUpper()) && tt.chars.isCyrillicLetter()) {
                ...
                com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2592(pers, t, tt, FioTemplateType.SURNAMEII.value());
                if (tt.getNext() != null && tt.getNext().isChar('.')) 
            ...
            if ((((((tt instanceof com.pullenti.ner.TextToken) && (tt.getWhitespacesBeforeCount() < 2) && tt.getLengthChar() == 1) && tt.chars.isAllUpper() && tt.chars.isCyrillicLetter()) && (tt.getNext() instanceof com.pullenti.ner.TextToken) && (tt.getWhitespacesAfterCount() < 2)) && tt.getNext().getLengthChar() == 1 && tt.getNext().chars.isAllUpper()) && tt.getNext().chars.isCyrillicLetter()) {
                ...
                com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2592(pers, t, tt.getNext(), FioTemplateType.SURNAMEII.value());
            ...
            if (comma && tt != null && (tt.getWhitespacesBeforeCount() < 2)) {
                java.util.ArrayList<PersonItemToken> pits1 = PersonItemToken.tryAttachList(tt, null, ParseAttr.of((ParseAttr.CANINITIALBEDIGIT.value()) | (ParseAttr.CANBELATIN.value())), 10);
                if (pits1 != null && pits1.size() > 0 && pits1.get(0).typ == ItemType.INITIAL) {
                    ...
                    com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new2592(pers, t, pits1.get(0).getEndToken(), FioTemplateType.SURNAMEI.value());
    ...
    public static PersonItemToken _new2534(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4) {
    ...
    public static PersonItemToken _new2536(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, com.pullenti.morph.CharsInfo _arg5) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.chars = _arg5;
    ...
    public static PersonItemToken _new2542(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.person.PersonReferent _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.referent = _arg4;
        res.setMorph(_arg5);
    ...
    public static PersonItemToken _new2550(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.morph.CharsInfo _arg4) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.value = _arg3;
        res.chars = _arg4;
        return res;
    ...
    public static PersonItemToken _new2565(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.value = _arg3;
        return res;
    }

    public static PersonItemToken _new2566(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, ItemType _arg4) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.value = _arg3;
        res.typ = _arg4;
        return res;
    ...
    public static PersonItemToken _new2567(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.morph.CharsInfo _arg4, com.pullenti.ner.MorphCollection _arg5) {
        PersonItemToken res = new PersonItemToken(_arg1, _arg2);
        res.value = _arg3;
        res.chars = _arg4;
        res.setMorph(_arg5);
    ...
    static {
        _globalInstance = new PersonItemToken(); 
        M_SURPREFIXES = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"АБД", "АБУ", "АЛ", "АЛЬ", "БИН", "БЕН", "ИБН", "ФОН", "ВАН", "ДЕ", "ДИ", "ДА", "ЛА", "ЛЕ", "ЛЯ", "ЭЛЬ"}));
        ...
        M_ARABPOSTFIX = new java.util.ArrayList<String>(java.util.Arrays.asList(new String[] {"АГА", "АЛИ", "АР", "АС", "АШ", "БЕЙ", "БЕК", "ЗАДЕ", "ОГЛЫ", "УГЛИ", "ОЛЬ", "ООЛ", "ПАША", "УЛЬ", "УЛЫ", "УУЛУ", "ХАН", "ХАДЖИ", "ШАХ", "ЭД", "ЭЛЬ"}));
