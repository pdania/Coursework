...
public class ShortNameHelper {
    ...
    public static class ShortnameVar {
        ...
        public static ShortnameVar _new2605(String _arg1, com.pullenti.morph.MorphGender _arg2) {
    ...
    public static java.util.ArrayList<ShortnameVar> getNamesForShortname(String shortname) {
        ...
        com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<ShortnameVar>> wrapres2603 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<ShortnameVar>>();
        boolean inoutres2604 = com.pullenti.unisharp.Utils.tryGetValue(m_Shorts_Names, shortname, wrapres2603);
        res = wrapres2603.value;
        if (!inoutres2604) 
            return null;
        else 
            return res;
            ...
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                if (t.isNewlineBefore()) {
                    ...
                    for (String s : shos) {
                        ...
                        com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<ShortnameVar>> wrapli2606 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<ShortnameVar>>();
                        boolean inoutres2607 = com.pullenti.unisharp.Utils.tryGetValue(m_Shorts_Names, s, wrapli2606);
                        li = wrapli2606.value;
                        if (!inoutres2607) 
                            m_Shorts_Names.put(s, (li = new java.util.ArrayList<ShortnameVar>()));
                        li.add(ShortnameVar._new2605(nam, g));
                    }
                    if (t == null) 
                        break;
                    t = t.getPrevious();
