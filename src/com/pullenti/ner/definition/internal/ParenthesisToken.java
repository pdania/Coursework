...
public class ParenthesisToken extends com.pullenti.ner.MetaToken {
    ...
    public static ParenthesisToken tryAttach(com.pullenti.ner.Token t) {
        ...
        if (ok && t.getNext() != null) {
            ...
            t1 = t.getNext();
            if (com.pullenti.morph.MorphClass.ooEq(t1.getMorphClassInDictionary(), com.pullenti.morph.MorphClass.VERB)) {
        ...
        if (t1 != null) {
            if (t1.getNext() != null) {
                com.pullenti.ner.core.NounPhraseToken npt1 = com.pullenti.ner.core.NounPhraseHelper.tryParse(t1, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                if (npt1 != null) {
            ...
            if (r != null) {
                ParenthesisToken res = _new1136(t, t1, r);
    ...
    public static ParenthesisToken _new1136(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Referent _arg3) {
