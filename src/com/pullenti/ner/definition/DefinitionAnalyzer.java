...
public class DefinitionAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.Collection<com.pullenti.ner.ReferentClass> getTypeSystem() {
        return java.util.Arrays.asList(new com.pullenti.ner.ReferentClass[] {com.pullenti.ner.definition.internal.MetaDefin.globalMeta});
    }
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        ...
        if (com.pullenti.morph.MorphLang.ooEq(kit.baseLanguage, com.pullenti.morph.MorphLang.EN)) {
            ...
            for (com.pullenti.ner.ExtOntologyItem it : kit.ontology.items) {
                if (it.referent instanceof DefinitionReferent) {
                    ...
                    if (!oh.containsKey(termin)) {
                        oh.put(termin, true);
                        onto.add(com.pullenti.ner.core.Termin._new1137(termin, termin));
                    }
                }
            }
        ...
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            ...
            if (com.pullenti.ner.core.MiscHelper.canBeStartOfSentence(t)) 
                ok = true;
            else if (((t.isValue("ЧТО", null) && t.getNext() != null && t.getPrevious() != null) && t.getPrevious().isComma() && t.getPrevious().getPrevious() != null) && com.pullenti.morph.MorphClass.ooEq(t.getPrevious().getPrevious().getMorph()._getClass(), com.pullenti.morph.MorphClass.VERB)) {
                ok = true;
                t = t.getNext();
                ...
                for (com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                    if (com.pullenti.ner.core.BracketHelper.canBeEndOfSequence(tt, true, t, false)) {
                        maxChar = tt.getPrevious().endChar;
                        break;
                    }
                }
            }
    ...
    public static java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttach(com.pullenti.ner.Token t, boolean glosRegime, com.pullenti.ner.core.TerminCollection onto, int maxChar, boolean thisIsDef) {
        ...
        for (; t != null; t = t.getNext()) {
            ...
            if (!((t instanceof com.pullenti.ner.TextToken))) {
                ...
                if (r != null && ((com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), "DECREE") || com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), "DECREEPART")))) {
                    _decree = r;
                    if (l0 == null) {
                        if ((t.getNext() != null && com.pullenti.morph.MorphClass.ooEq(t.getNext().getMorphClassInDictionary(), com.pullenti.morph.MorphClass.VERB) && t.getNext().getNext() != null) && t.getNext().getNext().isComma()) {
                            t = t.getNext().getNext();
                ...
                if ((t instanceof com.pullenti.ner.NumberToken) && com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0) != null) {
                }
                else 
                    break;
            }
            ...
            if (!t.chars.isLetter()) {
                ...
                if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, true, false)) {
                    com.pullenti.ner.core.BracketSequenceToken br = com.pullenti.ner.core.BracketHelper.tryParse(t, com.pullenti.ner.core.BracketParseAttr.NO, 100);
                    if (br != null && l0 == null && com.pullenti.ner.core.NounPhraseHelper.tryParse(t.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0) != null) {
                        l0 = t.getNext();
            ...
            npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.PARSEPREPOSITION, 0);
            ...
            if (npt == null) {
                ...
                if (t.getMorph()._getClass().isAdjective()) {
                    ...
                    if ((ve > 0 && tt != null && tt.isValue("ТАКОЙ", null)) && com.pullenti.ner.core.NounPhraseHelper.tryParse(tt.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0) != null) {
                        l0 = (l1 = t);
                        t = t.getNext();
                        break;
                    }
            ...
            if (npt != null) {
                ...
                boolean ok1 = true;
                if (!glosRegime) {
                    for (com.pullenti.ner.Token tt = npt.getBeginToken(); tt != null && tt.endChar <= npt.endChar; tt = tt.getNext()) {
        ...
        if (t.isHiphen() || t.isCharOf(":") || ((canNextSent && t.isChar('.')))) {
            ...
            com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t11, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
            ...
            if (isOntoTermin) 
                ...
                if ((((l0.getMorph().getGender().value()) & (npt.getMorph().getGender().value()))) != (com.pullenti.morph.MorphGender.UNDEFINED.value()) || (((l0.getMorph().getNumber().value()) & (npt.getMorph().getNumber().value()))) == (com.pullenti.morph.MorphNumber.PLURAL.value())) 
                    name0 = (l0.getNormalCaseText(com.pullenti.morph.MorphClass.ADJECTIVE, true, npt.getMorph().getGender(), false) + " " + npt.noun.getNormalCaseText(com.pullenti.morph.MorphClass.NOUN, true, npt.getMorph().getGender(), false));
                else 
                    ok = 0;
            }
        }
        ...
        if (l0 == l1 && l0.getMorph()._getClass().isAdjective() && l0.getMorph().getCase().isInstrumental()) {
            if (t != null && t.isValue("ТАКОЙ", null)) {
                com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                if (npt != null && npt.getMorph().getCase().isNominative()) {
                    String str = l0.getNormalCaseText(com.pullenti.morph.MorphClass.ADJECTIVE, npt.getMorph().getNumber() == com.pullenti.morph.MorphNumber.PLURAL, npt.getMorph().getGender(), false);
                    if (str == null) 
                        str = l0.getNormalCaseText(com.pullenti.morph.MorphClass.ADJECTIVE, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                    nam = (str + " " + npt.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false));
                }
            }
        }
        if (_decree != null) {
            for (com.pullenti.ner.Token tt = l0; tt != null && tt.endChar <= l1.endChar; tt = tt.getNext()) {
        ...
        if (!isOntoTermin) {
            com.pullenti.ner.core.NounPhraseToken npt2 = com.pullenti.ner.core.NounPhraseHelper.tryParse(l0, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
        ...
        if ((coef == DefinitionKind.UNDEFINED && ok > 1 && !isNot) && multiParts == null) {
            ...
            for (com.pullenti.ner.Token tt = l0; tt != null && tt.endChar <= l1.endChar; tt = tt.getNext()) {
                ...
                if (npt == null && tt.getMorph()._getClass().isPreposition()) 
                    npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(tt.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                if (npt == null) {
                    allNps = false;
                    break;
                }
    ...
    private java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttachEnd(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection onto, int maxChar) {
        ...
        if ((((l1.endChar - l0.endChar)) * 2) > ((r1.endChar - r0.endChar))) 
            return null;
        DefinitionReferent dr = DefinitionReferent._new1138(DefinitionKind.DEFINITION);
    ...
    private static com.pullenti.ner.MetaToken _tryAttachMiscToken(com.pullenti.ner.Token t) {
        ...
        if (t.isValue("КАК", null)) {
            ...
            if (t1 != null) {
                com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new857(t, t1, com.pullenti.ner.core.MiscHelper.getTextValue(t, t1, com.pullenti.ner.core.GetTextAttr.KEEPQUOTES));
        ...
        if (npt != null) {
            if (m_MiscFirstWords.tryParse(npt.noun.getBeginToken(), com.pullenti.ner.core.TerminParseAttr.NO) != null) {
                com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new857(t, npt.getEndToken(), npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false));
        ...
        if (t.isValue("В", null)) {
            ...
            if (npt != null) {
                if (npt.noun.isValue("СМЫСЛ", null)) {
                    com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new857(t, npt.getEndToken(), com.pullenti.ner.core.MiscHelper.getTextValue(t, npt.getEndToken(), com.pullenti.ner.core.GetTextAttr.NO));
                    res.getMorph()._setClass(com.pullenti.morph.MorphClass.NOUN);
                    return res;
                }
            }
    ...
    public static int calcSemanticCoef(String text1, String text2) {
        ...
        for (int k = 0; k < 2; k++) {
            ...
            for (com.pullenti.ner.Token t = ((k == 0 ? ar1.firstToken : ar2.firstToken)); t != null; t = t.getNext()) {
                com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                if (npt != null) {
                    String term = npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                    if (term == null) 
                        continue;
        ...
        if (ar != null) {
            for (com.pullenti.ner.Token t = ar.firstToken; t != null; t = t.getNext()) {
                ...
                for (com.pullenti.ner.Token tt = t1.getNext(); tt != null; tt = tt.getNext()) {
                    ...
                    if (tt.isAnd()) {
                        npt2 = com.pullenti.ner.core.NounPhraseHelper.tryParse(tt.getNext(), com.pullenti.ner.core.NounPhraseParseAttr.of((com.pullenti.ner.core.NounPhraseParseAttr.PARSENUMERICASADJECTIVE.value()) | (com.pullenti.ner.core.NounPhraseParseAttr.PARSEPREPOSITION.value())), 0);
                        if (npt2 != null) {
                    ...
                    npt2 = com.pullenti.ner.core.NounPhraseHelper.tryParse(tt, com.pullenti.ner.core.NounPhraseParseAttr.of((com.pullenti.ner.core.NounPhraseParseAttr.PARSENUMERICASADJECTIVE.value()) | (com.pullenti.ner.core.NounPhraseParseAttr.PARSEPREPOSITION.value())), 0);
                    if (npt2 != null) {
                ...
                for (com.pullenti.ner.Token tt = t; tt != null && tt.endChar <= t1.endChar; tt = tt.getNext()) {
                    ...
                    if (tt.isCommaAnd() || t.getMorph()._getClass().isPreposition()) 
                        continue;
                    String w = (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).getLemma();
                    if (w.length() < 3) 
                        continue;
                    if (tt.chars.isLatinLetter() && !doNormalizeForEnglish) {
                    }
                    else {
                        java.util.ArrayList<com.pullenti.morph.DerivateGroup> dg = com.pullenti.morph.Explanatory.findDerivates(w, true, null);
