...
public class DecreeReferent extends com.pullenti.ner.Referent {
    ...
    private java.util.ArrayList<Integer> _allYears() {
        ...
        for (com.pullenti.ner.Slot s : getSlots()) {
            if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), ATTR_DATE)) {
                ...
                com.pullenti.unisharp.Outargwrapper<Integer> wrapi1134 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres1135 = com.pullenti.unisharp.Utils.parseInteger(str, 0, null, wrapi1134);
                i = (wrapi1134.value != null ? wrapi1134.value : 0);
                if (inoutres1135) 
                    res.add(i);
            }
        }
    ...
    private boolean _CanBeEquals(com.pullenti.ner.Referent obj, com.pullenti.ner.Referent.EqualType _typ, boolean ignoreGeo) {
        ...
        if (this.findSlot(ATTR_GEO, null, true) != null && dr.findSlot(ATTR_GEO, null, true) != null) {
            if (com.pullenti.unisharp.Utils.stringsNe(this.getStringValue(ATTR_GEO), dr.getStringValue(ATTR_GEO))) 
                return false;
        }
        boolean srcEq = false;
    ...
    public static DecreeReferent _new1118(String _arg1) {
