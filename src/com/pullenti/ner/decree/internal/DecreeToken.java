...
public class DecreeToken extends com.pullenti.ner.MetaToken {
    ...
    public static DecreeToken tryAttach(com.pullenti.ner.Token t, DecreeToken prev, boolean mustByTyp) {
        ...
        if (res == null) {
            ...
            if (npt != null) {
                if ((npt.getEndToken().isValue("СОБРАНИЕ", null) || npt.getEndToken().isValue("УЧАСТНИК", null) || npt.getEndToken().isValue("СОБСТВЕННИК", null)) || npt.getEndToken().isValue("УЧРЕДИТЕЛЬ", null)) {
                    res = _new863(t, npt.getEndToken(), ItemType.OWNER);
                    com.pullenti.ner.core.NounPhraseToken npt2 = com.pullenti.ner.core.NounPhraseHelper.tryParse(res.getEndToken().getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
        ...
        if (res.typ == ItemType.NUMBER) {
            for (com.pullenti.ner.Token tt = res.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                ...
                if (res.children == null) 
                    res.children = new java.util.ArrayList<DecreeToken>();
                DecreeToken add = _new866(tt, tee, ItemType.NUMBER, tmp.toString());
    ...
    private static DecreeToken _TryAttach(com.pullenti.ner.Token t, DecreeToken prev, int lev, boolean mustByTyp) {
        ...
        if ((!mustByTyp && t.isValue("МЕЖДУ", "МІЖ") && (t.getNext() instanceof com.pullenti.ner.ReferentToken)) && t.getNext().getNext() != null) {
            ...
            if (t11 != null && t11.isCommaAnd() && (t11.getNext() instanceof com.pullenti.ner.ReferentToken)) {
                DecreeToken rr = _new863(t, t11.getNext(), ItemType.BETWEEN);
                rr.children = new java.util.ArrayList<DecreeToken>();
                rr.children.add(_new868(t.getNext(), t.getNext(), ItemType.OWNER, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.ReferentToken.class)));
                rr.children.add(_new868(t11.getNext(), t11.getNext(), ItemType.OWNER, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t11.getNext(), com.pullenti.ner.ReferentToken.class)));
        ...
        if (r != null && !mustByTyp) {
            if (r instanceof com.pullenti.ner.geo.GeoReferent) 
                return _new872(t, t, ItemType.TERR, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.ReferentToken.class), r.toString(true, t.kit.baseLanguage, 0));
            if (r instanceof com.pullenti.ner.date.DateReferent) {
                ...
                if (t.getPrevious() != null && t.getPrevious().getMorph()._getClass().isPreposition() && t.getPrevious().isValue("ДО", null)) 
                    return null;
                return _new868(t, t, ItemType.DATE, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.ReferentToken.class));
            }
            if (r instanceof com.pullenti.ner._org.OrganizationReferent) {
                if ((t.getNext() != null && t.getNext().isValue("В", "У") && t.getNext().getNext() != null) && t.getNext().getNext().isValue("СОСТАВ", "СКЛАДІ")) 
                    return null;
                return _new872(t, t, ItemType.ORG, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.ReferentToken.class), r.toString());
            }
            if (r instanceof com.pullenti.ner.person.PersonReferent) {
                ...
                if (ok) {
                    ...
                    if (prop != null && ((prop.getKind() == com.pullenti.ner.person.PersonPropertyKind.BOSS || (((String)com.pullenti.unisharp.Utils.notnull(prop.getName(), ""))).startsWith("глава")))) 
                        return _new868(t, t, ItemType.OWNER, new com.pullenti.ner.ReferentToken(prop, t, t, null));
                }
            }
            if (r instanceof com.pullenti.ner.person.PersonPropertyReferent) 
                return _new868(t, t, ItemType.OWNER, new com.pullenti.ner.ReferentToken(r, t, t, null));
            if (r instanceof com.pullenti.ner.denomination.DenominationReferent) {
                ...
                if (s.length() > 1 && ((s.charAt(0) == 'A' || s.charAt(0) == 'А')) && Character.isDigit(s.charAt(1))) 
                    return _new866(t, t, ItemType.NUMBER, s);
            }
            return null;
        }
        if (!mustByTyp) {
            ...
            if (tdat != null) {
                ...
                if (tdat.getReferent() instanceof com.pullenti.ner.date.DateReferent) 
                    return _new868(t, tdat, ItemType.DATE, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(tdat, com.pullenti.ner.ReferentToken.class));
                com.pullenti.ner.ReferentToken dr = t.kit.processReferent("DATE", tdat);
                if (dr != null) 
                    return _new868(t, dr.getEndToken(), ItemType.DATE, dr);
            }
            if (t.isValue("НА", null) && t.getNext() != null && (t.getNext().getReferent() instanceof com.pullenti.ner.date.DateRangeReferent)) 
                return _new868(t, t.getNext(), ItemType.DATERANGE, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.ReferentToken.class));
            if (t.isChar('(')) {
                ...
                if (tt != null) {
                    ...
                    if (br != null) 
                        return _new863(t, br.getEndToken(), ItemType.EDITION);
                }
                if (t.getNext() != null && t.getNext().isValue("ПРОЕКТ", null)) 
                    return _new866(t.getNext(), t.getNext(), ItemType.TYP, "ПРОЕКТ");
                if ((t.getNext() != null && (t.getNext().getReferent() instanceof com.pullenti.ner.date.DateRangeReferent) && t.getNext().getNext() != null) && t.getNext().getNext().isChar(')')) 
                    return _new868(t, t.getNext().getNext(), ItemType.DATERANGE, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.ReferentToken.class));
            }
            else {
                ...
                if (tt != null) {
                    ...
                    if (xxx != null) 
                        return _new863(t, tt.getPrevious(), ItemType.EDITION);
                }
            }
            if (t instanceof com.pullenti.ner.NumberToken) {
                if (prev != null && ((prev.typ == ItemType.TYP || prev.typ == ItemType.DATE))) {
                    ...
                    if (t11 != null) {
                        ...
                        if (ne != null && ((ne.typ == ItemType.DATE || ne.typ == ItemType.OWNER || ne.typ == ItemType.NAME))) 
                            return _new866(t, t11, ItemType.NUMBER, valnum);
                        ...
                        if (prev.typ == ItemType.TYP) {
                            ...
                            if (prev.typKind == com.pullenti.ner.decree.DecreeKind.STANDARD) {
                                ...
                                for (int ii = valnum.length() - 1; ii >= 0; ii--) {
                                    if (!Character.isDigit(valnum.charAt(ii))) {
                                        ...
                                        if (ss.charAt(0) == '0' && ss.length() == 2) 
                                            ...
                                            com.pullenti.unisharp.Outargwrapper<Integer> wrapnn887 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                                            boolean inoutres888 = com.pullenti.unisharp.Utils.parseInteger(ss, 0, null, wrapnn887);
                                            nn = (wrapnn887.value != null ? wrapnn887.value : 0);
                                            if (inoutres888) {
                                                if (nn > 50 && nn <= 99) 
                                                    nn += 1900;
                                ...
                                ok = true;
                            if (ok) 
                                return _new889(t, t11, ItemType.NUMBER, valnum, year);
                        }
                    }
                    if ((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getIntValue() != null) {
                        ...
                        if (val > 1910 && (val < 2030)) 
                            return _new866(t, t, ItemType.DATE, ((Integer)val).toString());
                    }
                }
                ...
                if (rt != null) {
                    ...
                    if (pr != null) 
                        return _new891(rt.getBeginToken(), rt.getEndToken(), ItemType.OWNER, rt, rt.getMorph());
                }
        ...
        if (!((t instanceof com.pullenti.ner.TextToken))) {
            if ((t instanceof com.pullenti.ner.NumberToken) && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getValue(), "100")) {
                if ((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getBeginToken().isValue("СТО", null) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getBeginToken().chars.isAllUpper()) {
                    toks = m_Termins.tryParseAll((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getBeginToken(), com.pullenti.ner.core.TerminParseAttr.NO, 0.0);
            ...
            toks = m_Termins.tryParseAll(t, com.pullenti.ner.core.TerminParseAttr.NO, 0.0);
        if (toks != null) {
            for (com.pullenti.ner.core.TerminToken tok : toks) {
                    ...
                    for (com.pullenti.ner.Token tt = t.getPrevious(); tt != null && (cou < 500); tt = tt.getPrevious(),cou++) {
                        ...
                        for (com.pullenti.ner.core.TerminToken tok1 : toks) {
                            if (dr.findSlot(com.pullenti.ner.decree.DecreeReferent.ATTR_NAME, tok1.termin.getCanonicText(), true) != null) 
                                return _new892(tok.getBeginToken(), tok.getEndToken(), (ItemType)tok1.termin.tag, tok1.termin.getCanonicText(), tok1.getMorph());
                        }
                    }
                ...
                DecreeToken res = _new893(tok.getBeginToken(), tok.getEndToken(), (ItemType)tok.termin.tag, tok.termin.getCanonicText(), tok.getMorph(), doubt);
                ...
                if (com.pullenti.unisharp.Utils.stringsEq(res.value, "КОНСТИТУЦИЯ") && tok.getEndToken().getNext() != null && tok.getEndToken().getNext().isChar('(')) {
                    com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(tok.getEndToken().getNext().getNext(), com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
        ...
        if (((t.getMorph()._getClass().isAdjective() && ((t.isValue("УКАЗАННЫЙ", "ЗАЗНАЧЕНИЙ") || t.isValue("ВЫШЕУКАЗАННЫЙ", "ВИЩЕВКАЗАНИЙ") || t.isValue("НАЗВАННЫЙ", "НАЗВАНИЙ"))))) || ((t.getMorph()._getClass().isPronoun() && (((t.isValue("ЭТОТ", "ЦЕЙ") || t.isValue("ТОТ", "ТОЙ") || t.isValue("ДАННЫЙ", "ДАНИЙ")) || t.isValue("САМЫЙ", "САМИЙ")))))) {
            ...
            if (t11 != null && t11.isValue("ЖЕ", null)) 
                t11 = t11.getNext();
            com.pullenti.ner.core.NounPhraseToken nnn = com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
            com.pullenti.ner.core.TerminToken tok;
            if ((((tok = m_Termins.tryParse(t11, com.pullenti.ner.core.TerminParseAttr.NO)))) != null) {
                if ((((tok.getMorph().getNumber().value()) & (com.pullenti.morph.MorphNumber.PLURAL.value()))) == (com.pullenti.morph.MorphNumber.UNDEFINED.value()) || ((nnn != null && nnn.getMorph().getNumber() == com.pullenti.morph.MorphNumber.SINGULAR))) {
                    com.pullenti.ner.core.NounPhraseToken npt = com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.NO, 0);
                    if (npt != null && (((npt.getMorph().getNumber().value()) & (com.pullenti.morph.MorphNumber.PLURAL.value()))) != (com.pullenti.morph.MorphNumber.UNDEFINED.value())) {
                        ...
                        if (te != null) 
                            return _new868(t, tok.getEndToken(), ItemType.DECREEREF, te);
                    }
                }
            }
        }
        if (t.getMorph()._getClass().isAdjective() && t.isValue("НАСТОЯЩИЙ", "СПРАВЖНІЙ")) {
            ...
            if ((((tok = m_Termins.tryParse(t.getNext(), com.pullenti.ner.core.TerminParseAttr.NO)))) != null) 
                return _new868(t, tok.getEndToken(), ItemType.DECREEREF, null);
        }
        if (mustByTyp) 
            return null;
        if ((((t instanceof com.pullenti.ner.TextToken) && prev != null && prev.typ == ItemType.TYP) && t.chars.isAllUpper() && t.getLengthChar() >= 2) && t.getLengthChar() <= 5) {
            if (((com.pullenti.unisharp.Utils.stringsEq(prev.value, "ТЕХНИЧЕСКИЕ УСЛОВИЯ") && t.getNext() != null && t.getNext().isChar('.')) && (t.getNext().getNext() instanceof com.pullenti.ner.NumberToken) && t.getNext().getNext().getNext() != null) && t.getNext().getNext().getNext().isChar('.') && (t.getNext().getNext().getNext().getNext() instanceof com.pullenti.ner.NumberToken)) {
                DecreeToken res = _new866(t, t, ItemType.NUMBER, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term);
                t = t.getNext().getNext();
        ...
        if ((((((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 4 && t.chars.isAllUpper()) && t.getNext() != null && !t.isWhitespaceAfter()) && t.getNext().isChar('.') && (t.getNext().getNext() instanceof com.pullenti.ner.NumberToken)) && !t.getNext().isWhitespaceAfter() && t.getNext().getNext().getNext() != null) && t.getNext().getNext().getNext().isChar('.') && (t.getNext().getNext().getNext().getNext() instanceof com.pullenti.ner.NumberToken)) {
            if (t.getNext().getNext().getNext().getNext().getNext() != null && t.getNext().getNext().getNext().getNext().getNext().isValue("ТУ", null)) {
                DecreeToken res = _new866(t, t.getNext().getNext().getNext().getNext(), ItemType.NUMBER, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term);
        ...
        if (t.getMorph()._getClass().isAdjective()) {
            ...
            if ((npt != null && dt != null && dt.typ == ItemType.TYP) && com.pullenti.unisharp.Utils.stringsEq(dt.value, "КОДЕКС")) {
                dt.value = npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                dt.setBeginToken(t);
                dt.isDoubtful = true;
                return dt;
            }
            if (npt != null && ((npt.getEndToken().isValue("ДОГОВОР", null) || npt.getEndToken().isValue("КОНТРАКТ", null)))) {
                dt = _new863(t, npt.getEndToken(), ItemType.TYP);
                dt.value = npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                if (t.getMorphClassInDictionary().isVerb()) 
                    dt.value = npt.getEndToken().getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false);
                return dt;
            }
            ...
            if (tryNpt) {
                if (npt != null) {
                    if (npt.getEndToken().isValue("ГАЗЕТА", null) || npt.getEndToken().isValue("БЮЛЛЕТЕНЬ", "БЮЛЕТЕНЬ")) 
                        return _new892(t, npt.getEndToken(), ItemType.TYP, npt.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.getMorph());
                    if (npt.adjectives.size() > 0 && npt.getEndToken().getMorphClassInDictionary().isNoun()) {
                        if ((((tok = m_Termins.tryParse(npt.getEndToken(), com.pullenti.ner.core.TerminParseAttr.NO)))) != null) {
                            if (npt.getBeginToken().isValue("ОБЩИЙ", "ЗАГАЛЬНИЙ")) 
                                return null;
                            return _new900(npt.getBeginToken(), tok.getEndToken(), npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.getMorph());
                        }
                    }
                    if (prev != null && prev.typ == ItemType.TYP) {
                        if (npt.getEndToken().isValue("КОЛЛЕГИЯ", "КОЛЕГІЯ")) {
                            DecreeToken res1 = _new892(t, npt.getEndToken(), ItemType.OWNER, npt.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.getMorph());
        ...
        if (t1 != null) {
            if ((t1.getWhitespacesBeforeCount() < 15) && ((!t1.isNewlineBefore() || (t1 instanceof com.pullenti.ner.NumberToken) || _isJusNumber(t1)))) {
                ...
                if (t11 != null) {
                    ...
                    return _new866(t0, t11, ItemType.NUMBER, tmp.toString());
                }
            }
            if (t1.isNewlineBefore() && num) 
                return _new863(t0, t1.getPrevious(), ItemType.NUMBER);
        }
        if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, false, false)) {
            if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, true, false) && ((((t.getNext().isValue("О", null) || t.getNext().isValue("ОБ", null) || t.getNext().isValue("ПРО", null)) || t.getNext().isValue("ПО", null) || t.chars.isCapitalUpper()) || ((prev != null && (t.getNext() instanceof com.pullenti.ner.TextToken) && ((prev.typ == ItemType.DATE || prev.typ == ItemType.NUMBER))))))) {
                ...
                if (br != null) {
                    ...
                    return _new866(br.getBeginToken(), br.getEndToken(), ItemType.NAME, com.pullenti.ner.core.MiscHelper.getTextValueOfMetaToken(br, com.pullenti.ner.core.GetTextAttr.NO));
                }
                else {
                    com.pullenti.ner.Token tt1 = _tryAttachStdChangeName(t.getNext());
                    if (tt1 != null) 
                        return _new866(t, tt1, ItemType.NAME, com.pullenti.ner.core.MiscHelper.getTextValue(t, tt1, com.pullenti.ner.core.GetTextAttr.NO));
                }
            }
            else if (t.isChar('(')) {
                com.pullenti.ner.core.BracketSequenceToken br = com.pullenti.ner.core.BracketHelper.tryParse(t, com.pullenti.ner.core.BracketParseAttr.NO, 100);
                if (br != null) {
                    if (!t.getNext().isValue("ДАЛЕЕ", "ДАЛІ")) {
                        if ((br.endChar - br.beginChar) < 30) 
                            return _new866(br.getBeginToken(), br.getEndToken(), ItemType.MISC, com.pullenti.ner.core.MiscHelper.getTextValueOfMetaToken(br, com.pullenti.ner.core.GetTextAttr.NO));
                    }
                }
            }
        }
        ...
        if (t.isValue("О", null) || t.isValue("ОБ", null) || t.isValue("ПРО", null)) {
            ...
            if (et != null && et.getNext() != null) {
                ...
                if (dts2 != null && dts2.get(0).typ == ItemType.TYP) {
                    ...
                    return _new866(t, et, ItemType.NAME, com.pullenti.ner.core.MiscHelper.getTextValue(t, et, com.pullenti.ner.core.GetTextAttr.NO));
                }
        ...
        if (prev != null && prev.typ == ItemType.TYP) {
            if (t.isValue("ПРАВИТЕЛЬСТВО", "УРЯД") || t.isValue("ПРЕЗИДЕНТ", null)) 
                return _new911(t, t, ItemType.OWNER, t.getMorph(), t.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false));
        }
        com.pullenti.ner.core.NounPhraseToken npt2 = com.pullenti.ner.core.NounPhraseHelper.tryParse(t, com.pullenti.ner.core.NounPhraseParseAttr.PARSEPREPOSITION, 0);
        if (npt2 != null) {
                ...
                for (com.pullenti.ner.Token tt = t; tt != null; tt = tt.getNext()) {
                    ...
                    if (npt != null) {
                        if (tmp.length() > 0) 
                            ...
                            tmp.append(npt.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false));
                        t1 = (tt = npt.getEndToken());
                    }
        ...
        if (t.isValue("ВЕСТНИК", "ВІСНИК") || t.isValue("БЮЛЛЕТЕНЬ", "БЮЛЕТЕНЬ")) {
            ...
            if (npt != null) 
                return _new866(t, npt.getEndToken(), ItemType.TYP, com.pullenti.ner.core.MiscHelper.getTextValue(t, npt.getEndToken(), com.pullenti.ner.core.GetTextAttr.FIRSTNOUNGROUPTONOMINATIVE));
            else if (t.getNext() != null && (t.getNext().getReferent() instanceof com.pullenti.ner._org.OrganizationReferent)) 
                return _new866(t, t.getNext(), ItemType.TYP, com.pullenti.ner.core.MiscHelper.getTextValue(t, t.getNext(), com.pullenti.ner.core.GetTextAttr.FIRSTNOUNGROUPTONOMINATIVE));
        }
        ...
        if ((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 1 && t.getNext() != null) {
            if ((com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "Б") && t.getNext().isCharOf("\\/") && (t.getNext().getNext() instanceof com.pullenti.ner.TextToken)) && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t.getNext().getNext(), com.pullenti.ner.TextToken.class))).term, "Н")) 
                return _new866(t, t.getNext().getNext(), ItemType.NUMBER, "Б/Н");
        }
        return null;
    }
    ...
    private static com.pullenti.ner.Token _tryAttachNumber(com.pullenti.ner.Token t, StringBuilder tmp, boolean afterNum) {
        ...
        if ((res.getNext() != null && res.getNext().isHiphen() && (res.getNext().getNext() instanceof com.pullenti.ner.NumberToken)) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(res.getNext().getNext(), com.pullenti.ner.NumberToken.class))).getIntValue() != null) {
            int min;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapmin917 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres918 = com.pullenti.unisharp.Utils.parseInteger(tmp.toString(), 0, null, wrapmin917);
            min = (wrapmin917.value != null ? wrapmin917.value : 0);
            if (inoutres918) {
            ...
            if (p0 == null) {
                ...
                if ((tt instanceof com.pullenti.ner.NumberToken) && res.get(res.size() - 1).typ == ItemType.DATE) {
                    if (tt.getPrevious() != null && tt.getPrevious().getMorph()._getClass().isPreposition()) {
                        ...
                        if (t11 != null) 
                            p0 = _new866(tt, t11, ItemType.NUMBER, tmp.toString());
                    }
                }
                if (p0 == null) 
                    break;
    ...
    public static DecreeToken tryAttachName(com.pullenti.ner.Token t, String _typ, boolean veryProbable, boolean inTitleDocRef) {
        ...
        if (t == null) 
            return null;
        com.pullenti.ner.mail.internal.MailLine li = com.pullenti.ner.mail.internal.MailLine.parse(t, 0);
        if (li != null) {
            ...
            if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, true, false)) {
                ...
                if (br != null && br.isQuoteType()) {
                    ...
                    if ((s0.length() < 10) && com.pullenti.unisharp.Utils.stringsNe(_typ, "ПРОГРАММА") && com.pullenti.unisharp.Utils.stringsNe(_typ, "ПРОГРАМА")) 
                        return null;
                    return _new866(t, t1, ItemType.NAME, s0);
                }
                ...
                if (cou > 0) {
                    if ((npt.getMorph().getCase().isInstrumental() && tt.getPrevious() != null && tt.getPrevious().getPrevious() != null) && ((tt.getPrevious().getPrevious().isValue("РАБОТА", "РОБОТА")))) {
                        ...
                        if (tt0 instanceof com.pullenti.ner.TextToken) {
                            ...
                            java.util.ArrayList<com.pullenti.morph.DerivateGroup> exps = com.pullenti.morph.Explanatory.findDerivates(norm, true, tt0.getMorph().getLanguage());
                            if (exps != null) {
                                for (com.pullenti.morph.DerivateGroup ex : exps) {
                                    if (ex.nexts != null) {
        ...
        if (com.pullenti.unisharp.Utils.isNullOrEmpty(s) || (s.length() < 10)) 
            return null;
        return _new866(t, t1, ItemType.NAME, s);
    }
    ...
    public static void initialize() {
        ...
        for (String s : m_MiscTypesUA) {
            m_Keywords.add(com.pullenti.ner.core.Termin._new922(s, com.pullenti.morph.MorphLang.UA));
        }
        com.pullenti.ner.core.Termin t = com.pullenti.ner.core.Termin._new130("ТЕХНИЧЕСКОЕ ЗАДАНИЕ", "ТЗ");
        t.addVariant("ТЕХЗАДАНИЕ", false);
        t.addAbridge("ТЕХ. ЗАДАНИЕ");
        m_Keywords.add(t);
        t = com.pullenti.ner.core.Termin._new130("ТЕХНИКО КОММЕРЧЕСКОЕ ПРЕДЛОЖЕНИЕ", "ТКП");
        t.addVariant("КОММЕРЧЕСКОЕ ПРЕДЛОЖЕНИЕ", false);
        m_Keywords.add(t);
        for (String s : m_AllTypesRU) {
            m_Termins.add(com.pullenti.ner.core.Termin._new135(s, ItemType.TYP));
            m_Keywords.add(com.pullenti.ner.core.Termin._new135(s, ItemType.TYP));
        }
        for (String s : m_AllTypesUA) {
            m_Termins.add(com.pullenti.ner.core.Termin._new136(s, ItemType.TYP, com.pullenti.morph.MorphLang.UA));
            m_Keywords.add(com.pullenti.ner.core.Termin._new136(s, ItemType.TYP, com.pullenti.morph.MorphLang.UA));
        }
        m_Termins.add(com.pullenti.ner.core.Termin._new135("ОТРАСЛЕВОЕ СОГЛАШЕНИЕ", ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new472("ГАЛУЗЕВА УГОДА", com.pullenti.morph.MorphLang.UA, ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new135("МЕЖОТРАСЛЕВОЕ СОГЛАШЕНИЕ", ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new472("МІЖГАЛУЗЕВА УГОДА", com.pullenti.morph.MorphLang.UA, ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new137("ОСНОВЫ ЗАКОНОДАТЕЛЬСТВА", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX));
        m_Termins.add(com.pullenti.ner.core.Termin._new934("ОСНОВИ ЗАКОНОДАВСТВА", com.pullenti.morph.MorphLang.UA, ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX));
        m_Termins.add(com.pullenti.ner.core.Termin._new137("ОСНОВЫ ГРАЖДАНСКОГО ЗАКОНОДАТЕЛЬСТВА", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX));
        m_Termins.add(com.pullenti.ner.core.Termin._new934("ОСНОВИ ЦИВІЛЬНОГО ЗАКОНОДАВСТВА", com.pullenti.morph.MorphLang.UA, ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX));
        t = com.pullenti.ner.core.Termin._new161("ФЕДЕРАЛЬНЫЙ ЗАКОН", ItemType.TYP, "ФЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ФЕДЕРАЛЬНИЙ ЗАКОН", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ФЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ПРОЕКТ ЗАКОНА", ItemType.TYP);
        t.addVariant("ЗАКОНОПРОЕКТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ПАСПОРТ ПРОЕКТА", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new472("ПРОЕКТ ЗАКОНУ", com.pullenti.morph.MorphLang.UA, ItemType.TYP);
        t.addVariant("ЗАКОНОПРОЕКТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new472("ПАСПОРТ ПРОЕКТУ", com.pullenti.morph.MorphLang.UA, ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new159("ГОСУДАРСТВЕННАЯ ПРОГРАММА", "ПРОГРАММА", ItemType.TYP);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new944("ДЕРЖАВНА ПРОГРАМА", "ПРОГРАМА", com.pullenti.morph.MorphLang.UA, ItemType.TYP);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new161("ФЕДЕРАЛЬНЫЙ КОНСТИТУЦИОННЫЙ ЗАКОН", ItemType.TYP, "ФКЗ");
        t.addVariant("КОНСТИТУЦИОННЫЙ ЗАКОН", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ФЕДЕРАЛЬНИЙ КОНСТИТУЦІЙНИЙ ЗАКОН", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ФКЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("УГОЛОВНЫЙ КОДЕКС", ItemType.TYP, "УК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("КРИМИНАЛЬНЫЙ КОДЕКС", ItemType.TYP, "КК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("КРИМІНАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("УГОЛОВНО-ПРОЦЕССУАЛЬНЫЙ КОДЕКС", ItemType.TYP, "УПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("КРИМІНАЛЬНО-ПРОЦЕСУАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("УГОЛОВНО-ИСПОЛНИТЕЛЬНЫЙ КОДЕКС", ItemType.TYP, "УИК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("КРИМІНАЛЬНО-ВИКОНАВЧИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КВК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ГРАЖДАНСКИЙ КОДЕКС", ItemType.TYP, "ГК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ЦИВІЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЦК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ГРАЖДАНСКИЙ ПРОЦЕССУАЛЬНЫЙ КОДЕКС", ItemType.TYP, "ГПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ЦИВІЛЬНИЙ ПРОЦЕСУАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЦПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ГРАДОСТРОИТЕЛЬНЫЙ КОДЕКС", ItemType.TYP, "ГРК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("МІСТОБУДІВНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "МБК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ХОЗЯЙСТВЕННЫЙ КОДЕКС", ItemType.TYP, "ХК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ГОСПОДАРСЬКИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ГК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ХОЗЯЙСТВЕННЫЙ ПРОЦЕССУАЛЬНЫЙ КОДЕКС", ItemType.TYP, "ХПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ГОСПОДАРСЬКИЙ ПРОЦЕСУАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ГПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("АРБИТРАЖНЫЙ ПРОЦЕССУАЛЬНЫЙ КОДЕКС", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX);
        t.addAbridge("АПК");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new934("АРБІТРАЖНИЙ ПРОЦЕСУАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX);
        t.addAbridge("АПК");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("КОДЕКС ВНУТРЕННЕГО ВОДНОГО ТРАНСПОРТА", ItemType.TYP, "КВВТ", com.pullenti.ner.decree.DecreeKind.KODEX);
        t.addVariant("КВ ВТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ТРУДОВОЙ КОДЕКС", ItemType.TYP, "ТК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ТРУДОВИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ТК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("КОДЕКС ЗАКОНОВ О ТРУДЕ", "КЗОТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("КОДЕКС ЗАКОНІВ ПРО ПРАЦЮ", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КЗПП", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ЖИЛИЩНЫЙ КОДЕКС", ItemType.TYP, "ЖК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ЖИТЛОВИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЖК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ЗЕМЕЛЬНЫЙ КОДЕКС", ItemType.TYP, "ЗК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ЗЕМЕЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЗК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ЛЕСНОЙ КОДЕКС", ItemType.TYP, "ЛК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ЛІСОВИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЛК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("БЮДЖЕТНЫЙ КОДЕКС", ItemType.TYP, "БК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("БЮДЖЕТНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "БК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("НАЛОГОВЫЙ КОДЕКС", ItemType.TYP, "НК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ПОДАТКОВИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("СЕМЕЙНЫЙ КОДЕКС", ItemType.TYP, "СК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("СІМЕЙНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "СК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ВОДНЫЙ КОДЕКС", ItemType.TYP, "ВК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ВОДНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ВК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ВОЗДУШНЫЙ КОДЕКС", ItemType.TYP, "ВК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ПОВІТРЯНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("КОДЕКС ОБ АДМИНИСТРАТИВНЫХ ПРАВОНАРУШЕНИЯХ", ItemType.TYP, "КОАП", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("КОДЕКС ПРО АДМІНІСТРАТИВНІ ПРАВОПОРУШЕННЯ", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КОАП", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ОБ АДМИНИСТРАТИВНЫХ ПРАВОНАРУШЕНИЯХ", ItemType.STDNAME);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new472("ПРО АДМІНІСТРАТИВНІ ПРАВОПОРУШЕННЯ", com.pullenti.morph.MorphLang.UA, ItemType.STDNAME);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("КОДЕКС ОБ АДМИНИСТРАТИВНЫХ ПРАВОНАРУШЕНИЯХ", ItemType.TYP, "КРКОАП", com.pullenti.ner.decree.DecreeKind.KODEX);
        t.addVariant("КРК ОБ АП", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("КОДЕКС АДМИНИСТРАТИВНОГО СУДОПРОИЗВОДСТВА", ItemType.TYP, "КАС", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("КОДЕКС АДМІНІСТРАТИВНОГО СУДОЧИНСТВА", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КАС", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ТАМОЖЕННЫЙ КОДЕКС", ItemType.TYP, "ТК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("МИТНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "МК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("КОДЕКС ТОРГОВОГО МОРЕПЛАВАНИЯ", ItemType.TYP, "КТМ", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("КОДЕКС ТОРГОВЕЛЬНОГО МОРЕПЛАВСТВА", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КТМ", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new947("ПРАВИЛА ДОРОЖНОГО ДВИЖЕНИЯ", ItemType.TYP, "ПДД", "ПРАВИЛА");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new949("ПРАВИЛА ДОРОЖНЬОГО РУХУ", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ПДР", "ПРАВИЛА");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("СОБРАНИЕ ЗАКОНОДАТЕЛЬСТВА", ItemType.TYP);
        t.addAbridge("СЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ОФИЦИАЛЬНЫЙ ВЕСТНИК", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new472("ОФІЦІЙНИЙ ВІСНИК", com.pullenti.morph.MorphLang.UA, ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("СВОД ЗАКОНОВ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("БЮЛЛЕТЕНЬ НОРМАТИВНЫХ АКТОВ ФЕДЕРАЛЬНЫХ ОРГАНОВ ИСПОЛНИТЕЛЬНОЙ ВЛАСТИ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("БЮЛЛЕТЕНЬ МЕЖДУНАРОДНЫХ ДОГОВОРОВ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("БЮЛЛЕТЕНЬ ВЕРХОВНОГО СУДА", ItemType.TYP);
        t.addVariant("БЮЛЛЕТЕНЬ ВС", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ВЕСТНИК ВЫСШЕГО АРБИТРАЖНОГО СУДА", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ВЕСТНИК БАНКА РОССИИ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("РОССИЙСКАЯ ГАЗЕТА", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("РОССИЙСКИЕ ВЕСТИ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("СОБРАНИЕ АКТОВ ПРЕЗИДЕНТА И ПРАВИТЕЛЬСТВА", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ВЕДОМОСТИ ВЕРХОВНОГО СОВЕТА", ItemType.TYP);
        t.addVariant("ВЕДОМОСТИ ВС", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ВЕДОМОСТИ СЪЕЗДА НАРОДНЫХ ДЕПУТАТОВ И ВЕРХОВНОГО СОВЕТА", ItemType.TYP);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("БЮЛЛЕТЕНЬ НОРМАТИВНЫХ АКТОВ МИНИСТЕРСТВ И ВЕДОМСТВ", ItemType.TYP);
        m_Termins.add(t);
        m_Termins.add(com.pullenti.ner.core.Termin._new135("СВОД ЗАКОНОВ", ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new135("ВЕДОМОСТИ", ItemType.TYP));
        t = com.pullenti.ner.core.Termin._new159("ЗАРЕГИСТРИРОВАТЬ", "РЕГИСТРАЦИЯ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new1018("ЗАРЕЄСТРУВАТИ", com.pullenti.morph.MorphLang.UA, "РЕЄСТРАЦІЯ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("СТАНДАРТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("МЕЖДУНАРОДНЫЙ СТАНДАРТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new161("ЕДИНЫЙ ОТРАСЛЕВОЙ СТАНДАРТ ЗАКУПОК", ItemType.TYP, "ЕОСЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ЕДИНЫЙ ОТРАСЛЕВОЙ ПОРЯДОК", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("ГОСТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("ОСТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ОТРАСЛЕВОЙ СТАНДАРТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("ПНСТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ПРЕДВАРИТЕЛЬНЫЙ НАЦИОНАЛЬНЫЙ СТАНДАРТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("РСТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("РЕСПУБЛИКАНСКИЙ СТАНДАРТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("ПБУ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ПОЛОЖЕНИЕ ПО БУХГАЛТЕРСКОМУ УЧЕТУ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("ISO", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ИСО", false);
        t.addVariant("ISO/IEC", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ТЕХНИЧЕСКИЕ УСЛОВИЯ", "ТУ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ТЕХУСЛОВИЯ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ФЕДЕРАЛЬНЫЕ НОРМЫ И ПРАВИЛА", "ФНП", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("НОРМАТИВНЫЕ ПРАВИЛА", "НП", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("СТРОИТЕЛЬНЫЕ НОРМЫ И ПРАВИЛА", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("СНИП", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("СТРОИТЕЛЬНЫЕ НОРМЫ", "СН", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("CH", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ВЕДОМСТВЕННЫЕ СТРОИТЕЛЬНЫЕ НОРМЫ", "ВСН", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("BCH", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("РЕСПУБЛИКАНСКИЕ СТРОИТЕЛЬНЫЕ НОРМЫ", "РСН", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("PCH", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ПРАВИЛА БЕЗОПАСНОСТИ", "ПБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("НОРМЫ РАДИАЦИОННОЙ БЕЗОПАСНОСТИ", "НРБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ПРАВИЛА РАДИАЦИОННОЙ БЕЗОПАСНОСТИ", "ПРБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("НОРМЫ ПОЖАРНОЙ БЕЗОПАСНОСТИ", "НПБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ПРАВИЛА ПОЖАРНОЙ БЕЗОПАСНОСТИ", "ППБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("СТРОИТЕЛЬНЫЕ ПРАВИЛА", "СП", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("МОСКОВСКИЕ ГОРОДСКИЕ СТРОИТЕЛЬНЫЕ НОРМЫ", "МГСН", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("АВОК", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ABOK", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ТЕХНИЧЕСКИЙ РЕГЛАМЕНТ", "ТР", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ОБЩИЕ ПРАВИЛА БЕЗОПАСНОСТИ", "ОПБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ПРАВИЛА ЯДЕРНОЙ БЕЗОПАСНОСТИ", "ПБЯ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("СТАНДАРТ ОРГАНИЗАЦИИ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("СТО", false);
        t.addVariant("STO", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ПРАВИЛА ПО ОХРАНЕ ТРУДА", "ПОТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ПРАВИЛА ОХРАНЫ ТРУДА", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("ИНСТРУКЦИЯ ПО ОХРАНЕ ТРУДА", "ИОТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ИНСТРУКЦИЯ ОХРАНЫ ТРУДА", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new969("РУКОВОДЯЩИЙ ДОКУМЕНТ", "РД", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new137("САНИТАРНЫЕ НОРМЫ И ПРАВИЛА", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("САНПИН", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new161("ТЕХНИЧЕСКОЕ ЗАДАНИЕ", ItemType.TYP, "ТЗ");
        t.addVariant("ТЕХЗАДАНИЕ", false);
        t.addAbridge("ТЕХ. ЗАДАНИЕ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new130("ТЕХНИКО КОММЕРЧЕСКОЕ ПРЕДЛОЖЕНИЕ", "ТКП");
    ...
    public static com.pullenti.ner.Token isKeyword(com.pullenti.ner.Token t, boolean isMiscTypeOnly) {
        ...
        if (npt == null || npt.getBeginToken() == npt.getEndToken()) {
            if (t.isValue("НАСТОЯЩИЙ", "СПРАВЖНІЙ") || t.isValue("НАЗВАННЫЙ", "НАЗВАНИЙ") || t.isValue("ДАННЫЙ", "ДАНИЙ")) {
    ...
    public static void addNewType(String _typ, String acronym) {
        com.pullenti.ner.core.Termin t = com.pullenti.ner.core.Termin._new161(_typ, ItemType.TYP, acronym);
        m_Termins.add(t);
        m_Keywords.add(com.pullenti.ner.core.Termin._new135(_typ, ItemType.TYP));
    }
    ...
    public static DecreeToken _new863(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static DecreeToken _new866(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    ...
    public static DecreeToken _new868(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.ReferentToken _arg4) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        return res;
    ...
    public static DecreeToken _new872(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.ReferentToken _arg4, String _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        res.value = _arg5;
    ...
    public static DecreeToken _new889(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, int _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.numYear = _arg5;
    ...
    public static DecreeToken _new891(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.ReferentToken _arg4, com.pullenti.ner.MorphCollection _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        res.setMorph(_arg5);
    ...
    public static DecreeToken _new892(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.setMorph(_arg5);
    ...
    public static DecreeToken _new893(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5, boolean _arg6) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.setMorph(_arg5);
    ...
    public static DecreeToken _new900(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.MorphCollection _arg4) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.value = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static DecreeToken _new911(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.MorphCollection _arg4, String _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        res.value = _arg5;
