...
public class BookLinkAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.Collection<com.pullenti.ner.ReferentClass> getTypeSystem() {
        return java.util.Arrays.asList(new com.pullenti.ner.ReferentClass[] {com.pullenti.ner.booklink.internal.MetaBookLink.globalMeta, com.pullenti.ner.booklink.internal.MetaBookLinkRef.globalMeta});
    }
    ...
    public java.util.HashMap<String, byte[]> getImages() {
        ...
        res.put(com.pullenti.ner.booklink.internal.MetaBookLink.IMAGEID, com.pullenti.ner.core.internal.ResourceHelper.getBytes("booklink.png"));
        res.put(com.pullenti.ner.booklink.internal.MetaBookLinkRef.IMAGEID, com.pullenti.ner.core.internal.ResourceHelper.getBytes("booklinkref.png"));
        res.put(com.pullenti.ner.booklink.internal.MetaBookLinkRef.IMAGEIDINLINE, com.pullenti.ner.core.internal.ResourceHelper.getBytes("booklinkrefinline.png"));
        res.put(com.pullenti.ner.booklink.internal.MetaBookLinkRef.IMAGEIDLAST, com.pullenti.ner.core.internal.ResourceHelper.getBytes("booklinkreflast.png"));
        return res;
    }
        ...
        try {
            ...
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                if (t.isChar('(')) {
                    ...
                    if (br != null && br.getLengthChar() > 70 && (br.getLengthChar() < 400)) {
                        if (br.isNewlineAfter() || ((br.getEndToken().getNext() != null && br.getEndToken().getNext().isCharOf(".;")))) {
                            rts = tryParse(t.getNext(), false, br.endChar);
                            if (rts != null && rts.size() >= 1) {
                                if (rts.size() > 1) {
                                    ...
                                    if (rts.get(0).beginChar == rts.get(1).beginChar) 
                                        rts.get(0).setBeginToken(rts.get(1));
                                    if (rts.get(0).endChar == rts.get(1).endChar) 
                ...
                if (re.getNumber() != null) {
                    ...
                    com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>> wrapli402 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>>();
                    boolean inoutres403 = com.pullenti.unisharp.Utils.tryGetValue(refsByNum, re.getNumber(), wrapli402);
                    li = wrapli402.value;
                    if (!inoutres403) 
            ...
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                ...
                java.util.ArrayList<BookLinkRefReferent> li;
                com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>> wrapli404 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>>();
                boolean inoutres405 = com.pullenti.unisharp.Utils.tryGetValue(refsByNum, (String)com.pullenti.unisharp.Utils.notnull(re.getNumber(), ""), wrapli404);
                li = wrapli404.value;
                if (!inoutres405) 
                    continue;
                int i;
                for (i = 0; i < li.size(); i++) {
                    if (t.beginChar < li.get(i).getOccurrence().get(0).beginChar) 
                        break;
                }
                if (i >= li.size()) 
                    continue;
    ...
    private static java.util.ArrayList<com.pullenti.ner.ReferentToken> tryParse(com.pullenti.ner.Token t, boolean isInLit, int maxChar) throws NumberFormatException {
        ...
        String nextNum = null;
        int nn;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapnn410 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres411 = com.pullenti.unisharp.Utils.parseInteger((num != null ? num : ""), 0, null, wrapnn410);
        nn = (wrapnn410.value != null ? wrapnn410.value : 0);
        if (inoutres411) 
        ...
        for (; t != null; t = t.getNext()) {
            ...
            if (tit != null) {
                if ((tit.typ == com.pullenti.ner.titlepage.internal.TitleItemToken.Types.TYP && tn0 == t && br == null) && com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(tit.getEndToken().getNext(), true, false)) {
            ...
            if (t.isCharOf(".;") && t.getWhitespacesAfterCount() > 0) {
                if ((((tit = com.pullenti.ner.titlepage.internal.TitleItemToken.tryAttach(t.getNext())))) != null) {
                    if (tit.typ == com.pullenti.ner.titlepage.internal.TitleItemToken.Types.TYP) 
                        break;
                }
                boolean stop = true;
                int words = 0;
                ...
                if (br != null && br.getEndToken().getPrevious().endChar > t.endChar) 
                    stop = false;
                if (stop) 
                    break;
            }
        ...
        if (tn1 == null && startOfName == null) {
            if (isElectrRes) {
                ...
                BookLinkRefReferent bref0 = BookLinkRefReferent._new406(uriRe);
                if (num != null) 
                    bref0.setNumber(num);
            ...
            if (decree != null && num != null) {
                java.util.ArrayList<com.pullenti.ner.ReferentToken> rts0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                BookLinkRefReferent bref0 = BookLinkRefReferent._new406(decree.getReferent());
                if (num != null) 
                    bref0.setNumber(num);
            ...
            if (bookPrev != null) {
                ...
                if (blt0 != null && blt0.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.PAGERANGE) {
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> rts0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                    BookLinkRefReferent bref0 = BookLinkRefReferent._new406(bookPrev);
                    if (num != null) 
                        bref0.setNumber(num);
        ...
        for (; tn1 != null && tn1.beginChar > tn0.beginChar; tn1 = tn1.getPrevious()) {
        ...
        for (com.pullenti.ner.Token tt = lt0; tt != null && tt.endChar <= lt1.endChar; tt = tt.getNext()) {
        ...
        if (com.pullenti.unisharp.Utils.stringsEq(res.getLang(), "EN")) {
            for (com.pullenti.ner.Token tt = tn0.getNext(); tt != null && (tt.endChar < tn1.endChar); tt = tt.getNext()) {
        ...
        for (com.pullenti.ner.ReferentToken rr : corrAuthors) {
            java.util.ArrayList<com.pullenti.ner.person.internal.PersonItemToken> pits0 = com.pullenti.ner.person.internal.PersonItemToken.tryAttachList(rr.getBeginToken(), null, com.pullenti.ner.person.internal.PersonItemToken.ParseAttr.CANINITIALBEDIGIT, 10);
        ...
        BookLinkRefReferent bref = BookLinkRefReferent._new406(res);
        if (num != null) 
            bref.setNumber(num);
    ...
    public static void initialize() throws Exception {
        com.pullenti.ner.booklink.internal.MetaBookLink.initialize2();
    ...
    static {
        _globalInstance = new BookLinkAnalyzer(); 
    }
}
