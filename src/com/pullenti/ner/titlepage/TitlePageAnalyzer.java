...
public class TitlePageAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.Collection<com.pullenti.ner.ReferentClass> getTypeSystem() {
        return java.util.Arrays.asList(new com.pullenti.ner.ReferentClass[] {com.pullenti.ner.titlepage.internal.MetaTitleInfo.globalMeta});
    }
    ...
    public com.pullenti.ner.ReferentToken processReferent1(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        ...
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Token> wrapet2715 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Token>();
        TitlePageReferent tpr = _process(begin, (end == null ? 0 : end.endChar), begin.kit, wrapet2715);
        et = wrapet2715.value;
        if (tpr == null) 
            return null;
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        ...
        com.pullenti.ner.Token et;
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Token> wrapet2716 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Token>();
        TitlePageReferent tpr = _process(kit.firstToken, 0, kit, wrapet2716);
        et = wrapet2716.value;
        if (tpr != null) 
    ...
    public static TitlePageReferent _process(com.pullenti.ner.Token begin, int maxCharPos, com.pullenti.ner.core.AnalysisKit kit, com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Token> endToken) {
        ...
        int endChar = (cou > 0 ? lines.get(cou - 1).endChar : 0);
        ...
        if (term != null && kit != null) {
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                com.pullenti.ner.core.TerminToken tok = term.tryParse(t, com.pullenti.ner.core.TerminParseAttr.NO, 0.0);
                if (tok == null) 
                    continue;
        ...
        for (com.pullenti.ner.Token t = begin; t != null; t = t.getNext()) {
            ...
            if (tpt != null) {
                ...
                if (tpt.typ == com.pullenti.ner.titlepage.internal.TitleItemToken.Types.TYP) {
                    ...
                    persTyp = tpt.typ;
                t = tpt.getEndToken();
                if (t.endChar > endToken.value.endChar) 
                    endToken.value = t;
            ...
            for (com.pullenti.ner.Referent r : rli) {
                        ...
                        for (com.pullenti.ner.Token tt = t.getNext(); tt != null; tt = tt.getNext()) {
                            ...
                            if (tpt != null) {
                                if (tpt.typ != com.pullenti.ner.titlepage.internal.TitleItemToken.Types.TYP && tpt.typ != com.pullenti.ner.titlepage.internal.TitleItemToken.Types.TYPANDTHEME) 
                                    break;
                                tt = tpt.getEndToken();
                                if (tt.endChar > endToken.value.endChar) 
                                    endToken.value = tt;
                                continue;
                            }
                        }
                ...
                if (r instanceof com.pullenti.ner._org.OrganizationReferent) {
                    ...
                    if (__org.getTypes().contains("курс") && __org.getNumber() != null) {
                        int i;
                        com.pullenti.unisharp.Outargwrapper<Integer> wrapi2717 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                        boolean inoutres2718 = com.pullenti.unisharp.Utils.parseInteger(__org.getNumber(), 0, null, wrapi2717);
                        i = (wrapi2717.value != null ? wrapi2717.value : 0);
                        if (inoutres2718) {
                            if (i > 0 && (i < 8)) 
        ...
        if (res.getDate() == null) {
            for (com.pullenti.ner.Token t = begin; t != null && t.endChar <= endChar; t = t.getNext()) {
                ...
                com.pullenti.ner.ReferentToken rt = t.kit.processReferent(com.pullenti.ner.date.DateAnalyzer.ANALYZER_NAME, t.getNext());
                if (rt != null) {
