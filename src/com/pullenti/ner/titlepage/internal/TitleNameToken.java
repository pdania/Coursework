...
public class TitleNameToken extends com.pullenti.ner.MetaToken {
    ...
    private boolean calcRankAndValue(int minNewlinesCount) {
        ...
        for (com.pullenti.ner.Token t = getBeginToken(); t != getEndToken().getNext() && t != null && t.endChar <= getEndToken().endChar; t = t.getNext()) {
            ...
            if (bst != null && bst.isQuoteType() && bst.getEndToken().endChar <= getEndToken().endChar) {
                if (words == 0) {
            ...
            com.pullenti.ner.person.internal.PersonAttrToken pat = com.pullenti.ner.person.internal.PersonAttrToken.tryAttach(t, null, com.pullenti.ner.person.internal.PersonAttrToken.PersonAttrAttachAttrs.NO);
            if (pat != null) {
                if (t.isNewlineBefore()) {
            ...
            com.pullenti.ner._org.internal.OrgItemTypeToken oitt = com.pullenti.ner._org.internal.OrgItemTypeToken.tryAttach(t, true, null);
            if (oitt != null) {
