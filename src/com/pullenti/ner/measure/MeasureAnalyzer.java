...
public class MeasureAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public java.util.Collection<com.pullenti.ner.ReferentClass> getTypeSystem() {
        return java.util.Arrays.asList(new com.pullenti.ner.ReferentClass[] {com.pullenti.ner.measure.internal.MeasureMeta.GLOBALMETA, com.pullenti.ner.measure.internal.UnitMeta.GLOBALMETA});
    }
            ...
            for (com.pullenti.ner.ExtOntologyItem r : kit.ontology.items) {
                ...
                for (com.pullenti.ner.Slot s : uu.getSlots()) {
                    if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), UnitReferent.ATTR_NAME) || com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), UnitReferent.ATTR_FULLNAME)) 
                        addunits.add(com.pullenti.ner.core.Termin._new135((String)com.pullenti.unisharp.Utils.cast(s.getValue(), String.class), uu));
                }
            }
        }
