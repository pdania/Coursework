    ...
    public java.util.ArrayList<Double> getDoubleValues() {
        ...
        for (com.pullenti.ner.Slot s : getSlots()) {
            if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), ATTR_VALUE) && (s.getValue() instanceof String)) {
                double d;
                com.pullenti.unisharp.Outargwrapper<Double> wrapd1757 = new com.pullenti.unisharp.Outargwrapper<Double>();
                boolean inoutres1758 = com.pullenti.ner.measure.internal.MeasureHelper.tryParseDouble((String)com.pullenti.unisharp.Utils.cast(s.getValue(), String.class), wrapd1757);
                d = (wrapd1757.value != null ? wrapd1757.value : 0);
                if (inoutres1758) 
                    res.add(d);
            }
        }
