...
public class UnitToken extends com.pullenti.ner.MetaToken {
    ...
    public String toString() {
        ...
        if (isDoubt) 
            res += "?";
        if (keyword != null) 
            res = (res + " (<-" + keyword.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false) + ")");
        return res;
    }
    ...
    public com.pullenti.ner.measure.UnitReferent createReferentWithRegister(com.pullenti.ner.core.AnalyzerData ad) {
        ...
        for (int i = owns.size() - 1; i >= 0; i--) {
            ...
            if (i > 0) {
                ...
                if ((((Unit)com.pullenti.unisharp.Utils.cast(owns.get(i - 1).getTag(), Unit.class))).baseMultiplier != 0) 
                    owns.get(i - 1).addSlot(com.pullenti.ner.measure.UnitReferent.ATTR_BASEFACTOR, com.pullenti.ner.core.NumberHelper.doubleToString((((Unit)com.pullenti.unisharp.Utils.cast(owns.get(i - 1).getTag(), Unit.class))).baseMultiplier), false, 0);
            }
        }
        return owns.get(0);
    }
    ...
    public static UnitToken tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection addUnits, UnitToken prev, boolean parseUnknownUnits) {
        ...
        java.util.ArrayList<com.pullenti.ner.core.TerminToken> toks = UnitsHelper.TERMINS.tryParseAll(tt, com.pullenti.ner.core.TerminParseAttr.NO, 0.0);
        if (toks != null) {
            ...
            if (toks.get(0).getBeginToken() == toks.get(0).getEndToken() && tt.getMorph()._getClass().isPreposition() && (tt.getWhitespacesAfterCount() < 3)) {
                if (com.pullenti.ner.core.NounPhraseHelper.tryParse(tt, com.pullenti.ner.core.NounPhraseParseAttr.PARSEPREPOSITION, 0) != null) 
                    return null;
            ...
            if (toks.get(0).getBeginToken() == toks.get(0).getEndToken() && ((toks.get(0).getBeginToken().isValue("М", null) || toks.get(0).getBeginToken().isValue("M", null))) && toks.get(0).getBeginToken().chars.isAllLower()) {
                if (prev != null && prev.unit != null && prev.unit.kind == com.pullenti.ner.measure.MeasureKind.LENGTH) {
                    UnitToken res = _new1639(t0, toks.get(0).getEndToken(), UnitsHelper.UMINUTE);
                    res.pow = _pow;
                    if (isNeg) 
                        res.pow = -_pow;
                    return res;
            ...
            for (com.pullenti.ner.core.TerminToken tok : toks) {
                UnitToken res = _new1639(t0, tok.getEndToken(), (Unit)com.pullenti.unisharp.Utils.cast(tok.termin.tag, Unit.class));
                res.pow = _pow;
                if (isNeg) 
                    res.pow = -_pow;
        ...
        if (t1 != null) {
            UnitToken res = _new1639(t0, t1, UnitsHelper.UGRADUS);
            res._checkDoubt();
            t = t1.getNext();
            if (t != null && t.isComma()) 
                t = t.getNext();
        ...
        if ((t instanceof com.pullenti.ner.TextToken) && ((t.isValue("ОС", null) || t.isValue("OC", null)))) {
            ...
            if (com.pullenti.unisharp.Utils.stringsEq(str, "оС") || com.pullenti.unisharp.Utils.stringsEq(str, "oC")) {
                UnitToken res = _new1751(t, t, UnitsHelper.UGRADUSC, false);
                return res;
            }
        }
        if (t.isChar('%')) {
            ...
            if (tt1 != null && tt1.isChar('(')) 
                tt1 = tt1.getNext();
            if ((tt1 instanceof com.pullenti.ner.TextToken) && (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt1, com.pullenti.ner.TextToken.class))).term.startsWith("ОБ")) {
                UnitToken re = _new1639(t, tt1, UnitsHelper.UALCO);
            ...
            return _new1639(t, t, UnitsHelper.UPERCENT);
        }
        if (addUnits != null) {
            com.pullenti.ner.core.TerminToken tok = addUnits.tryParse(t, com.pullenti.ner.core.TerminParseAttr.NO);
            if (tok != null) {
                UnitToken res = _new1754(t0, tok.getEndToken(), (com.pullenti.ner.measure.UnitReferent)com.pullenti.unisharp.Utils.cast(tok.termin.tag, com.pullenti.ner.measure.UnitReferent.class));
        ...
        if (mc.isUndefined()) {
            ...
            return null;
        UnitToken res1 = _new1755(t0, t1, _pow, true);
    ...
    private void _checkDoubt() {
        ...
        if (pow != 1) 
            return;
        if (getBeginToken().getLengthChar() < 3) {
            isDoubt = true;
    ...
    public static UnitToken _new1639(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Unit _arg3) {
        UnitToken res = new UnitToken(_arg1, _arg2);
        res.unit = _arg3;
        return res;
    }

    public static UnitToken _new1751(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Unit _arg3, boolean _arg4) {
        UnitToken res = new UnitToken(_arg1, _arg2);
        res.unit = _arg3;
        res.isDoubt = _arg4;
        return res;
    ...
    public static UnitToken _new1754(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.measure.UnitReferent _arg3) {
        UnitToken res = new UnitToken(_arg1, _arg2);
        res.extOnto = _arg3;
        return res;
    }

    public static UnitToken _new1755(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, int _arg3, boolean _arg4) {
        UnitToken res = new UnitToken(_arg1, _arg2);
        res.pow = _arg3;
        res.isDoubt = _arg4;
        return res;
