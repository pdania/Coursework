...
public class NumbersWithUnitToken extends com.pullenti.ner.MetaToken {
    ...
    public static java.util.ArrayList<NumbersWithUnitToken> tryParseMulti(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection addUnits, boolean canOmitNumber, boolean _not, boolean canBeNon, boolean isResctriction) {
        ...
        if (tt0.isChar('(')) {
            ...
            if (whd != null) 
                tt0 = whd.getEndToken();
            java.util.ArrayList<NumbersWithUnitToken> res0 = tryParseMulti(tt0.getNext(), addUnits, false, canOmitNumber, canBeNon, false);
            if (res0 != null) {
                res0.get(0).wHL = whd;
        ...
        NumbersWithUnitToken mt = tryParse(t, addUnits, canOmitNumber, _not, canBeNon, isResctriction);
        if (mt == null) 
            return null;
        ...
        if (nnn != null) {
            NumbersWithUnitToken mt2 = NumbersWithUnitToken.tryParse(nnn, addUnits, _not, false, false, false);
            if (mt2 != null) {
        ...
        if ((!mt.isWhitespaceAfter() && MeasureHelper.isMultCharEnd(mt.getEndToken().getNext()) && (mt.getEndToken().getNext().getNext() instanceof com.pullenti.ner.NumberToken)) && mt.units.size() == 0) {
            ...
            if (terms != null && terms.size() > 0) {
                mt.units.add(UnitToken._new1639(mt.getEndToken().getNext(), mt.getEndToken().getNext(), (Unit)com.pullenti.unisharp.Utils.cast(terms.get(0).tag, Unit.class)));
                mt.setEndToken(mt.getEndToken().getNext());
                java.util.ArrayList<NumbersWithUnitToken> res1 = tryParseMulti(mt.getEndToken().getNext(), addUnits, false, false, false, false);
                if (res1 != null) {
                    res1.add(0, mt);
                    return res1;
                }
     ...
     * @return 
     */
    public static NumbersWithUnitToken tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection addUnits, boolean canOmitNumber, boolean _not, boolean canBeNan, boolean isResctriction) {
        if (t == null) 
            return null;
    ...
    public static NumbersWithUnitToken _tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection addUnits, boolean second, boolean canOmitNumber, boolean canBeNan) {
        ...
        int minMax = 0;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapminMax1646 = new com.pullenti.unisharp.Outargwrapper<Integer>(minMax);
        com.pullenti.ner.Token ttt = _isMinOrMax(t, wrapminMax1646);
        minMax = (wrapminMax1646.value != null ? wrapminMax1646.value : 0);
        if (ttt != null) {
            t = ttt.getNext();
            if (t == null) 
                return null;
        ...
        if (t.isValue("В", null) && t.getNext() != null) {
            if (t.getNext().isValue("ПРЕДЕЛ", null) || t.isValue("ДИАПАЗОН", null)) {
                t = t.getNext().getNext();
                if (t == null) 
                    return null;
                isDiapKeyw = true;
        ...
        if (num == null) {
            ...
            if (tt != null) {
                ...
                for (Unit u : UnitsHelper.UNITS) {
                    if (com.pullenti.unisharp.Utils.stringsEq(u.fullnameCyr, unam)) {
                        ...
                        uni.add(UnitToken._new1639(t, t, u));
                        break;
                    }
                }
                if (uni == null) 
                    return null;
                res = _new1641(t0, tt.getEndToken(), _about);
                ...
                if ((uni != null && uni.size() == 1 && uni.get(0).getBeginToken() == uni.get(0).getEndToken()) && uni.get(0).getLengthChar() > 3) {
                    rval = 1.0;
                    res = _new1641(t0, uni.get(uni.size() - 1).getEndToken(), _about);
                    t = res.getEndToken().getNext();
                }
                else if (hasKeyw && canBeNan) {
                    rval = Double.NaN;
                    res = _new1641(t0, t0, _about);
                    if (t != null) 
            ...
            res = _new1641(t0, num.getEndToken(), _about);
        ...
        if (!second) {
            int iii = 0;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapiii1645 = new com.pullenti.unisharp.Outargwrapper<Integer>(iii);
            ttt = _isMinOrMax(t, wrapiii1645);
            iii = (wrapiii1645.value != null ? wrapiii1645.value : 0);
            if (ttt != null && iii > 0) {
                isSecondMax = true;
                t = ttt.getNext();
            }
        }
        NumbersWithUnitToken _next = (second || plusminus || ((t != null && ((t.isTableControlChar() || t.isNewlineBefore())))) ? null : _tryParse(t, addUnits, true, false, canBeNan));
    ...
    public static com.pullenti.ner.MetaToken _tryParseWHL(com.pullenti.ner.Token t) {
        ...
        if (txt.length() == 5 && ((txt.charAt(1) == 'Х' || txt.charAt(1) == 'X')) && ((txt.charAt(3) == 'Х' || txt.charAt(3) == 'X'))) {
            ...
            return com.pullenti.ner.MetaToken._new857(t, t, nams);
        }
        com.pullenti.ner.Token t0 = t;
        ...
        if (nams == null || (nams.size() < 2)) 
            return null;
        return com.pullenti.ner.MetaToken._new857(t0, t1, nams);
    }
    ...
    public static void initialize() {
        ...
        com.pullenti.ner.core.Termin t = com.pullenti.ner.core.Termin._new135("НЕ МЕНЕЕ", DiapTyp.GE);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("МЕНЕЕ", DiapTyp.LS);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("НЕ БОЛЕЕ", DiapTyp.LE);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("БОЛЕЕ", DiapTyp.GT);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ОТ", DiapTyp.FROM);
        t.addVariant("С", false);
        t.addVariant("C", false);
        t.addVariant("НАЧИНАЯ С", false);
        t.addVariant("НАЧИНАЯ ОТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("ДО", DiapTyp.TO);
        t.addVariant("ПО", false);
        t.addVariant("ЗАКАНЧИВАЯ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new135("НЕ ХУЖЕ", DiapTyp.UNDEFINED);
        m_Termins.add(t);
        m_Spec = new com.pullenti.ner.core.TerminCollection();
        t = com.pullenti.ner.core.Termin._new137("ПОЛЛИТРА", 0.5, "литр");
        t.addVariant("ПОЛУЛИТРА", false);
        m_Spec.add(t);
        t = com.pullenti.ner.core.Termin._new137("ПОЛКИЛО", 0.5, "килограмм");
        t.addVariant("ПОЛКИЛОГРАММА", false);
        m_Spec.add(t);
        t = com.pullenti.ner.core.Termin._new137("ПОЛМЕТРА", 0.5, "метр");
        t.addVariant("ПОЛУМЕТРА", false);
        m_Spec.add(t);
        t = com.pullenti.ner.core.Termin._new137("ПОЛТОННЫ", 0.5, "тонна");
        t.addVariant("ПОЛУТОННЫ", false);
        m_Spec.add(t);
        m_Spec.add(t);
    }

    public static NumbersWithUnitToken _new1632(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Double _arg3) {
        NumbersWithUnitToken res = new NumbersWithUnitToken(_arg1, _arg2);
        res.singleVal = _arg3;
        return res;
    }

    public static NumbersWithUnitToken _new1641(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        NumbersWithUnitToken res = new NumbersWithUnitToken(_arg1, _arg2);
        res.about = _arg3;
        return res;
    }
