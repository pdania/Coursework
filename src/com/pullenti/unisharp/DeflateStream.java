...
public class DeflateStream extends Stream {
    ...
    public DeflateStream(Stream str, boolean compress) throws java.io.IOException {
        stream = str;
        if (compress) {
            ...
            java.util.zip.Inflater inflate = new java.util.zip.Inflater();
    ...
    public void close() throws java.io.IOException {
        ...
        java.util.zip.Deflater deflate = new java.util.zip.Deflater();
